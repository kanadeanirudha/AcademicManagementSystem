...
namespace AMS.ViewModel
{
    public class OrganisationStudyCentrePrintingFormatViewModel : IOrganisationStudyCentrePrintingFormatViewModel
    {
        ...
        public string CentrePrintingLine
        {
         ...
         [Display(Name = "DisplayName_PrintingLine1", ResourceType = typeof(AMS.Common.Resources))]
        public string PrintingLine1
        {
         ...
         [Display(Name = "DisplayName_PrintingLine2", ResourceType = typeof(AMS.Common.Resources))]
        public string PrintingLine2
        {
         ...
         [Display(Name = "DisplayName_PrintingLine3", ResourceType = typeof(AMS.Common.Resources))]
        ...
        [Display(Name = "DisplayName_PrintingLine4", ResourceType = typeof(AMS.Common.Resources))]
        ...
        public int Height { get; set; }
         ...
         [Display(Name = "DisplayName_Logo", ResourceType = typeof(AMS.Common.Resources))]
        public byte[] Logo
        {
            get
            {
