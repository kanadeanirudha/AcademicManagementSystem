...
namespace AMS.ViewModel
{
    public class UserMasterViewModel : IUserMasterViewModel
    {
        ...
        [Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_EmailIDForAccountRequired")]
       ...
       // [Required(ErrorMessage = "Please enter the E-mail ID for your account")]       
        ...
        [Display(Name = "DisplayName_Password", ResourceType = typeof(AMS.Common.Resources))]
        [Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_PasswordForAccountRequired")]
