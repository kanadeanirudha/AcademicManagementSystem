...
namespace AMS.ViewModel
{
    public class GeneralLevelMasterViewModel : IGeneralLevelMasterViewModel
    {
        ...
        [Display(Name = "DisplayName_LevelName", ResourceType = typeof(AMS.Common.Resources))]
        [Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_LevelNameRequired")]
