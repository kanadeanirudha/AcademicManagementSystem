...
namespace AMS.ViewModel
{
    public class LeaveRuleMasterViewModel : ILeaveRuleMasterViewModel
    {
        ...
        [Display(Name = "DisplayName_DaysBeforeApplicationSubmitted", ResourceType = typeof(AMS.Common.Resources))]
        [Required(ErrorMessage = "Days Befor Application Submitted should not be blank.")]
         //[Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_DayOfTheMonthRequired")]
        ...
        [Display(Name = "Days After Application Submitted")]
        [Required(ErrorMessage = "Leave Application Submitted Upto Days should not be blank.")]
         //[Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_DayOfTheMonthRequired")]
