...
namespace AMS.ViewModel
{
    public class GeneralNationalityMasterViewModel : IGeneralNationalityMasterViewModel
    {
        ...
        [Display(Name = "DisplayName_NationalityDescription", ResourceType = typeof(AMS.Common.Resources))]
        [Required(ErrorMessageResourceType = typeof(AMS.Common.Resources), ErrorMessageResourceName = "ValidationMessage_NationalityDescriptionRequired")]
