...
{
    public interface IStudentRegistrationFormViewModel
    {
        StudentRegistrationForm StudentRegistrationFormDTO
        {
            get;
            set;
        }
        ...
        string Student_DateofRegistration
        {
            get;
            set;
        }
        ...
        bool IsTaskGeneratedForApproval
        {
            get;
            set;
        }
    ...
    public interface IStudentRegistrationFormBaseViewModel
    {
