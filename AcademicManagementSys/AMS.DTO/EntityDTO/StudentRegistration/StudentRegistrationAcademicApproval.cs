...
namespace AMS.DTO
{
    public class StudentRegistrationAcademicApproval : BaseDTO
    {
        ...
        #region EntranceExamination
        public int QualifyingSubjectID
        {
            get;
            set;
        ...
        public int QualifyingMarksOutOf
        {
            get;
            set;

        }
        public int QualifyingMarksObtained
        {
            get;
            set;

        }
        #endregion EntranceExamination

        #region Qualification
        public int QualificationSubjectID
        {
            get;
            set;

        }
        public string QualificationSubjectName
        {
            get;
            set;

        }
        public int QualificationMarksOutOf
        {
            get;
            set;

        }
        public int QualificationMarksObtained
        {
            get;
            set;
        ...
        public int SelectedSectionDetailID
        {
            get;
            set;
        }
    ...
    public class PreviousWorkExperienceAcademicApproval : BaseDTO
    {
