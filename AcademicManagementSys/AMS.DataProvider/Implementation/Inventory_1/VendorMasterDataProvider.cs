        ...
        public IBaseEntityResponse<VendorMaster> InsertVendorMaster(VendorMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (item.State != null)
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@nsState", SqlDbType.NVarChar, 15, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.State));
                    }
                    else
                    {
                        cmdToExecute.Parameters.Add(new SqlParameter("@nsState", SqlDbType.NVarChar, 15, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, DBNull.Value));
                    }
