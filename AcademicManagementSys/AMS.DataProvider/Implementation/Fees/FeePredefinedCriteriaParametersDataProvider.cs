...
{
    public class FeePredefinedCriteriaParametersDataProvider : DBInteractionBase, IFeePredefinedCriteriaParametersDataProvider
    {
        ...
        /// </summary>
        public FeePredefinedCriteriaParametersDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public FeePredefinedCriteriaParametersDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<FeePredefinedCriteriaParameters> GetFeePredefinedCriteriaParametersBySearch(FeePredefinedCriteriaParametersSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_FeePredefinedCriteriaParameters_SelectAll";
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.TableEntityName = sqlDataReader["TableEntityName"].ToString();
                        item.PrimaryKeyFieldName = sqlDataReader["PrimaryKeyFieldName"].ToString();
                        item.DisplayKeyFieldName = sqlDataReader["DisplayKeyFieldName"].ToString();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_FeePredefinedCriteriaParameters_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<FeePredefinedCriteriaParameters> GetTableEntityNameList(FeePredefinedCriteriaParametersSearchRequest searchRequest)
        {
            ...
            IBaseEntityCollectionResponse<FeePredefinedCriteriaParameters> baseEntityCollection = new BaseEntityCollectionResponse<FeePredefinedCriteriaParameters>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        {
                            item.PrimaryKeyFieldName = Convert.ToString(sqlDataReader["ColumnName"]);
                        }
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["ColumnName"]) == false)
                        {
                            item.DisplayKeyFieldName = Convert.ToString(sqlDataReader["ColumnName"]);
                        }
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
        ...
        public IBaseEntityResponse<FeePredefinedCriteriaParameters> GetFeePredefinedCriteriaParametersByID(FeePredefinedCriteriaParameters item)
        {
            IBaseEntityResponse<FeePredefinedCriteriaParameters> response = new BaseEntityResponse<FeePredefinedCriteriaParameters>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_FeePredefinedCriteriaParameters_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        FeePredefinedCriteriaParameters _item = new FeePredefinedCriteriaParameters();
        ...
        public IBaseEntityResponse<FeePredefinedCriteriaParameters> InsertFeePredefinedCriteriaParameters(FeePredefinedCriteriaParameters item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_FeePredefinedCriteriaParameters_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 10,
                        ParameterDirection.Input, false, 0, 0, "",
                        DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsFeeCriteriaParametersDescription", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.FeeCriteriaParametersDescription));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsFeeCriteriaParametersCode", SqlDbType.NVarChar, 40,
                                            ParameterDirection.Input, false, 0, 0, "",
                                            DataRowVersion.Proposed, item.FeeCriteriaParametersCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsTableEntityName", SqlDbType.NVarChar, 30,
                                           ParameterDirection.Input, false, 0, 0, "",
                                           DataRowVersion.Proposed, item.TableEntityName));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsPrimaryKeyFieldName", SqlDbType.NVarChar, 50,
                                           ParameterDirection.Input, false, 0, 0, "",
                                           DataRowVersion.Proposed, item.PrimaryKeyFieldName));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsDisplayKeyFieldName", SqlDbType.NVarChar, 60,
                                           ParameterDirection.Input, false, 0, 0, "",
                                           DataRowVersion.Proposed, item.DisplayKeyFieldName));
        ...
        public IBaseEntityResponse<FeePredefinedCriteriaParameters> UpdateFeePredefinedCriteriaParameters(FeePredefinedCriteriaParameters item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_FeePredefinedCriteriaParameters_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_FeePredefinedCriteriaParameters_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of FeePredefinedCriteriaParameters
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<FeePredefinedCriteriaParameters> DeleteFeePredefinedCriteriaParameters(FeePredefinedCriteriaParameters item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_FeePredefinedCriteriaParameters_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_FeePredefinedCriteriaParameters_Delete' reported the ErrorCode: " + _errorCode);
                    }
