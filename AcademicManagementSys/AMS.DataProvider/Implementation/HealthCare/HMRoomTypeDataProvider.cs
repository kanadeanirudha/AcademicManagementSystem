...
{
    public class HMRoomTypeDataProvider : DBInteractionBase, IHMRoomTypeDataProvider
    {
        ...
        public HMRoomTypeDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<HMRoomType> GetHMRoomTypeBySearch(HMRoomTypeSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<HMRoomType> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<HMRoomType>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_SelectAll";
                  ...
                  //  cmdToExecute.Parameters.Add(new SqlParameter("@nsCentreCode", SqlDbType.NVarChar, 10, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.CentreCode));
                   // cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.DepartmentID));
                    ...
                    baseEntityCollection.CollectionResponse = new List<HMRoomType>();
                    while (sqlDataReader.Read())
                    {
                        HMRoomType item = new HMRoomType();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMRoomType_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<HMRoomType> GetHMRoomTypeSearchList(HMRoomTypeSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        HMRoomType item = new HMRoomType();
                        //item.ID = Convert.ToInt16(sqlDataReader["HMRoomTypeID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMRoomType_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<HMRoomType> GetHMRoomTypeByID(HMRoomType item)
        {
            IBaseEntityResponse<HMRoomType> response = new BaseEntityResponse<HMRoomType>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        HMRoomType _item = new HMRoomType();
        ...
        public IBaseEntityResponse<HMRoomType> InsertHMRoomType(HMRoomType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRoomType", SqlDbType.NVarChar, 100,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.RoomType));
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_HMRoomType_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_HMRoomType_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<HMRoomType> UpdateHMRoomType(HMRoomType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_HMRoomType_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of HMRoomType
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<HMRoomType> DeleteHMRoomType(HMRoomType item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMRoomType_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMRoomType_Delete' reported the ErrorCode: " + _errorCode);
                    }
