...
{
    public class HMOPDHealthCentreDataProvider : DBInteractionBase, IHMOPDHealthCentreDataProvider
    {
        ...
        /// </summary>
        public HMOPDHealthCentreDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public HMOPDHealthCentreDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<HMOPDHealthCentre> GetHMOPDHealthCentreBySearch(HMOPDHealthCentreSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<HMOPDHealthCentre> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<HMOPDHealthCentre>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_SelectAll";
                   ...
                   // cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.DepartmentID));
                    ...
                    baseEntityCollection.CollectionResponse = new List<HMOPDHealthCentre>();
                    while (sqlDataReader.Read())
                    {
                        HMOPDHealthCentre item = new HMOPDHealthCentre();
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMOPDHealthCentre_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<HMOPDHealthCentre> GetHMOPDHealthCentreSearchList(HMOPDHealthCentreSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        HMOPDHealthCentre item = new HMOPDHealthCentre();
                        //item.ID = Convert.ToInt16(sqlDataReader["HMOPDHealthCentreID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMOPDHealthCentre_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<HMOPDHealthCentre> GetHMOPDHealthCentreByID(HMOPDHealthCentre item)
        {
            IBaseEntityResponse<HMOPDHealthCentre> response = new BaseEntityResponse<HMOPDHealthCentre>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        HMOPDHealthCentre _item = new HMOPDHealthCentre();
        ...
        public IBaseEntityResponse<HMOPDHealthCentre> InsertHMOPDHealthCentre(HMOPDHealthCentre item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsOPDName", SqlDbType.NVarChar, 100,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.OPDName));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsCentreCode", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.CentreCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iDepartmentID", SqlDbType.NVarChar, 50,
                                            ParameterDirection.Input, false, 10, 0, "",
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_HMOPDHealthCentre_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_HMOPDHealthCentre_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<HMOPDHealthCentre> UpdateHMOPDHealthCentre(HMOPDHealthCentre item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_HMOPDHealthCentre_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of HMOPDHealthCentre
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<HMOPDHealthCentre> DeleteHMOPDHealthCentre(HMOPDHealthCentre item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_HMOPDHealthCentre_Delete' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityCollectionResponse<HMOPDHealthCentre> GetListHMOPDHealthCentre(HMOPDHealthCentreSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_HMOPDHealthCentre_GetDropdownListOPD";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                   // cmdToExecute.Parameters.Add(new SqlParameter("@nsCentreCode", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.CentreCode));
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.OPDName = sqlDataReader["OPDName"].ToString();
                        //item.MarchandiseBaseCategoryCode = Convert.ToString(sqlDataReader["MarchandiseBaseCatgoryCode"]);
