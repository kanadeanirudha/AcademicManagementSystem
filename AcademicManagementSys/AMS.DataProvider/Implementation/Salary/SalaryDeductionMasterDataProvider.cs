...
namespace AMS.DataProvider
{
	public class SalaryDeductionMasterDataProvider : DBInteractionBase,ISalaryDeductionMasterDataProvider
	{
			...
			try
			{
				...
				else
				{
					...
					while (sqlDataReader.Read())
					{
                        ...
                        item.DeductionHeadName = sqlDataReader["DeductionHeadName"].ToString();
                        item.DeductionType = sqlDataReader["DeductionType"].ToString();
			...
			try
			{
				...
				else
				{
					...
					while (sqlDataReader.Read())
					{
                        ...
                        _item.DeductionHeadName = sqlDataReader["DeductionHeadName"].ToString();
                        _item.DeductionType = sqlDataReader["DeductionType"].ToString();
					...
					{
						// Throw error.
						throw new Exception("Stored Procedure 'SalaryDeductionMaster' reported the ErrorCode: " + _errorCode);
					}
				}
			}
			catch (Exception ex)
		...
		public IBaseEntityResponse<SalaryDeductionMaster> InsertSalaryDeductionMaster(SalaryDeductionMaster item)
		{
			...
			try
			{
				...
				else
				{
					...
					cmdToExecute.Parameters.Add(new SqlParameter("@nsDeductionHeadName", SqlDbType.NVarChar,0,
											ParameterDirection.Input,false,11,0,"",
											DataRowVersion.Proposed, item.DeductionHeadName));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsDeductionType", SqlDbType.NVarChar, 0,
											ParameterDirection.Input,false,11,0,"",
											DataRowVersion.Proposed, item.DeductionType));
					...
					{
						// Throw error.
						throw new Exception("Stored Procedure 'dbo.USP_SalaryDeductionMaster_INSERT' reported the ErrorCode: " + 
										_errorCode);
					}
					if (_rowsAffected > 0)
					{
		...
		public IBaseEntityResponse<SalaryDeductionMaster> UpdateSalaryDeductionMaster(SalaryDeductionMaster item)
		{
			...
			try
			{
				...
				else
				{
					...
					{
						// Throw error.
						throw new Exception("Stored Procedure 'dbo.USP_SalaryDeductionMaster_Delete' reported the ErrorCode: " + 
										_errorCode);
					}
					if (_rowsAffected > 0)
					{
		...
		/// <summary>
		/// Delete a specific record of SalaryDeductionMaster
		/// </summary>
		/// <param name="item"></param>
		/// <returns></returns>
        ...
        public IBaseEntityCollectionResponse<SalaryDeductionMaster> GetAllowanceHeadNameList(SalaryDeductionMasterSearchRequest searchRequest)
        {
            ...
            IBaseEntityCollectionResponse<SalaryDeductionMaster> baseEntityCollection = new BaseEntityCollectionResponse<SalaryDeductionMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_SalaryDeductionMaster_ListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    //-----------------------------------------------------Output Parameters ------------------------------------------------------------------
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    //-----------------------------------------------------Input Parameters ------------------------------------------------------------------
