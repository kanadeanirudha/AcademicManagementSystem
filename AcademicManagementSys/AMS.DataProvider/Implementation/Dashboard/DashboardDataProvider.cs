...
namespace AMS.DataProvider
{
    public class DashboardDataProvider : DBInteractionBase, IDashboardDataProvider
    {
        ...
        public IBaseEntityCollectionResponse<Dashboard> GetByGeneralRequestApprovalField(DashboardSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "USP_GeneralRequestApproval_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@sErrorMessage", SqlDbType.VarChar, 100, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, ""));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralRequestTransactionID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.GeneralRequestTransactionID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralRequestApproval_SelectOne' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<Dashboard> GetDashboardByID(Dashboard item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_Dashboard_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.TaskNotificationDetailsID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                        // Open connection.
                    ...
                    while (sqlDataReader.Read())
                    {
                        Dashboard _item = new Dashboard();
                        _item.TaskNotificationDetailsID = Convert.ToInt32(sqlDataReader["ID"]);
                        _item.TaskNotificationMasterID = Convert.ToInt32(sqlDataReader["TaskNotificationMasterID"]);
                        _item.GeneralTaskReportingDetailsID = Convert.ToInt32(sqlDataReader["GeneralTaskReportingDetailsID"]);
                        _item.NextGeneralTaskReportingDetailsID = Convert.ToInt32(sqlDataReader["NextGeneralTaskReportingDetailsID"]);
                        _item.IsLastRecordFlag = Convert.ToBoolean(sqlDataReader["IsLastRecordFlag"]);
                        _item.ApprovalStatus = Convert.ToInt32(sqlDataReader["ApprovalStatus"]);
                        _item.MenuCodeLink = sqlDataReader["MenuCodeLink"].ToString();
        ...
        public IBaseEntityResponse<Dashboard> GeneralRequestApprovalInsert(Dashboard item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralRequestApproval_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralRequestTransactionID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.GeneralRequestTransactionID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@bApprovalStatus", SqlDbType.Bit, 0, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, Convert.ToBoolean(item.ApprovalStatus)));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsRemark", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.Remark != null ? item.Remark.Trim() : string.Empty));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iEmployeeID", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.PersonID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@sRequestCode", SqlDbType.NVarChar, 15, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.RequestCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iCreatedBy", SqlDbType.Int, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.CreatedBy));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
        ...
        public IBaseEntityResponse<Dashboard> UpdateDashboard(Dashboard item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_Dashboard_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.TaskNotificationDetailsID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iTaskNotificationMasterID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.TaskNotificationMasterID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralTaskReportingDetailsID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.GeneralTaskReportingDetailsID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iNextGeneralTaskReportingDetailsID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.NextGeneralTaskReportingDetailsID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@bIsLastRecordFlag", SqlDbType.Bit, 0,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.IsLastRecordFlag));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iApprovalStatus", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.ApprovalStatus));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsMenuCodeLink", SqlDbType.NVarChar, 0,
                                        ParameterDirection.Input, false, 10, 0, "",
                                        DataRowVersion.Proposed, item.MenuCodeLink));
                    ...
                    // Execute query.
                    _rowsAffected = cmdToExecute.ExecuteNonQuery();
                    item.TaskNotificationDetailsID = (Int32)cmdToExecute.Parameters["@iID"].Value;
                    _errorCode = (SqlInt32)cmdToExecute.Parameters["@iErrorCode"].Value;
                    if (_errorCode != (int)ErrorEnum.AllOk)
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_Dashboard_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of Dashboard
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<Dashboard> DeleteDashboard(Dashboard item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_Dashboard_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        {
                            item.Description = sqlDataReader["TaskDescription"].ToString();
                        }
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
                    if (cmdToExecute.Parameters["@iErrorCode"].Value != null)
