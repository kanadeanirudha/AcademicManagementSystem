...
{
    public class OnlineExamExaminationMasterDataProvider : DBInteractionBase, IOnlineExamExaminationMasterDataProvider
    {
        ...
        /// </summary>
        public OnlineExamExaminationMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public OnlineExamExaminationMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<OnlineExamExaminationMaster> GetOnlineExamExaminationMasterBySearch(OnlineExamExaminationMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<OnlineExamExaminationMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<OnlineExamExaminationMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<OnlineExamExaminationMaster>();
                    while (sqlDataReader.Read())
                    {
                        OnlineExamExaminationMaster item = new OnlineExamExaminationMaster();

                        item.ID = sqlDataReader["OnlineExamExaminationMasterID"] is DBNull ? new Int32() : Convert.ToInt32(sqlDataReader["OnlineExamExaminationMasterID"]);
        ...
        public IBaseEntityCollectionResponse<OnlineExamExaminationMaster> GetOnlineExamExaminationMasterSearchList(OnlineExamExaminationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamExaminationMaster_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
        ...
        //    IBaseEntityCollectionResponse<OnlineExamExaminationMaster> baseEntityCollection = new BaseEntityCollectionResponse<OnlineExamExaminationMaster>();
        //    SqlCommand cmdToExecute = new SqlCommand();
        //    SqlDataReader sqlDataReader = null;
        ...
        //            cmdToExecute.Connection = _mainConnection;
        //            cmdToExecute.CommandText = "dbo.USP_OnlineExamExaminationMaster_SearchListForDropDown";
        //            cmdToExecute.CommandType = CommandType.StoredProcedure;
        //            //-----------------------------------------------------Output Parameters ------------------------------------------------------------------
        //            cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
        //            //-----------------------------------------------------Input Parameters ------------------------------------------------------------------
        ...
        /// <returns></returns>
        public IBaseEntityResponse<OnlineExamExaminationMaster> GetOnlineExamExaminationMasterByID(OnlineExamExaminationMaster item)
        {
            IBaseEntityResponse<OnlineExamExaminationMaster> response = new BaseEntityResponse<OnlineExamExaminationMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamExaminationMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        OnlineExamExaminationMaster _item = new OnlineExamExaminationMaster();
        ...
        public IBaseEntityResponse<OnlineExamExaminationMaster> InsertOnlineExamExaminationMaster(OnlineExamExaminationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsExaminationName", SqlDbType.NVarChar, 60,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.ExaminationName));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsPurpose", SqlDbType.NVarChar, 200,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.Purpose));
                    cmdToExecute.Parameters.Add(new SqlParameter("nsAcadSessionId", SqlDbType.Int, 4,
                                             ParameterDirection.Input, false, 10, 0, "",
                                             DataRowVersion.Proposed, item.AcadSessionId));
                    cmdToExecute.Parameters.Add(new SqlParameter("nsExaminationFor", SqlDbType.NVarChar, 100,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.ExaminationFor));
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iOnlineExamExaminationMasterID"].Value;
                    //}
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_OnlineExamExaminationMaster_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_OnlineExamExaminationMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        /// <summary>
        /// Delete a specific record of OnlineExamExaminationMaster
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<OnlineExamExaminationMaster> DeleteOnlineExamExaminationMaster(OnlineExamExaminationMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_OnlineExamExaminationMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
        ...
        public IBaseEntityCollectionResponse<OnlineExamExaminationMaster> GetExaminationNameList(OnlineExamExaminationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamExaminationMaster_GetDropdownListForExaminationName";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public IBaseEntityCollectionResponse<OnlineExamExaminationMaster> OnlineExamGetExaminationListCentreWise(OnlineExamExaminationMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamGetExaminationList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iGenSessionMaster", SqlDbType.Int, 0, ParameterDirection.Input, true, 0, 0, "", DataRowVersion.Proposed, searchRequest.SessionMaster));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iRoleMasterID", SqlDbType.Int, 0, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, searchRequest.RoleMasterID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
