...
{
    public class GeneralQuestionLevelMasterDataProvider : DBInteractionBase, IGeneralQuestionLevelMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralQuestionLevelMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralQuestionLevelMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralQuestionLevelMaster> GetGeneralQuestionLevelMasterBySearch(GeneralQuestionLevelMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.ID = sqlDataReader["GeneralQuestionLevelMasterID"] is DBNull ? new Int32() : Convert.ToInt32(sqlDataReader["GeneralQuestionLevelMasterID"]);
                        item.LevelCode = sqlDataReader["LevelCode"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["LevelCode"]);
                        item.LevelDescription = sqlDataReader["LevelDescription"] is DBNull ? string.Empty : Convert.ToString(sqlDataReader["LevelDescription"]);
        ...
        public IBaseEntityCollectionResponse<GeneralQuestionLevelMaster> GetGeneralQuestionLevelMasterSearchList(GeneralQuestionLevelMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralQuestionLevelMaster_GetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralQuestionLevelMaster_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralQuestionLevelMaster> GetGeneralQuestionLevelMasterByID(GeneralQuestionLevelMaster item)
        {
            IBaseEntityResponse<GeneralQuestionLevelMaster> response = new BaseEntityResponse<GeneralQuestionLevelMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralQuestionLevelMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralQuestionLevelMaster _item = new GeneralQuestionLevelMaster();
        ...
        public IBaseEntityResponse<GeneralQuestionLevelMaster> InsertGeneralQuestionLevelMaster(GeneralQuestionLevelMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralQuestionLevelMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsLevelCode", SqlDbType.NVarChar, 15,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.LevelCode));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsLevelDescription", SqlDbType.NVarChar, 200,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.LevelDescription));
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iGeneralQuestionLevelMasterID"].Value;
                    //}
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_GeneralQuestionLevelMaster_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralQuestionLevelMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralQuestionLevelMaster> UpdateGeneralQuestionLevelMaster(GeneralQuestionLevelMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralQuestionLevelMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralQuestionLevelMaster_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of GeneralQuestionLevelMaster
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<GeneralQuestionLevelMaster> DeleteGeneralQuestionLevelMaster(GeneralQuestionLevelMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralQuestionLevelMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralQuestionLevelMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
