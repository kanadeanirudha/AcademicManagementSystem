...
{
    public class GeneralPaperSetMasterDataProvider : DBInteractionBase, IGeneralPaperSetMasterDataProvider
    {
        ...
        /// </summary>
        public GeneralPaperSetMasterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public GeneralPaperSetMasterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<GeneralPaperSetMaster> GetGeneralPaperSetMasterBySearch(GeneralPaperSetMasterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<GeneralPaperSetMaster> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<GeneralPaperSetMaster>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_GeneralPaperSetMaster_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<GeneralPaperSetMaster>();
                    while (sqlDataReader.Read())
                    {
                        GeneralPaperSetMaster item = new GeneralPaperSetMaster();

                        item.ID = sqlDataReader["GeneralPaperSetMasterID"] is DBNull ? new byte() : Convert.ToByte(sqlDataReader["GeneralPaperSetMasterID"]);
        ...
        public IBaseEntityCollectionResponse<GeneralPaperSetMaster> GetGeneralPaperSetMasterSearchList(GeneralPaperSetMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamAssignpapersetter_GetPaperSetListForDropDown";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    if (_mainConnectionIsCreatedLocal)
                    {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["PaperSetCode"]) == false)
                        {
                            item.PaperSetCode = Convert.ToString(sqlDataReader["PaperSetCode"]);
                        }
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
                    if (cmdToExecute.Parameters["@iErrorCode"].Value != null)
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_OnlineExamAssignpapersetter_GetPaperSetListForDropDown' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<GeneralPaperSetMaster> GetGeneralPaperSetMasterByID(GeneralPaperSetMaster item)
        {
            IBaseEntityResponse<GeneralPaperSetMaster> response = new BaseEntityResponse<GeneralPaperSetMaster>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralPaperSetMaster_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        GeneralPaperSetMaster _item = new GeneralPaperSetMaster();
        ...
        public IBaseEntityResponse<GeneralPaperSetMaster> InsertGeneralPaperSetMaster(GeneralPaperSetMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralPaperSetMaster_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;

                    cmdToExecute.Parameters.Add(new SqlParameter("@iGeneralPaperSetMasterID", SqlDbType.Int, 4,
                                            ParameterDirection.Output, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsPaperSetCode", SqlDbType.Char, 200,
                                            ParameterDirection.Input, false, 10, 0, "",
                                            DataRowVersion.Proposed, item.PaperSetCode));
                    ...
                    //if (_rowsAffected > 0)
                    //{
                    //    item.ID = (Int16)cmdToExecute.Parameters["@iGeneralPaperSetMasterID"].Value;
                    //}
                    ...
                    //{
                    //    // Throw error.
                    //    throw new Exception("Stored Procedure 'dbo.USP_GeneralPaperSetMaster_Insert' reported the ErrorCode: " +
                    //                    _errorCode);
                    //}
                    //if (_rowsAffected > 0)
                    //{
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralPaperSetMaster_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<GeneralPaperSetMaster> UpdateGeneralPaperSetMaster(GeneralPaperSetMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralPaperSetMaster_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_GeneralPaperSetMaster_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        public IBaseEntityResponse<GeneralPaperSetMaster> DeleteGeneralPaperSetMaster(GeneralPaperSetMaster item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_GeneralPaperSetMaster_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_GeneralPaperSetMaster_Delete' reported the ErrorCode: " + _errorCode);
                    }
