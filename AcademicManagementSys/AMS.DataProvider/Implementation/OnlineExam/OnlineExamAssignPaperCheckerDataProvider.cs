...
{
    public class OnlineExamAssignPaperCheckerDataProvider : DBInteractionBase, IOnlineExamAssignPaperCheckerDataProvider
    {
        ...
        /// </summary>
        public OnlineExamAssignPaperCheckerDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public OnlineExamAssignPaperCheckerDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<OnlineExamAssignPaperChecker> GetOnlineExamAssignPaperCheckerBySearch(OnlineExamAssignPaperCheckerSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<OnlineExamAssignPaperChecker> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<OnlineExamAssignPaperChecker>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamPaperChecker_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<OnlineExamAssignPaperChecker>();
                    while (sqlDataReader.Read())
                    {
                        OnlineExamAssignPaperChecker item = new OnlineExamAssignPaperChecker();
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["OnlineExamQuestionPaperCheckerID"]) == false)
                        {
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["IsAllChecked"]) == false)
                        {
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_OnlineExamAssignPaperChecker_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<OnlineExamAssignPaperChecker> GetOnlineExamSupportStaffSearchList(OnlineExamAssignPaperCheckerSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamSupportStaff_SearchListforPaperChecker";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
        ...
        public IBaseEntityResponse<OnlineExamAssignPaperChecker> GetOnlineExamAssignPaperCheckerByID(OnlineExamAssignPaperChecker item)
        {
            IBaseEntityResponse<OnlineExamAssignPaperChecker> response = new BaseEntityResponse<OnlineExamAssignPaperChecker>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
        ...
        public IBaseEntityResponse<OnlineExamAssignPaperChecker> InsertOnlineExamAssignPaperChecker(OnlineExamAssignPaperChecker item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamPaperChecker_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iSectionDetailID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                    ...
                    {
                        //Throw error.
                        throw new Exception("Stored Procedure 'USP_OnlineExamAssignPaperChecker_Insert' reported the ErrorCode: " +
                                            _errorCode);
                    }
                }
            }
        ...
        /// <summary>
        /// Update a specific record of OnlineExamAssignPaperChecker
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        ...
        public IBaseEntityResponse<OnlineExamAssignPaperChecker> DeleteOnlineExamAssignPaperChecker(OnlineExamAssignPaperChecker item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_OnlineExamAssignPaperChecker_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4,
                                            ParameterDirection.Input, true, 10, 0, "",
                                            DataRowVersion.Proposed, item.ID));
                    ...
                    response.Entity = item;
                    //if (_errorCode != (int)ErrorEnum.AllOk)
                    if (_errorCode != (int)ErrorEnum.AllOk && _errorCode != (int)ErrorEnum.DependantEntry && _errorCode != 22)
                    {
                        // Throw error.
