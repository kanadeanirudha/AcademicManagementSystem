        ...
        public IBaseEntityResponse<EmployeeDependents> InsertEmployeeDependents(EmployeeDependents item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsMobileNumber", SqlDbType.NVarChar, 50,ParameterDirection.Input, false, 10, 0, "",DataRowVersion.Proposed, item.MobileNumber));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsAddress1", SqlDbType.NVarChar, 255,ParameterDirection.Input, false, 10, 0, "",DataRowVersion.Proposed, item.Address1));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsEmployeeDependentQualification", SqlDbType.NVarChar, 100,ParameterDirection.Input, false, 10, 0, "",DataRowVersion.Proposed, item.EmployeeDependentQualification));
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsEmployeeDependentDesignation", SqlDbType.NVarChar, 100,ParameterDirection.Input, false, 10, 0, "",DataRowVersion.Proposed, item.EmployeeDependentDesignation));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsPlaceOfBirth", SqlDbType.NVarChar, 50,ParameterDirection.Input, false, 0, 0, "",DataRowVersion.Proposed, item.PlaceOfBirth));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsLanguageKnown", SqlDbType.VarChar, 255,ParameterDirection.Input, false, 10, 0, "",DataRowVersion.Proposed, item.LanguageKnown));
