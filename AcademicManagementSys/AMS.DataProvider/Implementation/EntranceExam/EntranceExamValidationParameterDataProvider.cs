...
{
    public class EntranceExamValidationParameterDataProvider : DBInteractionBase, IEntranceExamValidationParameterDataProvider
    {
        ...
        /// </summary>
        public EntranceExamValidationParameterDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public EntranceExamValidationParameterDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<EntranceExamValidationParameter> GetEntranceExamValidationParameterBySearch(EntranceExamValidationParameterSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<EntranceExamValidationParameter> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<EntranceExamValidationParameter>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_SelectAll";
                    ...
                    baseEntityCollection.CollectionResponse = new List<EntranceExamValidationParameter>();
                    while (sqlDataReader.Read())
                    {
                        EntranceExamValidationParameter item = new EntranceExamValidationParameter();
                        item.ID = sqlDataReader["EntranceExamValidationParameterID"] is DBNull ? 0 : Convert.ToInt32(sqlDataReader["EntranceExamValidationParameterID"]);
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EntranceExamValidationParameter_SelectAll' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<EntranceExamValidationParameter> GetEntranceExamValidationParameterList(EntranceExamValidationParameterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_SearchList";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'USP_EntranceExamValidationParameter_SearchList' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public IBaseEntityResponse<EntranceExamValidationParameter> GetEntranceExamValidationParameterByID(EntranceExamValidationParameter item)
        {
            IBaseEntityResponse<EntranceExamValidationParameter> response = new BaseEntityResponse<EntranceExamValidationParameter>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_SelectOne";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    while (sqlDataReader.Read())
                    {
                        EntranceExamValidationParameter _item = new EntranceExamValidationParameter();
        ...
        public IBaseEntityResponse<EntranceExamValidationParameter> InsertEntranceExamValidationParameter(EntranceExamValidationParameter item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_Insert";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_EntranceExamValidationParameter_Insert' reported the ErrorCode: " + _errorCode);
                    }
                }
            }
        ...
        public IBaseEntityResponse<EntranceExamValidationParameter> UpdateEntranceExamValidationParameter(EntranceExamValidationParameter item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_Update";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 10,
                                        ParameterDirection.Input, false, 0, 0, "",
                                        DataRowVersion.Proposed, item.ID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_EntranceExamValidationParameter_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of EntranceExamValidationParameter
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        ...
        public IBaseEntityResponse<EntranceExamValidationParameter> DeleteEntranceExamValidationParameter(EntranceExamValidationParameter item)
        {
            ...
            try
            {
                ...
                else
                {
                    _mainConnection.ConnectionString = item.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_EntranceExamValidationParameter_Delete";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
