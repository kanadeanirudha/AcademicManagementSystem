...
{
	public class BranchPromotionDataProvider : DBInteractionBase,IBranchPromotionDataProvider
	{
		...
		/// </summary>
		public BranchPromotionDataProvider()
		{
		}
		/// <summary>
		/// Constructor to initialized data member and member functions
		...
		public BranchPromotionDataProvider(ILogger logException)
		{
		...
		/// <returns></returns>
		public IBaseEntityCollectionResponse<BranchPromotion>     GetBranchPromotionBySearch(BranchPromotionSearchRequest searchRequest)
		{
			IBaseEntityCollectionResponse<BranchPromotion> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<BranchPromotion>();
			...
			try
			{
				...
				else
				{
					...
					baseEntityCollection.CollectionResponse = new List<BranchPromotion>();
					while (sqlDataReader.Read())
					{
						BranchPromotion item = new BranchPromotion();
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["AcademicYear"]) == false && sqlDataReader["AcademicYear"].ToString() != "")
                        {
                            item.AcademicYear = Convert.ToString(sqlDataReader["AcademicYear"]);
                        }
					...
					if (_errorCode != (int)ErrorEnum.AllOk)                    {
						// Throw error.
						throw new Exception("Stored Procedure 'USP_BranchPromotion_SelectAll' reported the ErrorCode: " + _errorCode);
					}
				}
			}
			catch (Exception ex)
        ...
        public IBaseEntityCollectionResponse<BranchPromotion> GetBranchPromotionStudentListBySearch(BranchPromotionSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _mainConnection.ConnectionString = searchRequest.ConnectionString;
                    cmdToExecute.Connection = _mainConnection;
                    cmdToExecute.CommandText = "dbo.USP_BranchPromotion_SelectAll";
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
		...
		/// <returns></returns>
		public IBaseEntityResponse<BranchPromotion> GetBranchPromotionByID(BranchPromotion item)
		{
			IBaseEntityResponse<BranchPromotion> response = new BaseEntityResponse<BranchPromotion>();
			SqlCommand cmdToExecute = new SqlCommand();
			SqlDataReader sqlDataReader = null;
			try
			{
				...
				else
				{
					...
					cmdToExecute.Connection = _mainConnection;
					cmdToExecute.CommandText = "dbo.USP_BranchPromotion_SelectOne";
					cmdToExecute.CommandType = CommandType.StoredProcedure;
					...
					while (sqlDataReader.Read())
					{
						BranchPromotion _item = new BranchPromotion();
		...
		public IBaseEntityResponse<BranchPromotion> InsertBranchPromotion(BranchPromotion item)
		{
			...
			try
			{
				...
				else
				{
					...
					cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsIDs", SqlDbType.NVarChar, 4000, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.PromotedStudentList));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@sAcademicYear", SqlDbType.VarChar, 15, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.AcademicYear));
					...
					{
						// Throw error.
						throw new Exception("Stored Procedure 'dbo.USP_BranchPromotion_INSERT' reported the ErrorCode: " + 
										_errorCode);
					}
					if (_rowsAffected > 0)
					{
		...
		public IBaseEntityResponse<BranchPromotion> UpdateBranchPromotion(BranchPromotion item)
		{
			...
			try
			{
				...
				else
				{
					_mainConnection.ConnectionString = item.ConnectionString;
					cmdToExecute.Connection = _mainConnection;
					cmdToExecute.CommandText ="dbo.USP_BranchPromotion_Update";
					cmdToExecute.CommandType = CommandType.StoredProcedure;
					...
					{
						// Throw error.
						throw new Exception("Stored Procedure 'dbo.USP_BranchPromotion_Delete' reported the ErrorCode: " + 
										_errorCode);
					}
					if (_rowsAffected > 0)
					{
		...
		/// <summary>
		/// Delete a specific record of BranchPromotion
		/// </summary>
		/// <param name="item"></param>
		/// <returns></returns>
		public IBaseEntityResponse<BranchPromotion> DeleteBranchPromotion(BranchPromotion item)
		{
			...
			try
			{
				...
				else
				{
					_mainConnection.ConnectionString = item.ConnectionString;
					cmdToExecute.Connection = _mainConnection;
					cmdToExecute.CommandText ="dbo.USP_BranchPromotion_Delete";
					cmdToExecute.CommandType = CommandType.StoredProcedure;
