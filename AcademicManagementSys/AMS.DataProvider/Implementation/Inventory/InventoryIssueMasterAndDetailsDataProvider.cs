...
{
    public class InventoryIssueMasterAndDetailsDataProvider : DBInteractionBase, IInventoryIssueMasterAndDetailsDataProvider
    {
        ...
        /// </summary>
        public InventoryIssueMasterAndDetailsDataProvider()
        {
        }
        /// <summary>
        /// Constructor to initialized data member and member functions
        ...
        public InventoryIssueMasterAndDetailsDataProvider(ILogger logException)
        {
        ...
        /// <returns></returns>
        public IBaseEntityCollectionResponse<InventoryIssueMasterAndDetails> GetInventoryIssueMasterAndDetailsBySearch(InventoryIssueMasterAndDetailsSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<InventoryIssueMasterAndDetails> baseEntityCollection = baseEntityCollection = new BaseEntityCollectionResponse<InventoryIssueMasterAndDetails>();
            ...
            try
            {
                ...
                else
                {
                    ...
                    baseEntityCollection.CollectionResponse = new List<InventoryIssueMasterAndDetails>();
                    while (sqlDataReader.Read())
                    {
                        InventoryIssueMasterAndDetails item = new InventoryIssueMasterAndDetails();

                        item.IssueMasterID = Convert.ToInt32(sqlDataReader["IssueMasterID"]);
                        item.TransactionDate = Convert.ToString(sqlDataReader["TransactionDate"]);
                        item.IssueNumber = Convert.ToString(sqlDataReader["IssueNumber"]);
        ...
        /// <returns></returns>
        public IBaseEntityResponse<InventoryIssueMasterAndDetails> GetInventoryIssueMasterAndDetailsByID(InventoryIssueMasterAndDetails item)
        {
            IBaseEntityResponse<InventoryIssueMasterAndDetails> response = new BaseEntityResponse<InventoryIssueMasterAndDetails>();
            SqlCommand cmdToExecute = new SqlCommand();
            SqlDataReader sqlDataReader = null;
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@siID", SqlDbType.SmallInt, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.IssueMasterID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
                    ...
                    while (sqlDataReader.Read())
                    {
                        InventoryIssueMasterAndDetails _item = new InventoryIssueMasterAndDetails();
        ...
        public IBaseEntityResponse<InventoryIssueMasterAndDetails> InsertInventoryIssueMasterAndDetails(InventoryIssueMasterAndDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.IssueMasterID));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iIssueFromLocationID", SqlDbType.Int, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.IssueFromLocationID));
                    cmdToExecute.Parameters.Add(new SqlParameter("@iIssueToLocationId", SqlDbType.Int, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.IssueToLocationID));
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@iBalanceSheetId", SqlDbType.SmallInt, 3, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed,Convert.ToInt16( item.SelectedBalanceSheet)));
                    cmdToExecute.Parameters.Add(new SqlParameter("@xIssueDetails", SqlDbType.Xml, 0, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, item.ParameterXml));
                    ...
                    if (_rowsAffected > 0)
                    {
                        item.IssueMasterID = (Int32)cmdToExecute.Parameters["@iID"].Value;
                    }
                    _errorCode = (SqlInt32)cmdToExecute.Parameters["@iErrorCode"].Value;
        ...
        public IBaseEntityResponse<InventoryIssueMasterAndDetails> UpdateInventoryIssueMasterAndDetails(InventoryIssueMasterAndDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@siID", SqlDbType.SmallInt, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, item.IssueMasterID));
                    ...
                    // Execute query.
                    _rowsAffected = cmdToExecute.ExecuteNonQuery();
                    item.IssueMasterID = (Int16)cmdToExecute.Parameters["@siID"].Value;
                    _errorCode = (SqlInt32)cmdToExecute.Parameters["@iErrorCode"].Value;
                    if (_errorCode != (int)ErrorEnum.AllOk)
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_InventoryIssueMasterAndDetails_Delete' reported the ErrorCode: " +
                                        _errorCode);
                    }
                    if (_rowsAffected > 0)
                    {
        ...
        /// <summary>
        /// Delete a specific record of InventoryIssueMasterAndDetails
        /// </summary>
        /// <param name="item"></param>
        /// <returns></returns>
        public IBaseEntityResponse<InventoryIssueMasterAndDetails> DeleteInventoryIssueMasterAndDetails(InventoryIssueMasterAndDetails item)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.CommandType = CommandType.StoredProcedure;
                    cmdToExecute.Parameters.Add(new SqlParameter("@iID", SqlDbType.Int, 4, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed, item.IssueMasterID));
                    ...
                    {
                        // Throw error.
                        throw new Exception("Stored Procedure 'dbo.USP_InventoryIssueMasterAndDetails_Delete' reported the ErrorCode: " + _errorCode);
                    }
                    //if (_rowsAffected > 0)
                    //{
                    //    response.Entity = item;
