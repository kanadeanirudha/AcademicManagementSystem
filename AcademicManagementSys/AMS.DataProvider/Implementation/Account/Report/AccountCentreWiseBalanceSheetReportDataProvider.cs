            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        if (DBNull.Value.Equals(sqlDataReader["AccBalsheetHeadDesc"]) == false && item.AccBalsheetCode != string.Empty)
                        {
                            item.AccBalsheetHeadDesc = sqlDataReader["AccBalsheetHeadDesc"].ToString() + "[" + item.AccBalsheetCode + "]"; ;
                        }
                        else
                        {
                            item.AccBalsheetHeadDesc = sqlDataReader["AccBalsheetHeadDesc"].ToString();
                        }
                        if (DBNull.Value.Equals(sqlDataReader["AccBalsheetTypeCode"]) == false)
                        {
                            item.AccBalsheetTypeCode = sqlDataReader["AccBalsheetTypeCode"].ToString();
                        }
