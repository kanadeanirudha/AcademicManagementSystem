        ...
        public IBaseEntityCollectionResponse<AccountDayBookReport> GetAccountDayBookReportBySearch(AccountDayBookReportSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    cmdToExecute.Parameters.Add(new SqlParameter("@nsPatternOn", SqlDbType.NVarChar, 15, ParameterDirection.Input, true, 10, 0, "", DataRowVersion.Proposed,!string.IsNullOrEmpty(searchRequest.PatternType)? searchRequest.PatternType: string.Empty));
