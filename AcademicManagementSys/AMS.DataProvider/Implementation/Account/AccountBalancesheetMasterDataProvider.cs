            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        item.AccBalsheetTypeID = Convert.ToByte(sqlDataReader["AccBalsheetTypeID"]);
        ...
        public IBaseEntityCollectionResponse<AccountBalancesheetMaster> GetBalancesheetForMultipleSelectList(AccountBalancesheetMasterSearchRequest searchRequest)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        AccountBalancesheetMaster item = new AccountBalancesheetMaster();
                        item.ID = Convert.ToInt16(sqlDataReader["AccBalsheetMstID"]);
                        item.StatusFlag = Convert.ToBoolean(sqlDataReader["StatusFlag"]);
                        item.CentreCode = sqlDataReader["CentreCode"].ToString();
                        item.AccountID = Convert.ToInt16(sqlDataReader["AccountID"]);
                        item.AccBalsheetHeadDesc = sqlDataReader["AccBalsheetHeadDesc"].ToString() + "     [" + item.CentreCode + "]";
                        baseEntityCollection.CollectionResponse.Add(item);
                    }
            ...
            try
            {
                ...
                else
                {
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        _item.AccBalsheetCode = sqlDataReader["AccBalsheetCode"].ToString();
                        _item.AccBalsheetHeadDesc = sqlDataReader["AccBalsheetHeadDesc"].ToString();
                        _item.AccBalsheetTypeID = Convert.ToByte(sqlDataReader["AccBalsheetTypeID"]);
