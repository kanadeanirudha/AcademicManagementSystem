...
{
	public interface IStudentMasterDataProvider
	{
		...
		IBaseEntityCollectionResponse<StudentMaster> GetStudentMasterBySearch(StudentMasterSearchRequest searchRequest);
		IBaseEntityResponse<StudentMaster> GetStudentMasterByID(StudentMaster item);
