...
{
    public interface IFeeStructureMasterAndDetailsDataProvider
    {
        ...
        IBaseEntityCollectionResponse<FeeStructureMasterAndDetails> GetFeeStructureMasterAndDetailsBySearch(FeeStructureMasterAndDetailsSearchRequest searchRequest);
        ...
        IBaseEntityResponse<FeeStructureMasterAndDetails> GetFeeStructureMasterAndDetailsByID(FeeStructureMasterAndDetails item);
