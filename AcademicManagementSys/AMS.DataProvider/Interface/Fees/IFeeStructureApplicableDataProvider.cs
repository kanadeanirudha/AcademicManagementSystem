...
{
	public interface IFeeStructureApplicableDataProvider
	{
		...
		IBaseEntityCollectionResponse<FeeStructureApplicable> GetFeeStructureApplicableBySearch(FeeStructureApplicableSearchRequest searchRequest);
		...
		IBaseEntityResponse<FeeStructureApplicable> GetFeeStructureApplicableByID(FeeStructureApplicable item);
