...
namespace AMS.Web.UI.Controllers
{
    public class GeneralTypeOfAccountController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/GeneralTypeOfAccount/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/GeneralTypeOfAccount/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/GeneralTypeOfAccount/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralTypeOfAccountViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralTypeOfAccountDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralTypeOfAccount> response = _GeneralTypeOfAccountServiceAcess.InsertGeneralTypeOfAccount(model.GeneralTypeOfAccountDTO);

                    model.GeneralTypeOfAccountDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(Int16 ID)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralTypeOfAccount> response = _GeneralTypeOfAccountServiceAcess.SelectByID(model.GeneralTypeOfAccountDTO);
                ...
                return PartialView("/Views/GeneralTypeOfAccount/Edit.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Edit(GeneralTypeOfAccountViewModel model)
        {
            try
            {
                if (model != null && model.GeneralTypeOfAccountDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralTypeOfAccount> response = _GeneralTypeOfAccountServiceAcess.UpdateGeneralTypeOfAccount(model.GeneralTypeOfAccountDTO);
                    model.GeneralTypeOfAccountDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralTypeOfAccountServiceAcess.DeleteGeneralTypeOfAccount(GeneralTypeOfAccountDTO);
        ...
        public IEnumerable<GeneralTypeOfAccountViewModel> GetGeneralTypeOfAccount(out int TotalRecords)
        {
            ...
            List<GeneralTypeOfAccount> listGeneralTypeOfAccount = new List<GeneralTypeOfAccount>();
            IBaseEntityCollectionResponse<GeneralTypeOfAccount> baseEntityCollectionResponse = _GeneralTypeOfAccountServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
