...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralMapTypeOfAccountServiceAccess _GeneralMapTypeOfAccountServiceAcess = null;
        IGeneralTypeOfAccountServiceAccess _GeneralTypeOfAccountServiceAccess = null;
        ...
        {
            _GeneralMapTypeOfAccountServiceAcess = new GeneralMapTypeOfAccountServiceAccess();
            _GeneralTypeOfAccountServiceAccess = new GeneralTypeOfAccountServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/GeneralMapTypeOfAccount/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/GeneralMapTypeOfAccount/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create(string ModuleName)
        {
            ...
            List<UserModuleMaster> UserModuleMaster = GetUserModuleMasterList();
            ...
            return PartialView("/Views/GeneralMapTypeOfAccount/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralMapTypeOfAccountViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralMapTypeOfAccountDTO != null)
                {
                    ...
                    model.GeneralMapTypeOfAccountDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
               ...
               // model.GeneralMapTypeOfAccountDTO.GeneralMapTypeOfAccountID = id;
                ...
                return PartialView("/Views/Inventory_1/GeneralMapTypeOfAccount/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        protected List<GeneralTypeOfAccount> GetAccountType()
        {
            ...
            IBaseEntityCollectionResponse<GeneralTypeOfAccount> baseEntityCollectionResponse = _GeneralTypeOfAccountServiceAccess.GetListAccountType(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
