...
namespace AMS.Web.UI.Controllers
{
    public class AccountTransactionTypeMasterController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/AccountTransactionTypeMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/AccountTransactionTypeMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/AccountTransactionTypeMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(AccountTransactionTypeMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.AccountTransactionTypeMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<AccountTransactionTypeMaster> response = _AccountTransactionTypeMasterServiceAcess.InsertAccountTransactionTypeMaster(model.AccountTransactionTypeMasterDTO);

                    model.AccountTransactionTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<AccountTransactionTypeMaster> response = _AccountTransactionTypeMasterServiceAcess.SelectByID(model.AccountTransactionTypeMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/AccountTransactionTypeMaster/Edit.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
            ...
            try
            {
                if (model != null && model.AccountTransactionTypeMasterDTO != null)
                {
                   ...
                   // model.AccountTransactionTypeMasterDTO.TransactionTypeCode = model.TransactionTypeCode;
                    ...
                    IBaseEntityResponse<AccountTransactionTypeMaster> response = _AccountTransactionTypeMasterServiceAcess.UpdateAccountTransactionTypeMaster(model.AccountTransactionTypeMasterDTO);
                    model.AccountTransactionTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _AccountTransactionTypeMasterServiceAcess.DeleteAccountTransactionTypeMaster(AccountTransactionTypeMasterDTO);
        ...
        public IEnumerable<AccountTransactionTypeMasterViewModel> GetAccountTransactionTypeMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountTransactionTypeMaster> baseEntityCollectionResponse = _AccountTransactionTypeMasterServiceAcess.GetBySearch(searchRequest);
