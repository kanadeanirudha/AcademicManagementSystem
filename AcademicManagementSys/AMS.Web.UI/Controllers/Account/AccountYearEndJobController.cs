...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IAccountSessionMasterServiceAccess _AccountSessionMasterServiceAcess = null;
        ...
        {
            _AccountSessionMasterServiceAcess = new AccountSessionMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/AccountYearEndJob/Index.cshtml",model);
