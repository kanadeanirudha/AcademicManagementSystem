...
namespace AMS.Web.UI.Controllers
{
    public class AccountProfitAndLossReportController : BaseController
    {
        ...
        IAccountProfitAndLossReportServiceAccess _accountProfitAndLossServiceAccessServiceAccess = null;
        ...
        {
            _accountProfitAndLossServiceAccessServiceAccess = new AccountProfitAndLossReportServiceAccess();
        }
        #endregion
        ...
        public ActionResult Index()
        {
            try
            {
                if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
                {
                    ...
                    return View("/Views/Accounts/AccountProfitAndLossReport/Index.cshtml", model);
                }
                else
                {
        ...
        public List<AccountProfitAndLossReport> GetAccountDetailsForReport(string IncomeExpenseFlag, out int format)
        {
            try
            {
                ...
                if ( _sessionFromDate != string.Empty && _sessionUptoDate != string.Empty && _GroupBy != string.Empty && _accSessionId != 0)
                {
                    ...
                    IBaseEntityCollectionResponse<AccountProfitAndLossReport> baseEntityCollectionResponse = _accountProfitAndLossServiceAccessServiceAccess.GetBySearch(searchRequest);
