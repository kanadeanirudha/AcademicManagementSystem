...
namespace AMS.Web.UI.Controllers
{
    public class AccountBalancesheetReportController : BaseController
    {
        ...
        IAccountBalancesheetReportServiceAccess _accountBalancesheetReportServiceAccess = null;
        ...
        {
            _accountBalancesheetReportServiceAccess = new AccountBalancesheetReportServiceAccess();
        }
        #endregion
        ...
        public ActionResult Index()
        {
            try
            {
                if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
                {
                    ...
                    return View("/Views/Accounts/AccountBalancesheetReport/Index.cshtml", model);
                }
                else
                {
        ...
        public List<AccountBalancesheetReport> GetAccountBalancesheetReport(string AssetLiabilityFlag,out int format)
        {
            try
            {
                ...
                if (_sessionFromDate != string.Empty && _sessionUptoDate != string.Empty && _GroupBy != string.Empty && _accSessionId != 0)
                {
                    ...
                    IBaseEntityCollectionResponse<AccountBalancesheetReport> baseEntityCollectionResponse = _accountBalancesheetReportServiceAccess.GetBySearch(searchRequest);
