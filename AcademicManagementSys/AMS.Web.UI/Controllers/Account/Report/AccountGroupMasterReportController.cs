...
namespace AMS.Web.UI.Controllers
{
    public class AccountGroupMasterReportController : BaseController
    {
        ...
        IAccountGroupMasterReportServiceAccess _accountGroupMasterReportServiceAccess = null;
        ...
        {
            _accountGroupMasterReportServiceAccess = new AccountGroupMasterReportServiceAccess();
        ...
        public ActionResult Index()
        {
            if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
            {
                ...
                return View("/Views/Accounts/AccountGroupMasterReport/Index.cshtml", model);
            }
            else
            {
        ...
        public List<AccountGroupMasterReport> GetGroupList(int categoryID)
        {
            ...
            IBaseEntityCollectionResponse<AccountGroupMasterReport> baseEntityCollectionResponse = _accountGroupMasterReportServiceAccess.GetGroupList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<AccountGroupMasterReport> GetGroupDetailsForReport()
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AccountGroupMasterReport> baseEntityCollectionResponse = _accountGroupMasterReportServiceAccess.GetBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
