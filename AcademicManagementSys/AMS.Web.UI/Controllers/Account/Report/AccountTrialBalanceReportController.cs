...
namespace AMS.Web.UI.Controllers
{
    public class AccountTrialBalanceReportController : BaseController
    {
        ...
        IAccountTrialBalanceReportServiceAccess _accountTrialBalanceServiceAccessServiceAccess = null;
        ...
        {
            _accountTrialBalanceServiceAccessServiceAccess = new AccountTrialBalanceReportServiceAccess();
        }
        #endregion
        ...
        public ActionResult Index()
        {
            try
            {
                if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
                {
                    ...
                    return View("/Views/Accounts/AccountTrialBalanceReport/Index.cshtml", model);
                }
                else
                {
        ...
        public List<AccountTrialBalanceReport> GetAccountDetailsForReport()
        {
            try
            {
                ...
                if (_balanesheetMstID > 0 && _sessionFromDate != string.Empty && _sessionUptoDate != string.Empty && _GroupBy != string.Empty && _accSessionId != 0)
                {
                    ...
                    IBaseEntityCollectionResponse<AccountTrialBalanceReport> baseEntityCollectionResponse = _accountTrialBalanceServiceAccessServiceAccess.GetBySearch(searchRequest);
