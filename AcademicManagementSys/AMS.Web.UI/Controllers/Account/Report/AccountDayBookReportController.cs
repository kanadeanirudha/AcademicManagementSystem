...
namespace AMS.Web.UI.Controllers
{
    public class AccountDayBookReportController : BaseController
    {
        ...
        IAccountDayBookReportServiceAccess _accountDayBookReportServiceAccess = null;
        ...
        {
            _accountDayBookReportServiceAccess = new AccountDayBookReportServiceAccess();
        ...
        public ActionResult Index()
        {
            try
            {
                if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
                {
                    ...
                    return View("/Views/Accounts/AccountDayBookReport/Index.cshtml", model);
                }
                else
                {
        ...
        public List<AccountDayBookReport> GetDayBookReportData(string centreCode)
         {
             try
             {
                 ...
                 if (_balanesheetMstID > 0)
                 {
                     ...
                     IBaseEntityCollectionResponse<AccountDayBookReport> baseEntityCollectionResponse = _accountDayBookReportServiceAccess.GetBySearch(searchRequest);
