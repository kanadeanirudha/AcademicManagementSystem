...
namespace AMS.Web.UI.Controllers
{
    public class AccountTradingReportController : BaseController
    {
        ...
        IAccountTradingReportServiceAccess _accountTradingReportServiceAccessServiceAccess = null;
        ...
        {
            _accountTradingReportServiceAccessServiceAccess = new AccountTradingReportServiceAccess();
        }
        #endregion
        ...
        public ActionResult Index()
        {
            try
            {
                if (Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["FinMgr"]) > 0)
                {
                    ...
                    return View("/Views/Accounts/AccountTradingReport/Index.cshtml", model);
                }
                else
                {
        ...
        public List<AccountTradingReport> GetAccountDetailsForReport(string IncomeExpenseFlag)
        {
            try
            {
                ...
                if (_balanesheetMstID > 0 && _sessionFromDate != string.Empty && _sessionUptoDate != string.Empty && _GroupBy != string.Empty && _accSessionId != 0)
                {
                    ...
                    IBaseEntityCollectionResponse<AccountTradingReport> baseEntityCollectionResponse = _accountTradingReportServiceAccessServiceAccess.GetBySearch(searchRequest);
