...
{
    public class StudentRollListReportController : BaseController
    {
        ...
        public StudentRollListReportController()
        {
        ...
        public ActionResult Index()//string CentreCode, string UniversityID, string SectionDetailID, string CourseYearId, string AcademicYear, string admissionStatus, string sortOrder, string ReportType, string actionMode)
        {
            try
            {
                ...
                return View("/Views/Student/Report/StudentRollListReport/Index.cshtml", model);
            }
            catch (Exception)
            {
        ...
        #region Methods
        // Non-Action Method 
        public List<StudentReport> GetListStudentRollListReport()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(searchRequest.AcademicYear) && !string.IsNullOrEmpty(searchRequest.AdmissionStatus))
                {
                    IBaseEntityCollectionResponse<StudentReport> baseEntityCollectionResponse = _StudentReportServiceAcess.GetBySearchForRollListwise(searchRequest);
