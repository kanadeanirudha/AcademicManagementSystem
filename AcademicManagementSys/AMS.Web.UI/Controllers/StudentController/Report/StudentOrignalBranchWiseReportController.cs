...
{
    public class StudentOrignalBranchWiseReportController : BaseController
    {
        ...
        public StudentOrignalBranchWiseReportController()
        {
        ...
        public ActionResult Index()//string CentreCode, string UniversityID, string SectionDetailID, string CourseYearId, string AcademicYear, string admissionStatus, string sortOrder, string ReportType, string actionMode)
        {
            try
            {
                ...
                return View("/Views/Student/Report/StudentOrignalBranchWiseReport/Index.cshtml", model);
            }
            catch (Exception)
            {
        ...
        public ActionResult Index(StudentReportViewModel model)//string SelectedHeadID, string SelectedCategoryID)
        {
            try
            {
                ...
                if (model.IsPosted == true)
                {
                    ...
                    _CourseYearId = !string.IsNullOrEmpty(model.Course_Section) && model.Course_Section == "C" ? Convert.ToInt32(model.SelectedCourseYearId) : 0; ;
        ...
        #region Methods
        // Non-Action Method 
        public List<StudentReport> GetListStudentOrignalBranchWiseReport()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(searchRequest.AcademicYear) && !string.IsNullOrEmpty(searchRequest.AdmissionStatus) && !string.IsNullOrEmpty(searchRequest.SortOrder))
                {
                    IBaseEntityCollectionResponse<StudentReport> baseEntityCollectionResponse = _StudentReportServiceAcess.GetBySearchForOrignalBranchwise(searchRequest);
