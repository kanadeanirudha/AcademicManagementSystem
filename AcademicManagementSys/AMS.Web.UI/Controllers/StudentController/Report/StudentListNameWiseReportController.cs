...
{
    public class StudentListNameWiseReportController : BaseController
    {
        ...
        protected static string _AdmissionStatus = "null";
        protected static string _SortOrder = "null";
        ...
        public StudentListNameWiseReportController()
        {
        ...
        public ActionResult Index()//string CentreCode, string UniversityID, string SectionDetailID, string CourseYearId, string AcademicYear, string admissionStatus, string sortOrder, string ReportType, string actionMode)
        {
            try
            {
                ...
                return View("/Views/Student/Report/StudentListNameWiseReport/Index.cshtml", model);
            }
            catch (Exception)
            {
        ...
        public ActionResult Index(StudentReportViewModel model)//string SelectedHeadID, string SelectedCategoryID)
        {
            try
            {
                ...
                ViewBag.AdmissionStatus = new SelectList(AdmissionStatus, "Value", "Text");
                List<SelectListItem> li_AdmissionStatus = new List<SelectListItem>();
                li_AdmissionStatus.Add(new SelectListItem { Text = "Both", Value = "null" });
                li_AdmissionStatus.Add(new SelectListItem { Text = "Provisional", Value = "P" });
                li_AdmissionStatus.Add(new SelectListItem { Text = "Confirm", Value = "C" });
                ViewData["AdmissionStatus"] = new SelectList(li_AdmissionStatus, "Value", "Text", model.StudentReportDTO.AdmissionStatus);
               ...
               if (model.IsPosted == true)
                ...
                //  model.ListAccountCategoryMasterReport = GetListStudentListNameWiseReport();
                return View("/Views/Student/Report/StudentListNameWiseReport/Index.cshtml", model);
            }
            catch (Exception)
            {
        ...
        #region Methods
        // Non-Action Method 
        public List<StudentReport> GetListStudentListNameWiseReport()
        {
            try
            {
                ...
                if ((searchRequest.SectionDetailID > 0 || searchRequest.CourseYearId >0) && !string.IsNullOrEmpty(searchRequest.AcademicYear) && !string.IsNullOrEmpty(searchRequest.AdmissionStatus))
                {
                    IBaseEntityCollectionResponse<StudentReport> baseEntityCollectionResponse = _StudentReportServiceAcess.GetBySearchForStudentList(searchRequest);
