...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IVendorMasterServiceAccess _VendorMasterServiceAcess = null;
        ...
        IVendorMasterServiceAccess _IVendorMasterServiceAccess = null;
        ...
        {
            _VendorMasterServiceAcess = new VendorMasterServiceAccess();
            ...
            _IVendorMasterServiceAccess = new VendorMasterServiceAccess();
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/VendorMaster/Index.cshtml", model);
        ...
        public ActionResult List(string actionMode, string TaskCode, string VendorNumber)
        {
            try
            {
                ...
                VendorMasterViewModel model = new VendorMasterViewModel();
                return PartialView("/Views/Inventory_1/VendorMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult ReplenishmentData(string TaskCode, string VendorName, string VendorID, string VendorNumber, string Currency)
        {
            ...
            //{
            //    IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.GetReplenishmentDataByVendorNumber(model.VendorMasterDTO);
            ...
            return PartialView("/Views/Inventory_1/VendorMaster/ReplenishmentData.cshtml", model);
        }
        [HttpGet]
        public ActionResult UploadExcel(string TaskCode, string VendorName, string VendorID, string VendorNumber, string Currency)
        {
            ...
            return PartialView("/Views/Inventory_1/VendorMaster/UploadExcel.cshtml", model);
        }
        [HttpGet]
        public ActionResult FinanceData(string TaskCode, string VendorName, string VendorID, string VendorNumber)
        {
            ...
            if (model.VendorMasterDTO.VendorID > 0)
            {
                IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.GetFinanceDataByVendorNumber(model.VendorMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            return PartialView("/Views/Inventory_1/VendorMaster/FinanceData.cshtml", model);
        }
        public ActionResult GeneralData(string TaskCode, string VendorID, string VendorNumber)
        {
            ...
            if (model.VendorMasterDTO.VendorID > 0)
            {
                IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.GetGeneralDataByVendorNumber(model.VendorMasterDTO);
                if (response != null && response.Entity != null)
                {
                    ...
                    model.VendorMasterDTO.City = response.Entity.City;
            ...
            return PartialView("/Views/Inventory_1/VendorMaster/GeneralData.cshtml", model);
        }
        ...
        public ActionResult Create(VendorMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.VendorMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.InsertVendorMaster(model.VendorMasterDTO);
                    model.VendorMasterDTO.VendorNumber = response.Entity.VendorNumber;
                    model.VendorMasterDTO.VendorID = model.VendorID;

                    model.VendorMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult UploadExcel(VendorMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.VendorMasterDTO != null)
                {
                    ...
                    {
                        IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.InsertVendorMasterExcel(model.VendorMasterDTO);
                      //  model.VendorMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.SelectByID(model.VendorMasterDTO);
        //        if (response != null && response.Entity != null)
        //        {
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.VendorMasterDTO != null)
                {
                    if (model != null && model.VendorMasterDTO != null)
                    {
                        ...
                        model.VendorMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.UpdateVendorMaster(model.VendorMasterDTO);
        ...
        public ActionResult Delete(int VendorID)
        {
            ...
            if (VendorID > 0)
            {
                ...
                response = _VendorMasterServiceAcess.DeleteVendorMaster(model.VendorMasterDTO);
                string errorMessageDis = string.Empty;
                string colorCode = string.Empty;
                string mode = string.Empty;
        ...
        public List<GeneralCityMaster> GetCityListDetails(string SearchKeyWord)
        {
            ...
            IBaseEntityCollectionResponse<GeneralCityMaster> baseEntityCollectionResponse = _generalCityMasterServiceAcess.GetBySearchList(searchRequest);
        ...
        protected List<VendorMaster> GetVendorMasterListForGeneralData(string VendorID)
        {
            ...
            IBaseEntityCollectionResponse<VendorMaster> baseEntityCollectionResponse = _VendorMasterServiceAcess.GetContactPersonDetailsForVendorMaster(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<VendorMaster> GetVendorMasterListForPersonalDetails(string VendorID)
        {
            ...
            searchRequest.VendorID = Convert.ToInt32(!string.IsNullOrEmpty(VendorID) ? VendorID : null);
            List<VendorMaster> listVendorMaster = new List<VendorMaster>();
            IBaseEntityCollectionResponse<VendorMaster> baseEntityCollectionResponse = _VendorMasterServiceAcess.GetReplenishmentDataByVendorNumber(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public JsonResult GetVendorSearchList(string term)
        {
            ...
            IBaseEntityCollectionResponse<VendorMaster> baseEntityCollectionResponse = _VendorMasterServiceAcess.GetVendorMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public IEnumerable<VendorMasterViewModel> GetVendorMaster(out int TotalRecords)
        {
            ...
            List<VendorMaster> listVendorMaster = new List<VendorMaster>();
            IBaseEntityCollectionResponse<VendorMaster> baseEntityCollectionResponse = _VendorMasterServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public void CreateExcelDoc(string fileName)
        {
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(fileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                VendorMasterViewModel model = new VendorMasterViewModel();
                model.VendorMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAcess.GetDataValidationListsForExcel(model.VendorMasterDTO);
                if (response != null && response.Entity != null)
                {
