...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryStockAdjustmentServiceAccess _InventoryStockAdjustmentServiceAcess = null;
        ...
        {
            _InventoryStockAdjustmentServiceAcess = new InventoryStockAdjustmentServiceAccess();
        ...
        public ActionResult Index(string CentreCode)
        {
            ...
            List<InventoryLocationMaster_1> locationMasterList = GetInventoryIssueLocationMasterList();
         ...
         //   model.InventoryStockAdjustmentDTO.CentreCode = CentreCode;
            ...
            return View("/Views/Inventory_1/InventoryStockAdjustment/Index.cshtml", model);
        ...
        public ActionResult RestaurantItemIndex(string CentreCode)
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryStockAdjustment/RestaurantItemIndex.cshtml", model);
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryStockAdjustment/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryStockAdjustment/Create.cshtml", model);
        }
        ...
        public ActionResult Create(InventoryStockAdjustmentViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryStockAdjustmentDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryStockAdjustment> response = _InventoryStockAdjustmentServiceAcess.InsertInventoryStockAdjustment(model.InventoryStockAdjustmentDTO);
                    ...
                    model.InventoryStockAdjustmentDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult CreateBtnAdd(InventoryStockAdjustmentViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryStockAdjustmentDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryStockAdjustment> response = _InventoryStockAdjustmentServiceAcess.InsertInventoryStockAdjustmentXML(model.InventoryStockAdjustmentDTO);
        ...
        public ActionResult CreateRecipeItemStockAdjustment(InventoryStockAdjustmentViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryStockAdjustmentDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryStockAdjustment> response = _InventoryStockAdjustmentServiceAcess.InsertInventoryStockAdjustmentXMLForRecipe(model.InventoryStockAdjustmentDTO);
        ...
        public ActionResult Delete(int InventoryPhysicalStockAdjustmentID)
        {
            ...
            if (InventoryPhysicalStockAdjustmentID > 0)
            {
                ...
                response = _InventoryStockAdjustmentServiceAcess.DeleteInventoryStockAdjustment(InventoryStockAdjustmentDTO);
        ...
        #endregion
        protected List<InventoryLocationMaster_1> GetInventoryIssueLocationMasterList()
        {
        ...
        protected List<InventoryStockAdjustment> GetInventoryItemBatchMasterList(int ItemNumber, Int16 GeneralUnitsID)
        {
            ...
            IBaseEntityCollectionResponse<InventoryStockAdjustment> baseEntityCollectionResponse = _InventoryStockAdjustmentServiceAcess.GetInventoryItemBatchMasterList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<InventoryStockAdjustment> GetItemDescriptionDetailsdata(string SearchKeyWord, int GeneralUnitsID, string CurrentStockStatus)
        {
            ...
            IBaseEntityCollectionResponse<InventoryStockAdjustment> baseEntityCollectionResponse = _InventoryStockAdjustmentServiceAcess.GetItemNameForCurrentStock(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<InventoryStockAdjustment> GetRecipeItemDescriptionDetailsdata(string SearchKeyWord, int GeneralUnitsID)
        {
            ...
            searchRequest.InvLocationMasterID = GeneralUnitsID;
            List<InventoryStockAdjustment> listAccount = new List<InventoryStockAdjustment>();
            IBaseEntityCollectionResponse<InventoryStockAdjustment> baseEntityCollectionResponse = _InventoryStockAdjustmentServiceAcess.GetInventoryStockAdjustmentSearchListForRecipeItem(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<InventoryStockAdjustment> GetInventoryStockAdjustmentIngridentListForRecipeItemData(int InventoryRecipeMasterID, int GeneralUnitsID,int InventoryVariationMasterID)
        {
            ...
            List<InventoryStockAdjustment> listAccount = new List<InventoryStockAdjustment>();
            IBaseEntityCollectionResponse<InventoryStockAdjustment> baseEntityCollectionResponse = _InventoryStockAdjustmentServiceAcess.GetInventoryStockAdjustmentIngridentListForRecipeItem(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public IEnumerable<InventoryStockAdjustmentViewModel> GetInventoryStockAdjustment(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryStockAdjustment> baseEntityCollectionResponse = _InventoryStockAdjustmentServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
