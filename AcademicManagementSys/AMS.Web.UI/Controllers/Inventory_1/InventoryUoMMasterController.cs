...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryUoMMasterServiceAccess _InventoryUoMMasterServiceAcess = null;
        ...
        {
            _InventoryUoMMasterServiceAcess = new InventoryUoMMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/InventoryUoMMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryUoMMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create(string IDs)
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryUoMMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(InventoryUoMMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryUoMMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryUoMMaster> response = _InventoryUoMMasterServiceAcess.InsertInventoryUoMMaster(model.InventoryUoMMasterDTO);

                    model.InventoryUoMMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<InventoryUoMMaster> response = _InventoryUoMMasterServiceAcess.SelectByID(model.InventoryUoMMasterDTO);
        ...
        //                IBaseEntityResponse<InventoryUoMMaster> response = _InventoryUoMMasterServiceAcess.UpdateInventoryUoMMaster(model.InventoryUoMMasterDTO);
        ...
        public ActionResult ViewDetails(string ID)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryUoMMaster/ViewDetails.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _InventoryUoMMasterServiceAcess.DeleteInventoryUoMMaster(InventoryUoMMasterDTO);
        ...
        public IEnumerable<InventoryUoMMasterViewModel> GetInventoryUoMMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryUoMMaster> baseEntityCollectionResponse = _InventoryUoMMasterServiceAcess.GetBySearch(searchRequest);
