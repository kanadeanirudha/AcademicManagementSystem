...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemMerchantiseDepartmentServiceAccess _GeneralItemMerchantiseDepartmentServiceAcess = null;
        ...
        {
            _GeneralItemMerchantiseDepartmentServiceAcess = new GeneralItemMerchantiseDepartmentServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMerchantiseDepartment/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMerchantiseDepartment/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMerchantiseDepartment/Create.cshtml", model);
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralItemMerchantiseDepartmentDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMerchantiseDepartment> response = _GeneralItemMerchantiseDepartmentServiceAcess.InsertGeneralItemMerchantiseDepartment(model.GeneralItemMerchantiseDepartmentDTO);

                        model.GeneralItemMerchantiseDepartmentDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralItemMerchantiseDepartment> response = _GeneralItemMerchantiseDepartmentServiceAcess.SelectByID(model.GeneralItemMerchantiseDepartmentDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMerchantiseDepartment/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMerchantiseDepartmentDTO != null)
                {
                    if (model != null && model.GeneralItemMerchantiseDepartmentDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMerchantiseDepartment> response = _GeneralItemMerchantiseDepartmentServiceAcess.UpdateGeneralItemMerchantiseDepartment(model.GeneralItemMerchantiseDepartmentDTO);
                        model.GeneralItemMerchantiseDepartmentDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralItemMerchantiseDepartmentDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMerchantiseDepartmentServiceAcess.DeleteGeneralItemMerchantiseDepartment(GeneralItemMerchantiseDepartmentDTO);
        ...
        public IEnumerable<GeneralItemMerchantiseDepartmentViewModel> GetGeneralItemMerchantiseDepartment(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseDepartment> baseEntityCollectionResponse = _GeneralItemMerchantiseDepartmentServiceAcess.GetBySearch(searchRequest);
