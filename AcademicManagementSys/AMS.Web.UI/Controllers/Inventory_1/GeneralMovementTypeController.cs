...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralMovementTypeServiceAccess _GeneralMovementTypeServiceAcess = null;
        ...
        {
            _GeneralMovementTypeServiceAcess = new GeneralMovementTypeServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralMovementType/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralMovementType/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralMovementType/Create.cshtml", model);
        }
        ...
        public ActionResult CreateMovementTypeRules(string IDs)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralMovementType/CreateMovementTypeRules.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralMovementTypeViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralMovementTypeDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralMovementType> response = _GeneralMovementTypeServiceAcess.InsertGeneralMovementType(model.GeneralMovementTypeDTO);

                    model.GeneralMovementTypeDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult CreateMovementTypeRules(GeneralMovementTypeViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralMovementTypeDTO != null)
                {
                    ...
                    model.GeneralMovementTypeDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralMovementType> response = _GeneralMovementTypeServiceAcess.InsertGeneralMovementTypeRules(model.GeneralMovementTypeDTO);
        ...
        //        IBaseEntityResponse<GeneralMovementType> response = _GeneralMovementTypeServiceAcess.SelectByID(model.GeneralMovementTypeDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralMovementTypeDTO != null)
                {
                    if (model != null && model.GeneralMovementTypeDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralMovementType> response = _GeneralMovementTypeServiceAcess.UpdateGeneralMovementType(model.GeneralMovementTypeDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralMovementTypeServiceAcess.DeleteGeneralMovementType(GeneralMovementTypeDTO);
        ...
        public IEnumerable<GeneralMovementTypeViewModel> GetGeneralMovementType(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralMovementType> baseEntityCollectionResponse = _GeneralMovementTypeServiceAcess.GetBySearch(searchRequest);
