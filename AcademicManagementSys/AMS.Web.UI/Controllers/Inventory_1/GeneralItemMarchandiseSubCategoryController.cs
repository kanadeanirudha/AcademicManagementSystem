...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemMarchandiseSubCategoryServiceAccess _GeneralItemMarchandiseSubCategoryServiceAcess = null;
        ...
        {
            _GeneralItemMarchandiseSubCategoryServiceAcess = new GeneralItemMarchandiseSubCategoryServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMarchandiseSubCategory/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseSubCategory/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMarchandiseSubCategory/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralItemMarchandiseSubCategoryViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMarchandiseSubCategoryDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralItemMarchandiseSubCategory> response = _GeneralItemMarchandiseSubCategoryServiceAcess.InsertGeneralItemMarchandiseSubCategory(model.GeneralItemMarchandiseSubCategoryDTO);

                    model.GeneralItemMarchandiseSubCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralItemMarchandiseSubCategory> response = _GeneralItemMarchandiseSubCategoryServiceAcess.SelectByID(model.GeneralItemMarchandiseSubCategoryDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseSubCategory/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMarchandiseSubCategoryDTO != null)
                {
                    if (model != null && model.GeneralItemMarchandiseSubCategoryDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMarchandiseSubCategory> response = _GeneralItemMarchandiseSubCategoryServiceAcess.UpdateGeneralItemMarchandiseSubCategory(model.GeneralItemMarchandiseSubCategoryDTO);
                        model.GeneralItemMarchandiseSubCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralItemMarchandiseSubCategoryDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMarchandiseSubCategoryServiceAcess.DeleteGeneralItemMarchandiseSubCategory(GeneralItemMarchandiseSubCategoryDTO);
        ...
        public IEnumerable<GeneralItemMarchandiseSubCategoryViewModel> GetGeneralItemMarchandiseSubCategory(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseSubCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseSubCategoryServiceAcess.GetBySearch(searchRequest);
