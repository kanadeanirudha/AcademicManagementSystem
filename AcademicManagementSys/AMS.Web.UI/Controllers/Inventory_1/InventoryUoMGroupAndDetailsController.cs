...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryUoMGroupAndDetailsServiceAccess _InventoryUoMGroupAndDetailsServiceAcess = null;
        ...
        {
            _InventoryUoMGroupAndDetailsServiceAcess = new InventoryUoMGroupAndDetailsServiceAccess();
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/InventoryUoMGroupAndDetails/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryUoMGroupAndDetails/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult CreateGroup()
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryUoMGroupAndDetails/CreateGroup.cshtml", model);
        }
        [HttpPost]
        public ActionResult CreateGroup(InventoryUoMGroupAndDetailsViewModel model)
        {
            try
            {
                if (model != null && model.InventoryUoMGroupAndDetailsDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryUoMGroupAndDetails> response = _InventoryUoMGroupAndDetailsServiceAcess.InsertInventoryUoMGroup(model.InventoryUoMGroupAndDetailsDTO);
                    model.InventoryUoMGroupAndDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult CreateGroupDetails(string IDs)
        {
            ...
            IBaseEntityCollectionResponse<InventoryUoMGroupAndDetails> baseEntityCollectionResponse = _InventoryUoMGroupAndDetailsServiceAcess.SelectByInventoryUoMGroupID(searchRequest);
            ...
            return PartialView("/Views/Inventory_1/InventoryUoMGroupAndDetails/CreateGroupDetails.cshtml", model);
        }
        ...
        public ActionResult CreateGroupDetails(InventoryUoMGroupAndDetailsViewModel model)
        {
            try
            {
                if (model != null && model.InventoryUoMGroupAndDetailsDTO != null)
                {
                    ...
                    model.InventoryUoMGroupAndDetailsDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<InventoryUoMGroupAndDetails> response = _InventoryUoMGroupAndDetailsServiceAcess.InsertInventoryUoMGroupAndDetails(model.InventoryUoMGroupAndDetailsDTO);
                    model.InventoryUoMGroupAndDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    return Json(model.InventoryUoMGroupAndDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                return Json("Please review your form");
        ...
        public ActionResult ViewDetails(Int16 id)
        {
            ...
            try
            {
               ...
               // model.InventoryUoMGroupAndDetailsDTO.ID = id;
                ...
                IBaseEntityResponse<InventoryUoMGroupAndDetails> response = _InventoryUoMGroupAndDetailsServiceAcess.SelectByID(model.InventoryUoMGroupAndDetailsDTO);
                ...
                return PartialView("/Views/Inventory_1/InventoryUoMGroupAndDetails/View.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _InventoryUoMGroupAndDetailsServiceAcess.DeleteInventoryUoMGroupAndDetails(InventoryUoMGroupAndDetailsDTO);
        ...
        public IEnumerable<InventoryUoMGroupAndDetailsViewModel> GetInventoryUoMGroupAndDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryUoMGroupAndDetails> baseEntityCollectionResponse = _InventoryUoMGroupAndDetailsServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
