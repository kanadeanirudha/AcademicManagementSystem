...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralPurchaseGroupMasterServiceAccess _GeneralPurchaseGroupMasterServiceAcess = null;
        ...
        {
            _GeneralPurchaseGroupMasterServiceAcess = new GeneralPurchaseGroupMasterServiceAccess();
        }
        ...
        {
            return View("/Views/Inventory_1/GeneralPurchaseGroupMaster/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralPurchaseGroupMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        {
            GeneralPurchaseGroupMasterViewModel model = new GeneralPurchaseGroupMasterViewModel();
            return PartialView("/Views/Inventory_1/GeneralPurchaseGroupMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralPurchaseGroupMasterViewModel model)
        {
            try
            {
                if (model != null && model.GeneralPurchaseGroupMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralPurchaseGroupMaster> response = _GeneralPurchaseGroupMasterServiceAcess.InsertGeneralPurchaseGroupMaster(model.GeneralPurchaseGroupMasterDTO);
        ...
        public ActionResult Delete(GeneralPurchaseGroupMasterViewModel model)
        {
            ...
            if (!ModelState.IsValid)
            {
                if (model.ID > 0)
                {
                    ...
                    IBaseEntityResponse<GeneralPurchaseGroupMaster> response = _GeneralPurchaseGroupMasterServiceAcess.DeleteGeneralPurchaseGroupMaster(GeneralPurchaseGroupMasterDTO);
        ...
        public IEnumerable<GeneralPurchaseGroupMaster> GetGeneralPurchaseGroupMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralPurchaseGroupMaster> baseEntityCollectionResponse = _GeneralPurchaseGroupMasterServiceAcess.GetBySearch(searchRequest);
