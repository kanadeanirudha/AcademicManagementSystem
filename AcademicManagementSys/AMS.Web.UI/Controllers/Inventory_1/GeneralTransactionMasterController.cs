...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralTransactionMasterServiceAccess _GeneralTransactionMasterServiceAcess = null;
        ...
        {
            _GeneralTransactionMasterServiceAcess = new GeneralTransactionMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralTransactionMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralTransactionMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralTransactionMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralTransactionMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralTransactionMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralTransactionMaster> response = _GeneralTransactionMasterServiceAcess.InsertGeneralTransactionMaster(model.GeneralTransactionMasterDTO);

                    model.GeneralTransactionMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<GeneralTransactionMaster> response = _GeneralTransactionMasterServiceAcess.SelectByID(model.GeneralTransactionMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralTransactionMasterDTO != null)
                {
                    if (model != null && model.GeneralTransactionMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralTransactionMaster> response = _GeneralTransactionMasterServiceAcess.UpdateGeneralTransactionMaster(model.GeneralTransactionMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralTransactionMasterServiceAcess.DeleteGeneralTransactionMaster(GeneralTransactionMasterDTO);
        ...
        public IEnumerable<GeneralTransactionMasterViewModel> GetGeneralTransactionMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTransactionMaster> baseEntityCollectionResponse = _GeneralTransactionMasterServiceAcess.GetBySearch(searchRequest);
