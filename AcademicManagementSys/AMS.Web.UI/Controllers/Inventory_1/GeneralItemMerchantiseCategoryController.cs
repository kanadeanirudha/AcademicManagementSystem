...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemMerchantiseCategoryServiceAccess _GeneralItemMerchantiseCategoryServiceAcess = null;
        ...
        {
            _GeneralItemMerchantiseCategoryServiceAcess = new GeneralItemMerchantiseCategoryServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMerchantiseCategory/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMerchantiseCategory/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMerchantiseCategory/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralItemMerchantiseCategoryViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMerchantiseCategoryDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralItemMerchantiseCategory> response = _GeneralItemMerchantiseCategoryServiceAcess.InsertGeneralItemMerchantiseCategory(model.GeneralItemMerchantiseCategoryDTO);

                    model.GeneralItemMerchantiseCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralItemMerchantiseCategory> response = _GeneralItemMerchantiseCategoryServiceAcess.SelectByID(model.GeneralItemMerchantiseCategoryDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMerchantiseCategory/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMerchantiseCategoryDTO != null)
                {
                    if (model != null && model.GeneralItemMerchantiseCategoryDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMerchantiseCategory> response = _GeneralItemMerchantiseCategoryServiceAcess.UpdateGeneralItemMerchantiseCategory(model.GeneralItemMerchantiseCategoryDTO);
                        model.GeneralItemMerchantiseCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralItemMerchantiseCategoryDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMerchantiseCategoryServiceAcess.DeleteGeneralItemMerchantiseCategory(GeneralItemMerchantiseCategoryDTO);
        ...
        public IEnumerable<GeneralItemMerchantiseCategoryViewModel> GetGeneralItemMerchantiseCategory(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseCategory> baseEntityCollectionResponse = _GeneralItemMerchantiseCategoryServiceAcess.GetBySearch(searchRequest);
