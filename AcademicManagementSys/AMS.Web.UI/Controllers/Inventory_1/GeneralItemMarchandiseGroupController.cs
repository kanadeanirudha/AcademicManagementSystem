...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemMarchandiseGroupServiceAccess _GeneralItemMarchandiseGroupServiceAcess = null;
        ...
        {
            _GeneralItemMarchandiseGroupServiceAcess = new GeneralItemMarchandiseGroupServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMarchandiseGroup/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseGroup/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            GeneralItemMarchandiseGroupViewModel model = new GeneralItemMarchandiseGroupViewModel();
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseGroup/Create.cshtml", model);
                  }
            ...
            try
            {
               ...
               // {
                    if (model != null && model.GeneralItemMarchandiseGroupDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMarchandiseGroup> response = _GeneralItemMarchandiseGroupServiceAcess.InsertGeneralItemMarchandiseGroup(model.GeneralItemMarchandiseGroupDTO);

                        model.GeneralItemMarchandiseGroupDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralItemMarchandiseGroup> response = _GeneralItemMarchandiseGroupServiceAcess.SelectByID(model.GeneralItemMarchandiseGroupDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseGroup/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMarchandiseGroupDTO != null)
                {
                    if (model != null && model.GeneralItemMarchandiseGroupDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMarchandiseGroup> response = _GeneralItemMarchandiseGroupServiceAcess.UpdateGeneralItemMarchandiseGroup(model.GeneralItemMarchandiseGroupDTO);
                        model.GeneralItemMarchandiseGroupDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralItemMarchandiseGroupDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMarchandiseGroupServiceAcess.DeleteGeneralItemMarchandiseGroup(GeneralItemMarchandiseGroupDTO);
        ...
        public IEnumerable<GeneralItemMarchandiseGroupViewModel> GetGeneralItemMarchandiseGroup(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseGroup> baseEntityCollectionResponse = _GeneralItemMarchandiseGroupServiceAcess.GetBySearch(searchRequest);
