...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralPackageTypeServiceAccess _GeneralPackageTypeServiceAcess = null;
        ...
        {
            _GeneralPackageTypeServiceAcess = new GeneralPackageTypeServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralPackageType/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralPackageType/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralPackageType/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralPackageTypeViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralPackageTypeDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralPackageType> response = _GeneralPackageTypeServiceAcess.InsertGeneralPackageType(model.GeneralPackageTypeDTO);

                    model.GeneralPackageTypeDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralPackageTypeDTO != null)
                {
                    if (model != null && model.GeneralPackageTypeDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralPackageType> response = _GeneralPackageTypeServiceAcess.UpdateGeneralPackageType(model.GeneralPackageTypeDTO);
        ...
        public ActionResult ViewDetails(string ID)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralPackageType> response = _GeneralPackageTypeServiceAcess.SelectByID(model.GeneralPackageTypeDTO);
               ...
               return PartialView("/Views/Inventory_1/GeneralPackageType/ViewDetails.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralPackageTypeServiceAcess.DeleteGeneralPackageType(GeneralPackageTypeDTO);
        ...
        public IEnumerable<GeneralPackageTypeViewModel> GetGeneralPackageType(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralPackageType> baseEntityCollectionResponse = _GeneralPackageTypeServiceAcess.GetBySearch(searchRequest);
