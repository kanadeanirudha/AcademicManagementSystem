...
namespace AMS.Web.UI.Controllers
{
    public class GeneralPriceListAndListLineController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralPriceListAndListLine/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralPriceListAndListLine/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            IBaseEntityResponse<GeneralPriceListAndListLine> response = _GeneralPriceListAndListLineServiceAcess.GetIsRootCount(model.GeneralPriceListAndListLineDTO);
            ...
            return PartialView("/Views/Inventory_1/GeneralPriceListAndListLine/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralPriceListAndListLineViewModel model)
        {
            try
            {
                if (model != null && model.GeneralPriceListAndListLineDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralPriceListAndListLine> response = _GeneralPriceListAndListLineServiceAcess.InsertGeneralPriceListAndListLine(model.GeneralPriceListAndListLineDTO);
                    model.GeneralPriceListAndListLineDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult ViewDetails(Int16 id)
        {
            ...
            try
            {
               ...
               // model.GeneralPriceListAndListLineDTO.ID = id;
                ...
                IBaseEntityResponse<GeneralPriceListAndListLine> response = _GeneralPriceListAndListLineServiceAcess.SelectByID(model.GeneralPriceListAndListLineDTO);
                if (response != null && response.Entity != null)
                {
                ...
                return PartialView("/Views/Inventory_1/GeneralPriceListAndListLine/View.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralPriceListAndListLineServiceAcess.DeleteGeneralPriceListAndListLine(GeneralPriceListAndListLineDTO);
        ...
        public IEnumerable<GeneralPriceListAndListLineViewModel> GetGeneralPriceListAndListLine(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralPriceListAndListLine> baseEntityCollectionResponse = _GeneralPriceListAndListLineServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
