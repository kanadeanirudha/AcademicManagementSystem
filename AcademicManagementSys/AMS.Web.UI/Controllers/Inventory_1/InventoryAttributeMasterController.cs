...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryAttributeMasterServiceAccess _InventoryAttributeMasterServiceAcess = null;
        ...
        {
            _InventoryAttributeMasterServiceAcess = new InventoryAttributeMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/InventoryAttributeMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryAttributeMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryAttributeMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(InventoryAttributeMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryAttributeMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryAttributeMaster> response = _InventoryAttributeMasterServiceAcess.InsertInventoryAttributeMaster(model.InventoryAttributeMasterDTO);

                    model.InventoryAttributeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<InventoryAttributeMaster> response = _InventoryAttributeMasterServiceAcess.SelectByID(model.InventoryAttributeMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryAttributeMaster/Edit.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Edit(InventoryAttributeMasterViewModel model)
        {
            try
            {
                if (model != null && model.InventoryAttributeMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryAttributeMaster> response = _InventoryAttributeMasterServiceAcess.UpdateInventoryAttributeMaster(model.InventoryAttributeMasterDTO);
                    model.InventoryAttributeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _InventoryAttributeMasterServiceAcess.DeleteInventoryAttributeMaster(InventoryAttributeMasterDTO);
        ...
        public IEnumerable<InventoryAttributeMasterViewModel> GetInventoryAttributeMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryAttributeMaster> baseEntityCollectionResponse = _InventoryAttributeMasterServiceAcess.GetBySearch(searchRequest);
