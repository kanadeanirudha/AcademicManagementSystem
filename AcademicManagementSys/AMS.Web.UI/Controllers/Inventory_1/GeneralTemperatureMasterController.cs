...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralTemperatureMasterServiceAccess _GeneralTemperatureMasterServiceAcess = null;
        ...
        {
            _GeneralTemperatureMasterServiceAcess = new GeneralTemperatureMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralTemperatureMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralTemperatureMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralTemperatureMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralTemperatureMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralTemperatureMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralTemperatureMaster> response = _GeneralTemperatureMasterServiceAcess.InsertGeneralTemperatureMaster(model.GeneralTemperatureMasterDTO);

                    model.GeneralTemperatureMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralTemperatureMasterDTO != null)
                {
                    if (model != null && model.GeneralTemperatureMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralTemperatureMaster> response = _GeneralTemperatureMasterServiceAcess.UpdateGeneralTemperatureMaster(model.GeneralTemperatureMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralTemperatureMaster> response = _GeneralTemperatureMasterServiceAcess.SelectByID(model.GeneralTemperatureMasterDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralTemperatureMaster/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralTemperatureMasterServiceAcess.DeleteGeneralTemperatureMaster(GeneralTemperatureMasterDTO);
        ...
        public IEnumerable<GeneralTemperatureMasterViewModel> GetGeneralTemperatureMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTemperatureMaster> baseEntityCollectionResponse = _GeneralTemperatureMasterServiceAcess.GetBySearch(searchRequest);
