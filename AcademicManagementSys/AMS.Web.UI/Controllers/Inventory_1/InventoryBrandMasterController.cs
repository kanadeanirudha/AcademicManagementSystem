...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryBrandMasterServiceAccess _InventoryBrandMasterServiceAcess = null;
        ...
        {
            _InventoryBrandMasterServiceAcess = new InventoryBrandMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/InventoryBrandMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/InventoryBrandMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/InventoryBrandMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(InventoryBrandMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryBrandMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryBrandMaster> response = _InventoryBrandMasterServiceAcess.InsertInventoryBrandMaster(model.InventoryBrandMasterDTO);

                    model.InventoryBrandMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(Int16 id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<InventoryBrandMaster> response = _InventoryBrandMasterServiceAcess.SelectByID(model.InventoryBrandMasterDTO);
                ...
                return PartialView("/Views/Inventory_1/InventoryBrandMaster/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        try
            {
                if (model != null && model.InventoryBrandMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<InventoryBrandMaster> response = _InventoryBrandMasterServiceAcess.UpdateInventoryBrandMaster(model.InventoryBrandMasterDTO);
                    model.InventoryBrandMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _InventoryBrandMasterServiceAcess.DeleteInventoryBrandMaster(InventoryBrandMasterDTO);
        ...
        public IEnumerable<InventoryBrandMasterViewModel> GetInventoryBrandMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryBrandMaster> baseEntityCollectionResponse = _InventoryBrandMasterServiceAcess.GetBySearch(searchRequest);
