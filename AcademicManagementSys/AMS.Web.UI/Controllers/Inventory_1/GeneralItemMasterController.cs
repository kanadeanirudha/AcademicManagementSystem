...
namespace AMS.Web.UI.Controllers
{
    public class GeneralItemMasterController : BaseController
    {
        ...
        IGeneralPriceListAndListLineServiceAccess _GeneralPriceListAndListLineServiceAcess = null;
        IGeneralPriceGroupServiceAccess _GeneralPriceGroupServiceAccess = null;
        IGeneralItemCategoryMasterServiceAccess _GeneralItemCategoryMasterServiceAccess = null;
        IGeneralPurchaseGroupMasterServiceAccess _GeneralPurchaseGroupMasterServiceAccess = null;
        IGeneralSupplierMasterServiceAccess _IGeneralSupplierMasterServiceAccess = null;
        IGeneralPackageTypeServiceAccess _IGeneralPackageTypeServiceAccess = null;
        ...
        IOrderingAndDeliveryDayServiceAccess _OrderingAndDeliveryDayServiceAccess = null;
        IVendorMasterServiceAccess _VendorMasterServiceAccess = null;
        IGeneralTemperatureMasterServiceAccess _GeneraltemperatureMasterServiceAccess = null;
        IInventoryRecipeMenuCategoryServiceAccess _IInventoryRecipeMenuCategoryServiceAccess = null;

        IInventoryBrandMasterServiceAccess _InventoryBrandMasterServiceAccess = null;
        InventoryAttributeMasterServiceAccess _InventoryAttributeMasterServiceAccess = null;
        ...
        public GeneralItemMasterController()
        {
            ...
            _GeneralPriceListAndListLineServiceAcess = new GeneralPriceListAndListLineServiceAccess();
            _GeneralPriceGroupServiceAccess = new GeneralPriceGroupServiceAccess();
            _GeneralItemCategoryMasterServiceAccess = new GeneralItemCategoryMasterServiceAccess();
            _GeneralPurchaseGroupMasterServiceAccess = new GeneralPurchaseGroupMasterServiceAccess();
            _IGeneralSupplierMasterServiceAccess = new GeneralSupplierMasterServiceAccess();
            _IGeneralPackageTypeServiceAccess = new GeneralPackageTypeServiceAccess();
            ...
            _OrderingAndDeliveryDayServiceAccess = new OrderingAndDeliveryDayServiceAccess();
            _VendorMasterServiceAccess = new VendorMasterServiceAccess();
            _GeneraltemperatureMasterServiceAccess = new GeneralTemperatureMasterServiceAccess();
            _IInventoryRecipeMenuCategoryServiceAccess = new InventoryRecipeMenuCategoryServiceAccess();
            _InventoryBrandMasterServiceAccess = new InventoryBrandMasterServiceAccess();
            _InventoryAttributeMasterServiceAccess = new InventoryAttributeMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMaster/Index.cshtml", model);
        ...
        public ActionResult List(string actionMode, string TaskCode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GeneralItemUoMData(string TaskCode, string ItemNumber, string GeneralItemMasterID)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateUoMCodeData.cshtml", model);
        }
        public ActionResult CreateGeneralItemSuppliersData(string TaskCode, string ItemNumber, bool IsMultipleVendor, string ItemDescription,string GeneralVendorID)
        {
            ...
            if (model.GeneralItemMasterDTO.IsMultipleVendor == false)
            {
                if (model.GeneralItemMasterDTO.ItemNumber > 0)
                {
                    ...
                    IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.GetGeneralItemSupliersDataByItemNumber(model.GeneralItemMasterDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemSupliersData.cshtml", model);
            }
            else
            {
                if (model.GeneralItemMasterDTO.ItemNumber > 0)
                ...
                ViewBag.GeneralCurrencyMasterList = new SelectList(GeneralCurrencyMasterList, "Value", "Text");
                return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateMultipleVendor.cshtml", model);
            }
        }
        public ActionResult CreateGeneralItemGeneralData(string TaskCode, string ItemNumber)
        {
            ...
            if (model.GeneralItemMasterDTO.ItemNumber > 0)
            {
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.GetGeneralItemGeneralDataByItemNumber(model.GeneralItemMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemGeneralData.cshtml", model);
        }
        ...
        //    return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemSalesData.cshtml", model);
        //}
        public ActionResult SaleUomCodeData(string TaskCode, string ItemNumber, string GeneralUnitsID, string SelectedCentreCodeForSaleTab)
        {
          ...
          //  model.GeneralItemMasterListForSaleUoMDetails = GetSaleUomCode(ItemNumber);
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/SaleUomCodeData.cshtml", model);
        }
        [HttpPost]
        public ActionResult Create(GeneralItemMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.InsertGeneralItemMaster(model.GeneralItemMasterDTO);
        ...
        {
            GeneralItemMasterViewModel model = new GeneralItemMasterViewModel();
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateWarehouseData.cshtml", model);
        }
        public ActionResult CreateGeneralItemStoreData(string TaskCode, string ItemNumber, string GeneralItemMasterID, string GeneralUnitsID, string GeneralVendorID, string ItemCategoryCode_Param)//,string CentreCode)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemStoreData.cshtml", model);
        }
        public ActionResult CreateGeneralItemRestaurantData(string TaskCode, string ItemNumber, string GeneralItemMasterID)
        {
            ...
            {
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.GetRestaurantDataByItemNumber(model.GeneralItemMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateRestaurantMenuDetails.cshtml", model);
        }
        [HttpGet]
        public ActionResult CreateIngridentsOnVarients()
        {
            GeneralItemMasterViewModel model = new GeneralItemMasterViewModel();
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateIngridentsOnVarients.cshtml", model);
        }
        public ActionResult CreateGeneralItemAttributeData(string TaskCode, string ItemNumber, string GeneralItemMasterID)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemAttributeData.cshtml", model);
        }
        public ActionResult CreateGeneralItemEcommerceData(string TaskCode, string ItemNumber, string ItemCategoryCode_Param)
        {
            ...
            if (model.GeneralItemMasterDTO.ItemNumber > 0)
            {
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.GetGeneralItemEcommerceDataByItemNumber(model.GeneralItemMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateECommerceData.cshtml", model);
        }
        [HttpGet]
        public ActionResult UploadExcel()
        {
            GeneralItemMasterViewModel model = new GeneralItemMasterViewModel();
            return PartialView("/Views/Inventory_1/GeneralItemMaster/UploadExcel.cshtml", model);
        }
        [HttpGet]
        public ActionResult MultipleVendor(string GeneralItemMasterID, string ItemNumber)
        {
            ...
            model.GeneralItemMasterDTO.GeneralItemMasterID = Convert.ToInt32(!string.IsNullOrEmpty(GeneralItemMasterID) ? GeneralItemMasterID : null);
            model.GeneralItemMasterDTO.ItemNumber = Convert.ToInt32(!string.IsNullOrEmpty(ItemNumber) ? ItemNumber : null);
            return PartialView("/Views/Inventory_1/GeneralItemMaster/MultipleVendor.cshtml", model);
        }
        ...
        public ActionResult MultipleVendor(GeneralItemMasterViewModel model)
        {
            try
            {
...

                {
                    ...
                    model.GeneralItemMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    //IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.InsertGeneralItemSupplierDataForVendorDetails(model.GeneralItemMasterDTO);
                    response = _GeneralItemMasterServiceAcess.InsertGeneralItemSupplierDataForVendorDetails(model.GeneralItemMasterDTO);
        ...
        //    model.GeneralItemMasterDTO.ConnectionString = _connectioString;
        //    model.GeneralItemMasterDTO.ItemNumber = Convert.ToInt32(!string.IsNullOrEmpty(ItemNumber) ? ItemNumber : null); 
        //    return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateGeneralItemDimensionData.cshtml", model);
        //}
        [HttpGet]
        public ActionResult CreateStoreSpecificInformation(string ItemNumber, string GeneralUnitsID, string GeneralItemMasterID, string UnitName, string GeneralVendorID, string ItemCategoryCode_Param)
        {
            ...
            if (model.GeneralItemMasterDTO.GeneralItemMasterID > 0)
            {
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.SelectOneInventoryStoreSpecificInformation(model.GeneralItemMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            {
                return PartialView("/Views/Inventory_1/GeneralItemMaster/ErrorMessage.cshtml",model);
            }
            else
            {
                return PartialView("/Views/Inventory_1/GeneralItemMaster/CreateStoreSpecificInformation.cshtml", model);
            }
        ...
        public ActionResult CreateStoreSpecificInformation(GeneralItemMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMasterDTO != null)
                {
                    ...
                    model.GeneralItemMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.InsertInventoryStoreSpecificInformation(model.GeneralItemMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMasterDTO != null)
                {
                    if (model != null && model.GeneralItemMasterDTO != null)
                    {
                        ...
                        model.GeneralItemMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.UpdateGeneralItemMaster(model.GeneralItemMasterDTO);
        ...
        public ActionResult EditVarient(Int16 id)
        {
            try
            {
                ...
                model.GeneralItemMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]);
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.UpdateGeneralItemMaster(model.GeneralItemMasterDTO);
                model.GeneralItemMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(model.GeneralItemMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        protected List<GeneralItemMaster> GetGeneralItemSupliersDataByItemNumberandVendorIDLiSt(string ItemNumber, string GeneralVendorID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetGeneralItemSupliersDataByItemNumberandVendorID(searchRequest);
        ...
        public ActionResult Delete(int ItemNumber)
        {
            ...
            if (ItemNumber > 0)
            {
                ...
                response = _GeneralItemMasterServiceAcess.DeleteGeneralItemMaster(model.GeneralItemMasterDTO);
                string errorMessageDis = string.Empty;
                string colorCode = string.Empty;
                string mode = string.Empty;
        ...
        public ActionResult DeleteEComImage(int ID, string ImageName)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMasterServiceAcess.DeleteGeneralItemMasterEComImages(GeneralItemMasterDTO);
        ...
        public ActionResult UploadExcel(GeneralItemMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMasterDTO != null)
                {
                    ...
                    {
                        IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.InsertGeneralitemMasterExcel(model.GeneralItemMasterDTO);
                        string errorMessageDis = string.Empty;
                        string colorCode = string.Empty;
                        string mode = string.Empty;
                        if (response.Entity.ErrorCode == 18)
        ...
        public void CreateExcelDoc(string fileName)
        {
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(fileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                GeneralItemMasterViewModel model = new GeneralItemMasterViewModel();
                model.GeneralItemMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.GetDataValidationListsForExcel(model.GeneralItemMasterDTO);
                if (response != null && response.Entity != null)
                {
        ...
        {
            //return PartialView();
            return PartialView("/Views/Inventory_1/GeneralItemMaster/ArticleImageUpload.cshtml");
        }
        [HttpGet]
        public ActionResult MultipleArticleImageUpload()
        {
            //return PartialView();
            return PartialView("/Views/Inventory_1/GeneralItemMaster/MultipleImageUpload.cshtml");
        }
        ...
        public JsonResult CheckFocusOnAction(string selectedbarcodeName)
        {
            ...
            if (selectedbarcodeName != string.Empty)
            {
                ...
                IBaseEntityResponse<GeneralItemMaster> response = _GeneralItemMasterServiceAcess.CheckFocusOnAction(_GeneralItemMaster);
                if (response != null && response.Entity != null)
                {
        ...
        public JsonResult GetVendorSearchList(string term)
        {
            ...
            IBaseEntityCollectionResponse<VendorMaster> baseEntityCollectionResponse = _VendorMasterServiceAccess.GetVendorMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<InventoryRecipeMenuCategory> GetListRecipeMenuCategory()
        {
            ...
            IBaseEntityCollectionResponse<InventoryRecipeMenuCategory> baseEntityCollectionResponse = _IInventoryRecipeMenuCategoryServiceAccess.GetRestaurantCategory(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralPackageType> GetGeneralPackageType()
        {
            ...
            IBaseEntityCollectionResponse<GeneralPackageType> baseEntityCollectionResponse = _IGeneralPackageTypeServiceAccess.GetGeneralPackageTypeSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralPriceListAndListLine> GetListGeneralPriceGroupForPriceGroupCode()
        {
            ...
            IBaseEntityCollectionResponse<GeneralPriceListAndListLine> baseEntityCollectionResponse = _GeneralPriceListAndListLineServiceAcess.GetGeneralPriceListAndListLineSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public JsonResult GetLeadTimeByVendorID(string ItemNumber, string GeneralVendorID)
        {
            ...
            IBaseEntityResponse<VendorMaster> response = _VendorMasterServiceAccess.GetLeadTimeByVendorID(model.VendorMasterDTO);
            if (response != null && response.Entity != null)
            {
        ...
        protected List<GeneralItemMaster> GetGeneralItemMasterListForDelistingAndDelistingDate(string GeneralItemMasterID, string ItemNumber,string CentreListXML)
        {
            ...
            List<GeneralItemMaster> listGeneralItemMaster = new List<GeneralItemMaster>();
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetGeneralItemStoreData(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMaster> GetGeneralItemMasterListForAttributeData(string GeneralItemMasterID, string ItemNumber)
        {
            ...
            searchRequest.ID = Convert.ToInt32(!string.IsNullOrEmpty(GeneralItemMasterID) ? GeneralItemMasterID : null); ;
            List<GeneralItemMaster> listGeneralItemMaster = new List<GeneralItemMaster>();
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetGeneralItemAttributeDataByItemNumber(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMaster> GetGeneralItemMasterListForSaleDetails(string ItemNumber, string CentreListXML)
        {
            ...
            searchRequest.CentreListXML = CentreListXML;
            List<GeneralItemMaster> listGeneralItemMaster = new List<GeneralItemMaster>();
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetGeneralItemSalesDataByItemNumber(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMaster> GetGeneralItemMasterListForVarientDetails(string GeneralItemmasterID)
        {
            ...
            searchRequest.ID = Convert.ToInt32(!string.IsNullOrEmpty(GeneralItemmasterID) ? GeneralItemmasterID : null);
            List<GeneralItemMaster> listGeneralItemMaster = new List<GeneralItemMaster>();
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetVariantDetailsForGeneralItemMasters(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralPriceGroup> GetListGeneralItemPriceGroup()
        {
            ...
            IBaseEntityCollectionResponse<GeneralPriceGroup> baseEntityCollectionResponse = _GeneralPriceGroupServiceAccess.GetGeneralPriceGroupSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<InventoryAttributeMaster> GetListInventoryAttributeMaster()
        {
            ...
            IBaseEntityCollectionResponse<InventoryAttributeMaster> baseEntityCollectionResponse = _InventoryAttributeMasterServiceAccess.GetInventoryAttributeMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<InventoryBrandMaster> GetListGeneralItemBrandMaster()
        {
            ...
            IBaseEntityCollectionResponse<InventoryBrandMaster> baseEntityCollectionResponse = _InventoryBrandMasterServiceAccess.GetInventoryBrandMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralTemperatureMaster> GetListGeneralTemperatureMaster()
        {
            ...
            IBaseEntityCollectionResponse<GeneralTemperatureMaster> baseEntityCollectionResponse = _GeneraltemperatureMasterServiceAccess.GetGeneralTemperatureMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralPurchaseGroupMaster> GetListGeneralPurchaseGroupMaster()
        {
            ...
            IBaseEntityCollectionResponse<GeneralPurchaseGroupMaster> baseEntityCollectionResponse = _GeneralPurchaseGroupMasterServiceAccess.GetGeneralPurchaseGroupMasterSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMaster> GetListMultipleVendorItemWise(int ItemNumber)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetMultipleVendorListItemWise(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<InventoryUoMMaster> GetPurchaseUomCode(string ItemNumber)
        {
            ...
            searchRequest.ItemNumber = Convert.ToInt32(!string.IsNullOrEmpty(ItemNumber) ? ItemNumber : null);
            List<InventoryUoMMaster> ListInventoryUoMMasterForSaleUomCode = new List<InventoryUoMMaster>();
            IBaseEntityCollectionResponse<InventoryUoMMaster> baseEntityCollectionResponse = _InventoryUoMMasterServiceAccess.GetInventoryUoMMasterDropDownforPurchaseUomCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<InventoryUoMGroupAndDetails> GetListBaseCodebyUoMGroupCode(string UoMGroupCode)
        {
            ...
            IBaseEntityCollectionResponse<InventoryUoMGroupAndDetails> baseEntityCollectionResponse = _InventoryUoMGroupAndDetailsServiceAccess.GetInventoryUomCodeByUomGroupCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<OrderingAndDeliveryDay> GetListForOrderingDayAndDelivaryDayCode()
        {
            ...
            IBaseEntityCollectionResponse<OrderingAndDeliveryDay> baseEntityCollectionResponse = _OrderingAndDeliveryDayServiceAccess.GetDropDownListForOrderingAndDeliveryDay(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public IEnumerable<GeneralItemMasterViewModel> GetGeneralItemMaster(out int TotalRecords)
        {
            ...
            List<GeneralItemMaster> listGeneralItemMaster = new List<GeneralItemMaster>();
            IBaseEntityCollectionResponse<GeneralItemMaster> baseEntityCollectionResponse = _GeneralItemMasterServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
