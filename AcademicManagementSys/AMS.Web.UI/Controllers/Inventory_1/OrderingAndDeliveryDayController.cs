...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IOrderingAndDeliveryDayServiceAccess _OrderingAndDeliveryDayServiceAcess = null;
        ...
        {
            _OrderingAndDeliveryDayServiceAcess = new OrderingAndDeliveryDayServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/OrderingAndDeliveryDay/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/OrderingAndDeliveryDay/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/OrderingAndDeliveryDay/Create.cshtml", model);
        }
        ...
        public ActionResult Create(OrderingAndDeliveryDayViewModel model)
        {
            try
            {
                ...
                if (model != null && model.OrderingAndDeliveryDayDTO != null)
                {
                    ...
                    IBaseEntityResponse<OrderingAndDeliveryDay> response = _OrderingAndDeliveryDayServiceAcess.InsertOrderingAndDeliveryDay(model.OrderingAndDeliveryDayDTO);

                    model.OrderingAndDeliveryDayDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<OrderingAndDeliveryDay> response = _OrderingAndDeliveryDayServiceAcess.SelectByID(model.OrderingAndDeliveryDayDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.OrderingAndDeliveryDayDTO != null)
                {
                    if (model != null && model.OrderingAndDeliveryDayDTO != null)
                    {
                        ...
                        IBaseEntityResponse<OrderingAndDeliveryDay> response = _OrderingAndDeliveryDayServiceAcess.UpdateOrderingAndDeliveryDay(model.OrderingAndDeliveryDayDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _OrderingAndDeliveryDayServiceAcess.DeleteOrderingAndDeliveryDay(OrderingAndDeliveryDayDTO);
        ...
        public IEnumerable<OrderingAndDeliveryDayViewModel> GetOrderingAndDeliveryDay(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<OrderingAndDeliveryDay> baseEntityCollectionResponse = _OrderingAndDeliveryDayServiceAcess.GetBySearch(searchRequest);
