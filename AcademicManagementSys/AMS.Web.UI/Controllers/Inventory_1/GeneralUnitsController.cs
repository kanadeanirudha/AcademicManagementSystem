...
namespace AMS.Web.UI.Controllers
{
    public class GeneralUnitsController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralUnits/Index.cshtml");
        }
            ...
            //public ActionResult List(string actionMode, string centerCode, string departmentID)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralUnits/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create(string IDs)
        {
          ...
          //  model.GeneralUnitTypeID = Convert.ToInt16(IDs);
           ...
           // model.DepartmentID = Convert.ToInt32(IDsArray[3]);
            return PartialView("/Views/Inventory_1/GeneralUnits/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralUnitsViewModel model)
        {
            try
            {
                if (model != null && model.GeneralUnitsDTO != null)
                {
                    ...
                    model.GeneralUnitsDTO.GeneralUnitsStorageLocationID = model.GeneralUnitsStorageLocationID;
                   ...
                   // model.GeneralUnitsDTO.LocationAddress = model.LocationAddress;
                    ...
                    IBaseEntityResponse<GeneralUnits> response = _GeneralUnitsServiceAcess.InsertGeneralUnits(model.GeneralUnitsDTO);
                    model.GeneralUnitsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult UnitDetails(Int16 id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralUnits> response = _GeneralUnitsServiceAcess.SelectByID(model.GeneralUnitsDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralUnits/UnitDetails.cshtml", model);
            }
            catch (Exception)
            {
                throw;
         ...
         public ActionResult UnitDetails(GeneralUnitsViewModel model)
         {
             try
             {
                 if (model != null && model.GeneralUnitsDTO != null)
                 {
                     ...
                     IBaseEntityResponse<GeneralUnits> response = _GeneralUnitsServiceAcess.UpdateGeneralUnits(model.GeneralUnitsDTO);
                     model.GeneralUnitsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                     return Json(model.GeneralUnitsDTO.errorMessage, JsonRequestBehavior.AllowGet);
                 }
                 return Json("Please review your form");
             }
        ...
        public ActionResult ViewDetails(Int16 id)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralUnits/View.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralUnitsServiceAcess.DeleteGeneralUnits(GeneralUnitsDTO);
        ...
        public List<InventoryLocationMaster_1> GetLocationListDetails(string SearchKeyWord, string GeneralUnitsID, string CentreCode)
        {
            ...
            List<InventoryLocationMaster_1> listLocation = new List<InventoryLocationMaster_1>();
            IBaseEntityCollectionResponse<InventoryLocationMaster_1> baseEntityCollectionResponse = _InventoryLocationMaster_1ServiceAcess.GetInventoryLocationMaster_1List(searchRequest);
            ...
            //public IEnumerable<GeneralUnitsViewModel> GetGeneralUnits(out int TotalRecords,string centreCode,string DepartmentID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralUnits> baseEntityCollectionResponse = _GeneralUnitsServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public JsonResult UploadFile()
        {
            ...
            if (System.Web.HttpContext.Current.Request.Files.AllKeys.Any())
            {
                ...
                if (pic.ContentLength > 0)
                {
                    ...
                    var _comPath = Server.MapPath("~") + "\\Content\\UploadedFiles\\Inventory_1\\Logo\\";
