...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemMarchandiseBaseCategoryServiceAccess _GeneralItemMarchandiseBaseCategoryServiceAcess = null;
        ...
        {
            _GeneralItemMarchandiseBaseCategoryServiceAcess = new GeneralItemMarchandiseBaseCategoryServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemMarchandiseBaseCategory/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseBaseCategory/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemMarchandiseBaseCategory/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralItemMarchandiseBaseCategoryViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralItemMarchandiseBaseCategoryDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralItemMarchandiseBaseCategory> response = _GeneralItemMarchandiseBaseCategoryServiceAcess.InsertGeneralItemMarchandiseBaseCategory(model.GeneralItemMarchandiseBaseCategoryDTO);

                    model.GeneralItemMarchandiseBaseCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralItemMarchandiseBaseCategory> response = _GeneralItemMarchandiseBaseCategoryServiceAcess.SelectByID(model.GeneralItemMarchandiseBaseCategoryDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralItemMarchandiseBaseCategory/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralItemMarchandiseBaseCategoryDTO != null)
                {
                    if (model != null && model.GeneralItemMarchandiseBaseCategoryDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralItemMarchandiseBaseCategory> response = _GeneralItemMarchandiseBaseCategoryServiceAcess.UpdateGeneralItemMarchandiseBaseCategory(model.GeneralItemMarchandiseBaseCategoryDTO);
                        model.GeneralItemMarchandiseBaseCategoryDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralItemMarchandiseBaseCategoryDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralItemMarchandiseBaseCategoryServiceAcess.DeleteGeneralItemMarchandiseBaseCategory(GeneralItemMarchandiseBaseCategoryDTO);
        ...
        public IEnumerable<GeneralItemMarchandiseBaseCategoryViewModel> GetGeneralItemMarchandiseBaseCategory(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseBaseCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseBaseCategoryServiceAcess.GetBySearch(searchRequest);
