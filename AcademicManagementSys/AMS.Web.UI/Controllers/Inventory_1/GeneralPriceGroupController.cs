...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralPriceGroupServiceAccess _GeneralPriceGroupServiceAcess = null;
        ...
        {
            _GeneralPriceGroupServiceAcess = new GeneralPriceGroupServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralPriceGroup/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralPriceGroup/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralPriceGroup/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralPriceGroupViewModel model)
        {
            try
            {
                ...
                if (model != null && model.GeneralPriceGroupDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralPriceGroup> response = _GeneralPriceGroupServiceAcess.InsertGeneralPriceGroup(model.GeneralPriceGroupDTO);

                    model.GeneralPriceGroupDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //        IBaseEntityResponse<GeneralPriceGroup> response = _GeneralPriceGroupServiceAcess.SelectByID(model.GeneralPriceGroupDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralPriceGroupDTO != null)
                {
                    if (model != null && model.GeneralPriceGroupDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralPriceGroup> response = _GeneralPriceGroupServiceAcess.UpdateGeneralPriceGroup(model.GeneralPriceGroupDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralPriceGroupServiceAcess.DeleteGeneralPriceGroup(GeneralPriceGroupDTO);
        ...
        public IEnumerable<GeneralPriceGroupViewModel> GetGeneralPriceGroup(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralPriceGroup> baseEntityCollectionResponse = _GeneralPriceGroupServiceAcess.GetBySearch(searchRequest);
