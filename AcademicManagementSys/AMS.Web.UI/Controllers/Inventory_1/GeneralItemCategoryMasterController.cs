...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralItemCategoryMasterServiceAccess _GeneralItemCategoryMasterServiceAcess = null;
        IGeneralItemMarchandiseGroupServiceAccess _GeneralItemMarchandiseGroupServiceAccess = null;
        IGeneralItemMerchantiseDepartmentServiceAccess _GeneralItemMerchantiseDepartmentServiceAccess = null;
        IGeneralItemMerchantiseCategoryServiceAccess _GeneralItemMerchantiseCategoryServiceAccess = null;
        IGeneralItemMarchandiseSubCategoryServiceAccess _GeneralItemMarchandiseSubCategoryServiceAccess = null;
        IGeneralItemMarchandiseBaseCategoryServiceAccess _GeneralItemMarchandiseBaseCategoryServiceAccess = null;
        ...
        {
            _GeneralItemCategoryMasterServiceAcess = new GeneralItemCategoryMasterServiceAccess();
            _GeneralItemMarchandiseGroupServiceAccess = new GeneralItemMarchandiseGroupServiceAccess();
            _GeneralItemMerchantiseDepartmentServiceAccess = new GeneralItemMerchantiseDepartmentServiceAccess();
            _GeneralItemMerchantiseCategoryServiceAccess = new GeneralItemMerchantiseCategoryServiceAccess();
            _GeneralItemMarchandiseSubCategoryServiceAccess = new GeneralItemMarchandiseSubCategoryServiceAccess();
            _GeneralItemMarchandiseBaseCategoryServiceAccess = new GeneralItemMarchandiseBaseCategoryServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralItemCategoryMaster/Index.cshtml", model);
        }
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        {
            GeneralItemCategoryMasterViewModel model = new GeneralItemCategoryMasterViewModel();
            return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/UploadExcel.cshtml", model);
        }
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/Create.cshtml", model);
        }
        ...
        public ActionResult CreateBMC()
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/CreateBMC.cshtml", model);
        }
        ...
        public ActionResult Edit(Int16 id)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult EditBMC(Int16 id)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralItemCategoryMaster/EditBMC.cshtml", model);
            }
            catch (Exception)
            {
                throw;
            ...
            try
            {
                ...
                if (model != null && model.GeneralItemCategoryMasterDTO != null)
                {
                    ...
                    if (xmlParameter != string.Empty && xmlParameter != null && IsExcelValid == true)
                    {
                        ...
                        //model.GeneralItemCategoryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public JsonResult GetGroupCodeSearchList(string term)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseGroup> baseEntityCollectionResponse = _GeneralItemMarchandiseGroupServiceAccess.GetGeneralItemMarchandiseGroupSearchListForCategory(searchRequest);
        ...
        protected List<GeneralItemMerchantiseDepartment> GetDepartmentCodeByGroupCode(string GroupCode)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseDepartment> baseEntityCollectionResponse = _GeneralItemMerchantiseDepartmentServiceAccess.GetGeneralItemMerchantiseDepartmentCodeByGroupCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMerchantiseCategory> GetCategoryCodeByDepartmentCode(string MerchandiseDepartmentID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseCategory> baseEntityCollectionResponse = _GeneralItemMerchantiseCategoryServiceAccess.GetGeneralItemMerchantiseCategoryCodeByDepartmentCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMarchandiseSubCategory> GetSubCategoryCodeByCategoryCode(string MerchandiseCategoryID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseSubCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseSubCategoryServiceAccess.GetGeneralItemMerchantiseSubCategoryCodeByDepartmentCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMarchandiseBaseCategory> GetBaseCategoryCodeBySubCategoryCode(string MerchandiseSubCategoryID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseBaseCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseBaseCategoryServiceAccess.GetGeneralItemMerchantiseBaseCategoryCodeByCategoryCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMarchandiseGroup> GetListGeneralItemMarchandiseGroup()
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseGroup> baseEntityCollectionResponse = _GeneralItemMarchandiseGroupServiceAccess.GetGeneralItemMarchandiseGroupSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMerchantiseDepartment> GetListGeneralItemMerchantiseDepartment()
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseDepartment> baseEntityCollectionResponse = _GeneralItemMerchantiseDepartmentServiceAccess.GetGeneralItemMerchantiseDepartmentSearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMerchantiseCategory> GetListGeneralItemMerchantiseCategory()
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMerchantiseCategory> baseEntityCollectionResponse = _GeneralItemMerchantiseCategoryServiceAccess.GetGeneralItemMerchantiseCategorySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMarchandiseSubCategory> GetListGeneralItemMerchantiseSubCategory()
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseSubCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseSubCategoryServiceAccess.GetGeneralItemMarchandiseSubCategorySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<GeneralItemMarchandiseBaseCategory> GetListGeneralItemMerchantiseBaseCategory()
        {
            ...
            IBaseEntityCollectionResponse<GeneralItemMarchandiseBaseCategory> baseEntityCollectionResponse = _GeneralItemMarchandiseBaseCategoryServiceAccess.GetGeneralItemMarchandiseBaseCategorySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param)
        {
            if (Session["UserType"] != null)
            {
                ...
                var result = from c in records select new[] { c.ItemCategoryDescription.ToString(), c.ItemCategoryCode.ToString(), Convert.ToString(c.ID) };
