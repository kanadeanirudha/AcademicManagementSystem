...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralOperatorRelatedRoleServiceAccess _GeneralOperatorRelatedRoleServiceAcess = null;
        ...
        {
            _GeneralOperatorRelatedRoleServiceAcess = new GeneralOperatorRelatedRoleServiceAccess();
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralOperatorRelatedRole/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode, string centerCode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralOperatorRelatedRole/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create(string CentreCode)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralOperatorRelatedRole/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralOperatorRelatedRoleViewModel model, string CentreCode)
        {
            try
            {
                if (model != null && model.GeneralOperatorRelatedRoleDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralOperatorRelatedRole> response = _GeneralOperatorRelatedRoleServiceAcess.InsertGeneralOperatorRelatedRole(model.GeneralOperatorRelatedRoleDTO);
                    model.GeneralOperatorRelatedRoleDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(Int16 id)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralOperatorRelatedRole> response = _GeneralOperatorRelatedRoleServiceAcess.UpdateGeneralOperatorRelatedRole(model.GeneralOperatorRelatedRoleDTO);
                model.GeneralOperatorRelatedRoleDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(model.GeneralOperatorRelatedRoleDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        protected List<GeneralOperatorRelatedRole> GetListAdminRoleCode(string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<GeneralOperatorRelatedRole> baseEntityCollectionResponse = _GeneralOperatorRelatedRoleServiceAcess.GetAdminRoleCodeList(searchRequest);
        ...
        public IEnumerable<GeneralOperatorRelatedRole> GetGeneralOperatorRelatedRole(string centreCode, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralOperatorRelatedRole> baseEntityCollectionResponse = _GeneralOperatorRelatedRoleServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
