...
namespace AMS.Web.UI.Controllers
{
    public class VendorMasterReportController : BaseController
    {
        ...
        IVendorMasterReportServiceAccess _VendorMasterReportServiceAccess = null;
        ...
        {
            _VendorMasterReportServiceAccess = new VendorMasterReportServiceAccess();
        }
        #endregion
        ...
        public ActionResult Index()
        {
          ...
          //  model.ListAllVendor = GetVendorList(ReportFor);
            ...
            return View("/Views/Inventory_1/Report/VendorMaster/Index.cshtml",model);
        }
        [HttpPost]
        ...
        public List<VendorMasterReport> GetVendorList(string ReportFor)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<VendorMasterReport> baseEntityCollectionResponse = _VendorMasterReportServiceAccess.GetVendorMasterReportBySearch_AllVendorList(searchRequest);
