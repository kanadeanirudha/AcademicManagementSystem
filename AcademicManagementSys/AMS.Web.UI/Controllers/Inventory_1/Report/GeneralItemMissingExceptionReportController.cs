...
namespace AMS.Web.UI.Controllers
{
    public class GeneralItemMissingExceptionReportController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/Report/GeneralItemMissingExceptionReport/Index.cshtml", model);
        }
       [HttpPost]
       ...
       public List<AdminRoleApplicableDetails> GetCentreListByRoleAuthorization()
       {
        ...
        public List<InventoryReport> GetMissingExceptionReportList( string ReportFor)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<InventoryReport> baseEntityCollectionResponse = _InventoryReportServiceAccess.GetInventoryReportBySearch_PriceList(searchRequest);
