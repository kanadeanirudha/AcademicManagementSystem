...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralUnitsStorageLocationServiceAccess _GeneralUnitsStorageLocationServiceAcess = null;
        ...
        {
            _GeneralUnitsStorageLocationServiceAcess = new GeneralUnitsStorageLocationServiceAccess();
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralUnitStorageLocation/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/Inventory_1/GeneralUnitStorageLocation/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create(string IDs)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralUnitStorageLocation/create.cshtml", model);
        ...
        public ActionResult Create(GeneralUnitStorageLocationViewModel model)
        {
            try
            {
                    ...
                    if (model != null && model.GeneralUnitStorageLocationDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralUnitsStorageLocation> response = _GeneralUnitsStorageLocationServiceAcess.InsertGeneralUnitsStorageLocation(model.GeneralUnitStorageLocationDTO);

                        model.GeneralUnitStorageLocationDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult ViewDetails(Int16 id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralUnitsStorageLocation> response = _GeneralUnitsStorageLocationServiceAcess.SelectByID(model.GeneralUnitStorageLocationDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralUnitStorageLocation/View.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralUnitsStorageLocationServiceAcess.DeleteGeneralUnitsStorageLocation(GeneralUnitStorageLocationDTO);
        ...
        public JsonResult CheckFocusOnAction(string actionOn, string data)
        {
            ...
            model.GeneralUnitStorageLocationDTO.ConnectionString = _connectioString;
            IBaseEntityResponse<GeneralUnitsStorageLocation> response = _GeneralUnitsStorageLocationServiceAcess.CheckFocusOnAction(model.GeneralUnitStorageLocationDTO);
            if (response != null && response.Entity != null)
            {
        ...
        public IEnumerable<GeneralUnitStorageLocationViewModel> GetGeneralUnitsStorageLocation(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralUnitsStorageLocation> baseEntityCollectionResponse = _GeneralUnitsStorageLocationServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
