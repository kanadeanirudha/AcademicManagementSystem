...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralAllocateSaleProcessUnitServiceAccess _GeneralAllocateSaleProcessUnitServiceAcess = null;
        ...
        {
            _GeneralAllocateSaleProcessUnitServiceAcess = new GeneralAllocateSaleProcessUnitServiceAccess();
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/Inventory_1/GeneralAllocateSaleProcessUnit/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode, string centerCode)
        {
            ...
            //    }
            //    return PartialView("/Views/Inventory_1/GeneralAllocateSaleProcessUnit/List.cshtml", model);
            //}
            //catch (Exception ex)
            //{
        ...
        public ActionResult Create(string IDs)
        {
            ...
            return PartialView("/Views/Inventory_1/GeneralAllocateSaleProcessUnit/Create.cshtml", model);
        }
        ...
        public ActionResult Create(GeneralAllocateSaleProcessUnitViewModel model)
        {
            try
            {
                if (model != null && model.GeneralAllocateSaleProcessUnitDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralAllocateSaleProcessUnit> response = _GeneralAllocateSaleProcessUnitServiceAcess.InsertGeneralAllocateSaleProcessUnit(model.GeneralAllocateSaleProcessUnitDTO);
                    model.GeneralAllocateSaleProcessUnitDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult ViewDetails(Int16 id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralAllocateSaleProcessUnit> response = _GeneralAllocateSaleProcessUnitServiceAcess.SelectByID(model.GeneralAllocateSaleProcessUnitDTO);
                ...
                return PartialView("/Views/Inventory_1/GeneralAllocateSaleProcessUnit/View.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Delete(Int16 ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralAllocateSaleProcessUnitServiceAcess.DeleteGeneralAllocateSaleProcessUnit(GeneralAllocateSaleProcessUnitDTO);
        ...
        protected List<GeneralAllocateSaleProcessUnit> GetListGeneralAllocateSaleProcessForProcessUnit(string centreCode)
        {
            ...
            IBaseEntityCollectionResponse<GeneralAllocateSaleProcessUnit> baseEntityCollectionResponse = _GeneralAllocateSaleProcessUnitServiceAcess.GetGeneralAllocateSaleProcessUnitSearchList(searchRequest);
        ...
        public IEnumerable<GeneralAllocateSaleProcessUnitViewModel> GetGeneralAllocateSaleProcessUnit(out int TotalRecords, string centreCode)
        {
            ...
            IBaseEntityCollectionResponse<GeneralAllocateSaleProcessUnit> baseEntityCollectionResponse = _GeneralAllocateSaleProcessUnitServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
