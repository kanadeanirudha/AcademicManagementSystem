...
namespace AMS.Web.UI.Controllers
{
    public class AdminRoleDetailsController : BaseController
    {
        ...
        IAdminRoleDetailsServiceAccess _adminRoleDetailsServiceAcess = null;

        private string _connectioString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);

        public AdminRoleDetailsController()
        {
            _adminRoleDetailsServiceAcess = new AdminRoleDetailsServiceAccess();
        }
        ...
        public ActionResult Create(AdminRoleDetailsViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (model != null && model.AdminRoleDetailsDTO != null)
                {
                    ...
                    IBaseEntityResponse<AdminRoleDetails> response = _adminRoleDetailsServiceAcess.InsertAdminRoleDetails(model.AdminRoleDetailsDTO);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            IBaseEntityResponse<AdminRoleDetails> response = _adminRoleDetailsServiceAcess.SelectByID(model.AdminRoleDetailsDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.AdminRoleDetailsDTO != null)
                {
                    if (model != null && model.AdminRoleDetailsDTO != null)
                    {
                        ...
                        model.AdminRoleDetailsDTO.DeletedDate = null;
                        model.AdminRoleDetailsDTO.IsDeleted = false;
                        IBaseEntityResponse<AdminRoleDetails> response = _adminRoleDetailsServiceAcess.UpdateAdminRoleDetails(model.AdminRoleDetailsDTO);
                    }
                }
        ...
        public ActionResult Delete(AdminRoleDetailsViewModel model)
        {
            if (ModelState.IsValid)
            {
                if (model.ID > 0)
                {
                    ...
                    IBaseEntityResponse<AdminRoleDetails> response = _adminRoleDetailsServiceAcess.DeleteAdminRoleDetails(adminRoleDetailsDTO);
                }
                return Content(Boolean.TrueString);
            }
            else
        ...
        public IEnumerable<AdminRoleDetailsViewModel> GetAdminRoleDetails()
        {
            ...
            IBaseEntityCollectionResponse<AdminRoleDetails> baseEntityCollectionResponse = _adminRoleDetailsServiceAcess.GetBySearch(searchRequest);
