...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralCountryMasterServiceAccess _generalCountryMasterServiceAcess = null;
        ...
        {
            _generalCountryMasterServiceAcess = new GeneralCountryMasterServiceAccess();
        }
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralCountryMasterDTO != null)
                    {
                       ...
                       // model.GeneralCountryMasterDTO.SeqNo = model.SeqNo; ;
                        ...
                        IBaseEntityResponse<GeneralCountryMaster> response = _generalCountryMasterServiceAcess.InsertGeneralCountryMaster(model.GeneralCountryMasterDTO);
                        model.GeneralCountryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20 , ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            {                
                ...
                IBaseEntityResponse<GeneralCountryMaster> response = _generalCountryMasterServiceAcess.SelectByID(model.GeneralCountryMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralCountryMasterDTO != null)
                {
                    if (model != null && model.GeneralCountryMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralCountryMaster> response = _generalCountryMasterServiceAcess.UpdateGeneralCountryMaster(model.GeneralCountryMasterDTO);
                        model.GeneralCountryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralCountryMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralCountryMasterViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        if (model.ID > 0)
        ...
        //            generalCountryMasterDTO.ID = model.ID;
        //            generalCountryMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<GeneralCountryMaster> response = _generalCountryMasterServiceAcess.DeleteGeneralCountryMaster(generalCountryMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            //{
                if (ID > 0)
                {
                    ...
                    generalCountryMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralCountryMaster> response = _generalCountryMasterServiceAcess.DeleteGeneralCountryMaster(generalCountryMasterDTO);
                    model.GeneralCountryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralCountryMasterViewModel> GetGeneralCountryMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralCountryMaster> baseEntityCollectionResponse = _generalCountryMasterServiceAcess.GetBySearch(searchRequest);
