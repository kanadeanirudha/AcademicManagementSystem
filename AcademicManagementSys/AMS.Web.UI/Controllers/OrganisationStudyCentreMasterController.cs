...
namespace AMS.Web.UI.Controllers
{
    public class OrganisationStudyCentreMasterController : BaseController
    {
        ...
        IOrganisationStudyCentreMasterServiceAccess _organisationStudyCentreMasterServiceAcess = null;
        ...
        {
            _organisationStudyCentreMasterServiceAcess = new OrganisationStudyCentreMasterServiceAccess();
        ...
        public ActionResult Create()
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<OrganisationStudyCentreMaster> response = _organisationStudyCentreMasterServiceAcess.SelectHOROCount(model.OrganisationStudyCentreMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.OrganisationStudyCentreMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<OrganisationStudyCentreMaster> response = _organisationStudyCentreMasterServiceAcess.InsertOrganisationStudyCentreMaster(model.OrganisationStudyCentreMasterDTO);
                        model.OrganisationStudyCentreMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(string ids)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<OrganisationStudyCentreMaster> response = _organisationStudyCentreMasterServiceAcess.SelectByID(model.OrganisationStudyCentreMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.OrganisationStudyCentreMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<OrganisationStudyCentreMaster> response = _organisationStudyCentreMasterServiceAcess.UpdateOrganisationStudyCentreMaster(model.OrganisationStudyCentreMasterDTO);
                        model.OrganisationStudyCentreMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                    return Json(model.OrganisationStudyCentreMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        //[HttpPost]
        //public ActionResult Delete(OrganisationStudyCentreMasterViewModel model)
        //{
        ...
        //            OrganisationStudyCentreMasterDTO.ID = model.ID;
        //            OrganisationStudyCentreMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            response = _organisationStudyCentreMasterServiceAcess.DeleteOrganisationStudyCentreMaster(OrganisationStudyCentreMasterDTO);
        ...
        public ActionResult Delete(string ID)
        {
            ...
            try
            {
                if (IDs > 0)
                {
                    ...
                    OrganisationStudyCentreMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    response = _organisationStudyCentreMasterServiceAcess.DeleteOrganisationStudyCentreMaster(OrganisationStudyCentreMasterDTO);
                    model.OrganisationStudyCentreMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                }
                if (response.Message.Count == 0)
                {
                    return Json(model.OrganisationStudyCentreMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        public IEnumerable<OrganisationStudyCentreMasterViewModel> GetOrganisationStudyCentreMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<OrganisationStudyCentreMaster> baseEntityCollectionResponse = _organisationStudyCentreMasterServiceAcess.GetBySearch(searchRequest);
