...
namespace AMS.Web.UI.Controllers
{
    public class AccountGroupMasterController : BaseController
    {
        ...
        IAccountGroupMasterServiceAccess _accountGroupMasterServiceAccess = null;
        ...
        {
            _accountGroupMasterServiceAccess = new AccountGroupMasterServiceAccess();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountGroupMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AccountGroupMaster> response = _accountGroupMasterServiceAccess.InsertAccountGroupMaster(model.AccountGroupMasterDTO);
                        model.AccountGroupMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(Int16 id)
        {
            try
            {
                ...
                model.ID = id;
                model.AccountGroupMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<AccountGroupMaster> response = _accountGroupMasterServiceAccess.SelectByID(model.AccountGroupMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountGroupMasterDTO != null)
                    {
                        if (model != null && model.AccountGroupMasterDTO != null)
                        {
                            ...
                            model.AccountGroupMasterDTO.PrintingSequence = model.PrintingSequence;
                            model.AccountGroupMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]);
                            IBaseEntityResponse<AccountGroupMaster> response = _accountGroupMasterServiceAccess.UpdateAccountGroupMaster(model.AccountGroupMasterDTO);
                            model.AccountGroupMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }
                    return Json(model.AccountGroupMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public ActionResult Delete(short ID)
        {
            try
            {
                ...
                IBaseEntityResponse<AccountGroupMaster> response = null;
                    ...
                    response = _accountGroupMasterServiceAccess.DeleteAccountGroupMaster(AccountGroupMasterDTO);
                    model.AccountGroupMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    return Json(model.AccountGroupMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        public List<AccountGroupMaster> GetListAccountGroupMaster(out int _totalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountGroupMaster> baseEntityCollectionResponse = _accountGroupMasterServiceAccess.GetBySearch(searchRequest);
        ...
        public List<AccountCategoryMaster> GetListAccountCategoryMaster()
        {
            ...
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            IBaseEntityCollectionResponse<AccountCategoryMaster> baseEntityCollectionResponse = _accountCategoryMasterServiceAccess.GetCategoryList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
