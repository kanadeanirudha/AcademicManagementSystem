...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralLocationMasterServiceAccess _generalLocationMasterServiceAcess = null;
        ...
        {
            _generalLocationMasterServiceAcess = new GeneralLocationMasterServiceAccess();
           ...
           try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralLocationMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralLocationMaster> response = _generalLocationMasterServiceAcess.InsertGeneralLocationMaster(model.GeneralLocationMasterDTO);
                    model.GeneralLocationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralLocationMaster> response = _generalLocationMasterServiceAcess.SelectByID(model.GeneralLocationMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralLocationMasterDTO != null)
                {
                    if (model != null && model.GeneralLocationMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralLocationMaster> response = _generalLocationMasterServiceAcess.UpdateGeneralLocationMaster(model.GeneralLocationMasterDTO);
                        model.GeneralLocationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralLocationMasterViewModel model)
        //{
        ...
        //        GeneralLocationMasterDTO.ID = model.ID;
        //        GeneralLocationMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //        response = _generalLocationMasterServiceAcess.DeleteGeneralLocationMaster(GeneralLocationMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            try
            {
                if (ID > 0)
                {
                    ...
                    GeneralLocationMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    response = _generalLocationMasterServiceAcess.DeleteGeneralLocationMaster(GeneralLocationMasterDTO);
                    model.GeneralLocationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                }
                if (response.Message.Count == 0)
                {
                    return Json(model.GeneralLocationMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        public IEnumerable<GeneralLocationMasterViewModel> GetGeneralLocationMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralLocationMaster> baseEntityCollectionResponse = _generalLocationMasterServiceAcess.GetBySearch(searchRequest);
