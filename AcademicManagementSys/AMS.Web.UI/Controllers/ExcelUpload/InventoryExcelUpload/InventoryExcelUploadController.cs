...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryExcelUploadServiceAccess _InventoryExcelUploadServiceAccess = null;
        ...
        {
            _InventoryExcelUploadServiceAccess = new InventoryExcelUploadServiceAccess();
        }
        ...
        public void CreateVendorMasterMapCategoryExcel(string fileName)
        {
            using (SpreadsheetDocument document = SpreadsheetDocument.Create(fileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                IBaseEntityResponse<InventoryExcelUpload> response = _InventoryExcelUploadServiceAccess.GetDataValidationListsForInventoryExcel(model.InventoryExcelUploadDTO);
        ...
        public ActionResult UploadExcelForVendorMerchandiseCategory(InventoryExcelUploadViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryExcelUploadDTO != null)
                {
                    ...
                    {
                        IBaseEntityResponse<InventoryExcelUpload> response = _InventoryExcelUploadServiceAccess.InsertVendorMasterMapCategoryExcel(model.InventoryExcelUploadDTO);
                        model.InventoryExcelUploadDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult UploadExcelForItemMasterMapCategoryExcel(InventoryExcelUploadViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryExcelUploadDTO != null)
                {
                    ...
                    if (xmlParameter != string.Empty && xmlParameter != null && IsExcelValid == true)
                    {
                        IBaseEntityResponse<InventoryExcelUpload> response = _InventoryExcelUploadServiceAccess.InsertItemMasterMapCategoryExcel(model.InventoryExcelUploadDTO);
                        model.InventoryExcelUploadDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    else if (IsExcelValid == false)
                    {
        ...
        public ActionResult UploadExcelForItemMasterStoreDataExcel(InventoryExcelUploadViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryExcelUploadDTO != null)
                {
                    ...
                    if (xmlParameter != string.Empty && xmlParameter != null && IsExcelValid == true)
                    {
                        IBaseEntityResponse<InventoryExcelUpload> response = _InventoryExcelUploadServiceAccess.InsertItemMasterStoreDataExcel(model.InventoryExcelUploadDTO);
                        model.InventoryExcelUploadDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    else if (IsExcelValid == false)
                    {
        ...
        public ActionResult UploadExcelForPriceReport(InventoryExcelUploadViewModel model)
        {
            try
            {
                ...
                if (model != null && model.InventoryExcelUploadDTO != null)
                {
                    ...
                    if (xmlParameter != string.Empty && xmlParameter != null && IsExcelValid == true)
                    {
                        IBaseEntityResponse<InventoryExcelUpload> response = _InventoryExcelUploadServiceAccess.InsertItemMasterPriceReportExcel(model.InventoryExcelUploadDTO);
                        model.InventoryExcelUploadDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    else if (IsExcelValid == false)
                    {
                                    ...
                                    if ((IsExcelValid == true))
                                    {
                                        ...
                                        if (extension == ".xls" || extension == ".xlsx")
                                        {
                                            if (
                                                  ...
                                                  dt.Columns[2].ColumnName != "Site" ||
                                                  dt.Columns[3].ColumnName != "Order UoM" ||
                                                  dt.Columns[4].ColumnName != "Cost per Order Unit" ||
                                                  dt.Columns[5].ColumnName != "Sales UoM" ||
                                                  dt.Columns[6].ColumnName != "Sales Price")
                                            {
                                                IsExcelValid = false;
                                                errorMessage = "Invalid excel column,warning";
                                            }
