    ...
    public class GeneralTaskModelController : BaseController
    {
       ...
       // IFeeCriteriaParametersAndValuesServiceAccess _feeCriteriaParametersAndValuesServiceAccess = null;
        ...
        public GeneralTaskModelController()
        {
            ...
            //_feeCriteriaParametersAndValuesServiceAccess = new GeneralTaskModelServiceAccess();
        ...
        public ActionResult Create(GeneralTaskModelViewModel model)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralTaskModel> response = _GeneralTaskModelServiceAccess.InsertGeneralTaskModel(model.GeneralTaskModelDTO);
                model.GeneralTaskModelDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        //            IBaseEntityResponse<GeneralTaskModel> response = _GeneralTaskModelServiceAccess.DeleteGeneralTaskModel(GeneralTaskModelDTO);
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                if (ID > 0)
                {
                    ...
                    GeneralTaskModelDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralTaskModel> response = _GeneralTaskModelServiceAccess.DeleteGeneralTaskModel(GeneralTaskModelDTO);
                    model.GeneralTaskModelDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    return Json(model.GeneralTaskModelDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
                {
        ...
        public List<GeneralTaskModel> GetListGeneralTaskModel( out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskModel> baseEntityCollectionResponse = _GeneralTaskModelServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
