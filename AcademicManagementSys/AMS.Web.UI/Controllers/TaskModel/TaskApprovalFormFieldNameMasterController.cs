...
namespace AMS.Web.UI.Controllers
{
    public class TaskApprovalFormFieldNameMasterController : BaseController
    {
        ...
        ITaskApprovalFormFieldNameMasterServiceAccess _TaskApprovalFormFieldNameMasterServiceAcess = null;
        ...
        public TaskApprovalFormFieldNameMasterController()
        {
            ...
            _TaskApprovalFormFieldNameMasterServiceAcess = new TaskApprovalFormFieldNameMasterServiceAccess();
        }
    ...
    public ActionResult Create(TaskApprovalFormFieldNameMasterViewModel model)
    {
        try
        {
            ...
            if (model != null && model.TaskApprovalFormFieldNameMasterDTO != null)
            {
                ...
                model.TaskApprovalFormFieldNameMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
    ...
    protected List<GeneralTaskModel> GetListGeneralTaskModel()
    {
        ...
        IBaseEntityCollectionResponse<GeneralTaskModel> baseEntityCollectionResponse = _GeneralTaskModelServiceAccess.GetTaskCode(searchRequest);
