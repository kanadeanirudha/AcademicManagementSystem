...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralRequestMasterServiceAccess _GeneralRequestMasterServiceAcess = null;
        ...
        {
            _GeneralRequestMasterServiceAcess = new GeneralRequestMasterServiceAccess();
            ...
            try
            {
                ...
                if (model != null && model.GeneralRequestMasterDTO != null)
                {
                  ...
                  //  model.GeneralRequestMasterDTO.LinkMenuCode = model.LinkMenuCode;
                    ...
                    model.GeneralRequestMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public GeneralTaskReportingDetailsServiceAccess _GeneralTaskReportingDetailsServiceAccess { get; set; }
    }
}