...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IRequestApprovalFormFieldNameMasterServiceAccess _RequestApprovalFormFieldNameMasterServiceAcess = null;
        IGeneralRequestMasterServiceAccess _GeneralRequestMasterServiceAccess =  null;
        ...
        {
            _RequestApprovalFormFieldNameMasterServiceAcess = new RequestApprovalFormFieldNameMasterServiceAccess();
            _GeneralRequestMasterServiceAccess = new GeneralRequestMasterServiceAccess();
            ...
            try
            {
               ...
               // {
                    if (model != null && model.RequestApprovalFormFieldNameMasterDTO != null)
                    {
                        ...
                        model.RequestApprovalFormFieldNameMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
    ...
    protected List<GeneralRequestMaster> GetListGeneralRequestMaster()
    {
       GeneralRequestMasterSearchRequest searchRequest = new GeneralRequestMasterSearchRequest();
        ...
        IBaseEntityCollectionResponse<GeneralRequestMaster> baseEntityCollectionResponse = _GeneralRequestMasterServiceAccess.GetRequestCode(searchRequest);
