...
namespace AMS.Web.UI.Controllers
{
    public class GeneralTaskReportingDetailsController : BaseController
    {
        ...
        public ActionResult Index()
        {
            try
            {
               if (Convert.ToString(Session["UserType"]) == "A" || Convert.ToInt32(Session["SuperUser"]) > 0 || Convert.ToInt32(Session["AdmMgr"]) > 0)
                {
        ...
        public ActionResult CreateApprovalStageDetails(GeneralTaskReportingDetailsViewModel model)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralTaskReportingDetails> response = _generalTaskReportingDetailsServiceAccess.InsertGeneralTaskApprovalStageDetails(model.GeneralTaskReportingDetailsDTO);
                model.GeneralTaskReportingDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult EditApprovalStageDetails(string ids)
        {
            try
            {
                IGeneralTaskReportingDetailsViewModel model = new GeneralTaskReportingDetailsViewModel();
                 ...
                 IBaseEntityResponse<GeneralTaskReportingDetails> response = _generalTaskReportingDetailsServiceAccess.SelectByID(model.GeneralTaskReportingDetailsDTO);
        ...
        public ActionResult EditApprovalStageDetails(GeneralTaskReportingDetailsViewModel model)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralTaskReportingDetails> response = _generalTaskReportingDetailsServiceAccess.UpdateGeneralTaskReportingDetails(model.GeneralTaskReportingDetailsDTO);
                model.GeneralTaskReportingDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(model.GeneralTaskReportingDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        ////        model.GeneralTaskReportingDetailsDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
        ////        IBaseEntityResponse<GeneralTaskReportingDetails> response = _generalTaskReportingDetailsServiceAccess.InsertGeneralTaskReportingDetails(model.GeneralTaskReportingDetailsDTO);
        ...
        public ActionResult CreateTaskReportingMaster(GeneralTaskReportingDetailsViewModel model)
        {
            try
            {
                ...
                model.GeneralTaskReportingDetailsDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                IBaseEntityResponse<GeneralTaskReportingDetails> response = _generalTaskReportingDetailsServiceAccess.InsertGeneralTaskReportingMaster(model.GeneralTaskReportingDetailsDTO);
                model.GeneralTaskReportingDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                return Json(model.GeneralTaskReportingDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
        ...
        protected List<GeneralTaskReportingDetails> GetGeneralTaskModelList()
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.GetGeneralTaskModelList(searchRequest);
            if (baseEntityCollectionResponse != null) {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0) {
        ...
        protected List<GeneralTaskReportingDetails> GetReportingRoleIDsList(int GeneralTaskReportingMstID,int StageSequenceNumber) {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.ReportingRoleIDsSearchList(searchRequest);
            if (baseEntityCollectionResponse != null) {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0) {
        ...
        protected List<GeneralTaskReportingDetails> GetDepartmentList(string centreCode, int generalTaskReportingDetailsID , bool isCreateStageDetails)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.DepartmentList(searchRequest);
            if (baseEntityCollectionResponse != null) {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0) {
        ...
        public List<GeneralTaskReportingDetails> GetListGeneralTaskReportingMaster(out int TotalRecords, string centreCode, bool reloadStatus)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<GeneralTaskReportingDetails> GetListGeneralTaskReportingDetailsApprovalStages(out int TotalRecords, int ID, int NumberOfApprovalStages)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.GetTaskReportingDetailsApprovalStages(searchRequest);
            if (baseEntityCollectionResponse != null) {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0) {
                    listGeneralTaskReportingDetails = baseEntityCollectionResponse.CollectionResponse.ToList();
                }
        ...
        public List<GeneralTaskReportingDetails> GetListGeneralTaskReportingDetailsApprovalStageDetails(out int TotalRecords, int GeneralTaskReportingMasterID, int StageSequenceNumber, string reloadStatus)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTaskReportingDetails> baseEntityCollectionResponse = _generalTaskReportingDetailsServiceAccess.GetTaskReportingDetailsApprovalStageDetails(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
