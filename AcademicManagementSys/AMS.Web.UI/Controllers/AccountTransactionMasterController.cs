...
namespace AMS.Web.UI.Controllers
{
    public class AccountTransactionMasterController : BaseController
    {
        ...
        IAccountTransactionMasterServiceAccess _accountTransactionMasterServiceAccess = null;
        ...
        {
            _accountTransactionMasterServiceAccess = new AccountTransactionMasterServiceAccess();
        ...
        public ActionResult Index(string selectedTransactionCode, string selectedTransactionTypeText, string selectedBalsheet, string actionMode, string TransactionID)
        {
            ...
            return PartialView("/Views/AccountTransactionMaster/Index.cshtml", model);
        }
        ...
        public ActionResult Create(AccountTransactionMasterViewModel model)
        {
            try
            {
                if (model != null && model.AccountTransactionMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<AccountTransactionMaster> response = _accountTransactionMasterServiceAccess.InsertAccountTransactionMaster(model.AccountTransactionMasterDTO);
                    ...
                    {
                        model.AccountTransactionMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(AccountTransactionMasterViewModel model)
        {
            try
            {
                if (model != null && model.AccountTransactionMasterDTO != null)
                {
                    ...
                    {
                        model.AccountTransactionMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
        ...
        public ActionResult AccountVoucherRequestApproval(AccountTransactionMasterViewModel model)
        {
            ...
            model.AccountTransactionMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
            IBaseEntityResponse<AccountTransactionMaster> response = _accountTransactionMasterServiceAccess.InsertAccountVoucherRequest(model.AccountTransactionMasterDTO);
        ...
        protected List<AccountTransactionMaster> GetAccountList(string SearchKeyWord, int accountId, string personType, string transactionTypeCode)
        {
            ...
            IBaseEntityCollectionResponse<AccountTransactionMaster> baseEntityCollectionResponse = _accountTransactionMasterServiceAccess.GetAccountList(searchRequest);
        ...
        public List<AccountTransactionMaster> GetListAccountTransactionMaster(string SelectedTransactionType, string SelectedBalancesheetID, string SelectedAccSessionID, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountTransactionMaster> baseEntityCollectionResponse = _accountTransactionMasterServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<AccountTransactionMaster> GetListAccountTransactionMasterForEditView(string TransactionMainID)
        {
            ...
            IBaseEntityCollectionResponse<AccountTransactionMaster> baseEntityCollectionResponse = _accountTransactionMasterServiceAccess.GetBySearchForEditView(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<AccountTransactionMaster> GetAccountVoucherListForApproval(int personId, int taskNotificationMasterID)
        {
            ...
            IBaseEntityCollectionResponse<AccountTransactionMaster> baseEntityCollectionResponse = _accountTransactionMasterServiceAccess.GetVoucherDetailsForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
