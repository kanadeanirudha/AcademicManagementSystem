    ...
    public class AdminSnPostsController : BaseController
    {
        ...
        public ActionResult List(string centerCode, string departmentID, string actionMode)
        {
            try
            {
                ...
                return PartialView("List", _adminSnPostsBaseViewModel);             
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (model != null && model.AdminSnPostsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.InsertAdminSnPosts(model.AdminSnPostsDTO);
                        model.AdminSnPostsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }                
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.SelectByID(model.AdminSnPostsDTO);
            ...
            {               
                    if (model != null && model.AdminSnPostsDTO != null)
                    {
                        if (model != null && model.AdminSnPostsDTO != null)
                        {
                            ...
                            IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.UpdateAdminSnPosts(model.AdminSnPostsDTO);
                            model.AdminSnPostsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }          
                    return Json(model.AdminSnPostsDTO.errorMessage, JsonRequestBehavior.AllowGet);               
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(AdminSnPostsViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        if (model.ID > 0)
        ...
        //            AdminSnPostsDTO.ID = model.ID;
        //            AdminSnPostsDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.DeleteAdminSnPosts(AdminSnPostsDTO);
        ...
        //    //IBaseEntityResponse<AdminSnPosts> response = null;
        //    //if (model.ID > 0)
        //    //{
        //    //    AdminSnPosts AdminSnPostsDTO = new AdminSnPosts();
        //    //    AdminSnPostsDTO.ConnectionString = _connectioString;
        //    //    AdminSnPostsDTO.ID = model.ID;
        //    //    response = _adminSnPostsServiceAcess.DeleteAdminSnPosts(AdminSnPostsDTO);
        //    //}
        //    //if (response.Message.Count == 0)
        //    //{
        //    //    return Json(Boolean.TrueString + "::" + model.CentreCodeWithName + "::" + model.DepartmentIdWithName);
        //    //}
        //    //else
        //    //{
        ...
        public ActionResult Delete(int ID)
        {
            AdminSnPostsViewModel model = new AdminSnPostsViewModel();
                ...
                if (ID > 0)
                {
                    ...
                    AdminSnPostsDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.DeleteAdminSnPosts(AdminSnPostsDTO);
                    model.AdminSnPostsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<AdminSnPostsViewModel> GetAdminSnPosts(string centerCode, int departmentId, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AdminSnPosts> baseEntityCollectionResponse = _adminSnPostsServiceAcess.GetBySearch(searchRequest);
