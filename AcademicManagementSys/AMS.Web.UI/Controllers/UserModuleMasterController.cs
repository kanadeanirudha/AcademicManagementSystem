    ...
    public class UserModuleMasterController : BaseController
    {
          ...
          try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.UserModuleMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<UserModuleMaster> response = _userModuleMasterServiceAcess.InsertUserModuleMaster(model.UserModuleMasterDTO);
                    model.UserModuleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<UserModuleMaster> response = _userModuleMasterServiceAcess.SelectByID(model.UserModuleMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.UserModuleMasterDTO != null)
                {
                    if (model != null && model.UserModuleMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<UserModuleMaster> response = _userModuleMasterServiceAcess.UpdateUserModuleMaster(model.UserModuleMasterDTO);
                        model.UserModuleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
        ...
        //[HttpPost]
        //public ActionResult Delete(UserModuleMasterViewModel model)
        //{
        // try
        //    {
        //    if (!ModelState.IsValid)
        ...
        //            UserModuleMasterDTO.ID = model.ID;
        //            UserModuleMasterDTO.DeletedBy = Convert.ToInt32(Session["UserId"]);
        //            IBaseEntityResponse<UserModuleMaster> response = _userModuleMasterServiceAcess.DeleteUserModuleMaster(UserModuleMasterDTO);
            ...
            try
            {
                ...
                //{
                    if (ID > 0)
                    {
                        ...
                        UserModuleMasterDTO.DeletedBy = Convert.ToInt32(Session["UserId"]);
                        IBaseEntityResponse<UserModuleMaster> response = _userModuleMasterServiceAcess.DeleteUserModuleMaster(UserModuleMasterDTO);
                        model.UserModuleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    // return Content(Boolean.TrueString);
                    return Json(model.UserModuleMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                //}
        ...
        public IEnumerable<UserModuleMasterViewModel> GetUserModuleMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<UserModuleMaster> baseEntityCollectionResponse = _userModuleMasterServiceAcess.GetBySearch(searchRequest);
