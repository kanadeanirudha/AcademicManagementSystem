...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IAttendenceMonitoringSystemServiceAccess _attendenceMonitoringSystemServiceAccess = null;   
        ...
        {
            _attendenceMonitoringSystemServiceAccess = new AttendenceMonitoringSystemServiceAccess();            
        }
        ...
        protected List<AttendenceMonitoringSystem> GetAttendenceMonitoringSystemBySearch(int Level, string CentreCode, int DeptID ,out int AccessLevel)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AttendenceMonitoringSystem> baseEntityCollectionResponse = _attendenceMonitoringSystemServiceAccess.GetAttendenceMonitoringSystemBySearch(searchRequest);
        ...
        protected List<AttendenceMonitoringSystem> LoadAllAttendenceDetailsInDateRange(DateTime fromDate,DateTime toDate,int employeeID )
        {
            try
            {
                ...
                List<AttendenceMonitoringSystem> listAttendenceMonitoringSystem = new List<AttendenceMonitoringSystem>();
                IBaseEntityCollectionResponse<AttendenceMonitoringSystem> baseEntityCollectionResponse = _attendenceMonitoringSystemServiceAccess.GetAttendenceDetailsByEmployeeID(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
