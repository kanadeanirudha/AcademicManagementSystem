...
namespace AMS.Web.UI.Controllers
{
    public class AccountChequeBookMasterController : BaseController
    {
        ...
        IAccountChequeBookMasterServiceAccess _accountChequeBookMasterServiceAccess = null;
        ...
        {
            _accountChequeBookMasterServiceAccess = new AccountChequeBookMasterServiceAccess();
        ...
        public ActionResult Create( string Balancesheet, string AccID)
        {
            try
            {
                ...
                IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.SelectByAccountID(model.AccountChequeBookMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountChequeBookMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.InsertAccountChequeBookMaster(model.AccountChequeBookMasterDTO);
                        model.AccountChequeBookMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit( int ID, string Balancesheet, string AccVal)
        {
            try
            {
                ...
                model.ID = ID;
                model.AccountChequeBookMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.SelectByID(model.AccountChequeBookMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountChequeBookMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.UpdateAccountChequeBookMaster(model.AccountChequeBookMasterDTO);
                        model.AccountChequeBookMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        var actionMode = model.AccountChequeBookMasterDTO.errorMessage.Split(',');
                        TempData["ActionMode"] = actionMode[2];
                    }
                    return Json(model.AccountChequeBookMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        //    {
        //        AccountChequeBookMasterViewModel model = new AccountChequeBookMasterViewModel();
        //        model.AccountChequeBookMasterDTO = new AccountChequeBookMaster();
        //        model.AccountChequeBookMasterDTO.ID = ID;
        //        model.AccountChequeBookMasterDTO.ConnectionString = _connectioString;
        //        IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.SelectByID(model.AccountChequeBookMasterDTO);
        //        if (response != null && response.Entity != null)
        //        {
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                    ...
                    IBaseEntityResponse<AccountChequeBookMaster> response = _accountChequeBookMasterServiceAccess.DeleteAccountChequeBookMaster(AccountChequeBookMasterDTO);
                    model.AccountChequeBookMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    //var actionMode = model.AccountChequeBookMasterDTO.errorMessage.Split(',');
                    //TempData["ActionMode"] = actionMode[2];
                    return Json(model.AccountChequeBookMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        public List<AccountChequeBookMaster> GetListAccountChequeBookMaster( string SelectedBalanceSheet, out int _totalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountChequeBookMaster> baseEntityCollectionResponse = _accountChequeBookMasterServiceAccess.GetBySearch(searchRequest);
        ...
        public List<AccountBalancesheetMaster> GetListAccountBalanceSheetMaster(string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<AccountBalancesheetMaster> baseEntityCollectionResponse = _accountBalancesheetMasterServiceAccess.GetBalanceSheetList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
