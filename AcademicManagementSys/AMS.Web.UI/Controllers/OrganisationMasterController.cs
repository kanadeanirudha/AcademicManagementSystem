...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IOrganisationMasterServiceAccess _organisationMasterServiceAcess = null;
        ...
        {
            _organisationMasterServiceAcess = new OrganisationMasterServiceAccess();
         ...
         try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.OrganisationMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<OrganisationMaster> response = _organisationMasterServiceAcess.InsertOrganisationMaster(model.OrganisationMasterDTO);
                    model.OrganisationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            {                
                ...
                IBaseEntityResponse<OrganisationMaster> response = _organisationMasterServiceAcess.SelectByID(model.OrganisationMasterDTO);
           ...
           try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.OrganisationMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<OrganisationMaster> response = _organisationMasterServiceAcess.UpdateOrganisationMaster(model.OrganisationMasterDTO);
                    model.OrganisationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                }
                return Json(model.OrganisationMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(OrganisationMasterViewModel model)
        //{
        //  try
        //    {
        ...
        //            IBaseEntityResponse<OrganisationMaster> response = _organisationMasterServiceAcess.DeleteOrganisationMaster(orgStreamMasterDTO);
            ...
            try
            {
                ...
                if (ID > 0)
                {
                    ...
                    //{
                        ...
                        orgStreamMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<OrganisationMaster> response = _organisationMasterServiceAcess.DeleteOrganisationMaster(orgStreamMasterDTO);
                        model.OrganisationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    //}
                    return Json(model.OrganisationMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public IEnumerable<OrganisationMasterViewModel> GetOrganisationMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<OrganisationMaster> baseEntityCollectionResponse = _organisationMasterServiceAcess.GetBySearch(searchRequest);
