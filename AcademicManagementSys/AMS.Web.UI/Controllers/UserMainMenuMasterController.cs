...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IUserMainMenuMasterServiceAccess _userMainMenuMasterServiceAcess = null;
        ...
        {
            _userMainMenuMasterServiceAcess = new UserMainMenuMasterServiceAccess();
          ...
          try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.UserMainMenuMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<UserMainMenuMaster> response = _userMainMenuMasterServiceAcess.InsertUserMainMenuMaster(model.UserMainMenuMasterDTO);
                    model.UserMainMenuMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<UserMainMenuMaster> response = _userMainMenuMasterServiceAcess.SelectByID(model.UserMainMenuMasterDTO);
          ...
          try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.UserMainMenuMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<UserMainMenuMaster> response = _userMainMenuMasterServiceAcess.UpdateUserMainMenuMaster(model.UserMainMenuMasterDTO);
                    model.UserMainMenuMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                }
                return Json(model.UserMainMenuMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            else
        ...
        //            IBaseEntityResponse<UserMainMenuMaster> response = _userMainMenuMasterServiceAcess.DeleteUserMainMenuMaster(UserMainMenuMasterDTO);
            ...
            try
            {
                ...
                //{
                    if (ID > 0)
                    {
                        ...
                        UserMainMenuMasterDTO.DeletedBy = Convert.ToInt32(Session["UserId"]);
                        IBaseEntityResponse<UserMainMenuMaster> response = _userMainMenuMasterServiceAcess.DeleteUserMainMenuMaster(UserMainMenuMasterDTO);
                        model.UserMainMenuMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    // return Content(Boolean.TrueString);
                    return Json(model.UserMainMenuMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                //}
        ...
        public IEnumerable<UserMainMenuMasterViewModel> GetUserMainMenuMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<UserMainMenuMaster> baseEntityCollectionResponse = _userMainMenuMasterServiceAcess.GetBySearch(searchRequest);
        ...
        protected List<UserMainMenuMaster> GetParentMenuList(string ModuleCode)
        {
            ...
            IBaseEntityCollectionResponse<UserMainMenuMaster> baseEntityCollectionResponse = _userMainMenuMasterServiceAcess.GetParentMenuByModuleID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
