...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveManualAttendanceServiceAccess _leaveManualAttendanceServiceAcess = null;
        ...
        {
            _leaveManualAttendanceServiceAcess = new LeaveManualAttendanceServiceAccess();
        ...
        public ActionResult Create(LeaveManualAttendanceViewModel model)
        {
            try
            {
                ...
                if (model != null && model.LeaveManualAttendanceDTO != null)
                {
                    ...
                    IBaseEntityResponse<LeaveManualAttendance> response = _leaveManualAttendanceServiceAcess.InsertLeaveManualAttendance(model.LeaveManualAttendanceDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                model.LeaveManualAttendanceDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<LeaveManualAttendance> response = _leaveManualAttendanceServiceAcess.SelectByID(model.LeaveManualAttendanceDTO);
                ...
                if (model != null && model.LeaveManualAttendanceDTO != null)
                {
                    if (model != null && model.LeaveManualAttendanceDTO != null)
                    {
                       ...
                       //s model.LeaveManualAttendanceDTO.Status = model.Status;
                        ...
                        IBaseEntityResponse<LeaveManualAttendance> response = _leaveManualAttendanceServiceAcess.UpdateLeaveManualAttendance(model.LeaveManualAttendanceDTO);
        ...
        public IEnumerable<LeaveManualAttendanceViewModel> GetLeaveManualAttendance(out int TotalRecords, int personID, string centreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveManualAttendance> baseEntityCollectionResponse = _leaveManualAttendanceServiceAcess.GetBySearch(searchRequest);
