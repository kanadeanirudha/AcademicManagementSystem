...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveLateMarkRulesDetailsServiceAccess _LeaveLateMarkRulesDetailsServiceAccess = null;
        ...
        {
            _LeaveLateMarkRulesDetailsServiceAccess = new LeaveLateMarkRulesDetailsServiceAccess();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeaveLateMarkRulesDetailsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveLateMarkRulesDetails> response = _LeaveLateMarkRulesDetailsServiceAccess.InsertLeaveLateMarkRulesDetails(model.LeaveLateMarkRulesDetailsDTO);
                        ...
                        {
                            model.LeaveLateMarkRulesDetailsDTO.ErrorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                        }
                    }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<LeaveLateMarkRulesDetails> response = _LeaveLateMarkRulesDetailsServiceAccess.SelectByID(model.LeaveLateMarkRulesDetailsDTO);
        ...
        public ActionResult Edit(LeaveLateMarkRulesDetailsViewModel model)
        {
            ...
            if (model != null && model.LeaveLateMarkRulesDetailsDTO != null)
            {
                ...
                IBaseEntityResponse<LeaveLateMarkRulesDetails> response = _LeaveLateMarkRulesDetailsServiceAccess.UpdateLeaveLateMarkRulesDetails(model.LeaveLateMarkRulesDetailsDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID != null)
            {
                ...
                IBaseEntityResponse<LeaveLateMarkRulesDetails> response = _LeaveLateMarkRulesDetailsServiceAccess.DeleteLeaveLateMarkRulesDetails(LeaveLateMarkRulesDetailsDTO);
                //model.LeaveLateMarkRulesDetailsDTO.ErrorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                model.LeaveLateMarkRulesDetailsDTO.ErrorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                return Json(model.LeaveLateMarkRulesDetailsDTO.ErrorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        public IEnumerable<LeaveLateMarkRulesDetailsViewModel> GetLeaveLateMarkRulesDetailsRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveLateMarkRulesDetails> baseEntityCollectionResponse = _LeaveLateMarkRulesDetailsServiceAccess.GetBySearch(searchRequest);
