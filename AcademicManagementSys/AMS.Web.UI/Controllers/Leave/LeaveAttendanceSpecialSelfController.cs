...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveAttendanceSpecialRequestServiceAccess _leaveAttendanceSpecialRequestServiceAccess = null;
        ...
        {
            _leaveAttendanceSpecialRequestServiceAccess = new LeaveAttendanceSpecialRequestServiceAccess();
        ...
        public ActionResult Create(LeaveAttendanceSpecialRequestViewModel model)
        {
            try
            {
                 if (model != null && model.LeaveAttendanceSpecialRequestDTO != null)
                {
                    ...
                    IBaseEntityResponse<LeaveAttendanceSpecialRequest> response = _leaveAttendanceSpecialRequestServiceAccess.InsertLeaveAttendanceSpecialRequest(model.LeaveAttendanceSpecialRequestDTO);
        ...
        public IEnumerable<LeaveAttendanceSpecialRequestViewModel> GetLeaveAttendanceSpecialRequestRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveAttendanceSpecialRequest> baseEntityCollectionResponse = _leaveAttendanceSpecialRequestServiceAccess.GetBySearch(searchRequest);
