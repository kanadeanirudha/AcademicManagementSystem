...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeavePostServiceAccess _LeavePostServiceAccess = null;
        ...
        {
            _LeavePostServiceAccess = new LeavePostServiceAccess();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeavePostDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeavePost> response = _LeavePostServiceAccess.InsertLeavePostAtYearEnd(model.LeavePostDTO);
        ...
        public ActionResult Edit(string ID, string LeaveDescription, string Mode)
        {
            ...
            IBaseEntityResponse<LeavePost> response = _LeavePostServiceAccess.SelectByID(_LeavePostViewModel.LeavePostDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeavePostDTO != null)
                    {
                        if (model != null && model.LeavePostDTO != null)
                        {
                            ...
                            IBaseEntityResponse<LeavePost> response = _LeavePostServiceAccess.UpdateLeavePost(model.LeavePostDTO);
        ...
        public IEnumerable<LeavePostViewModel> GetLeavePostAtTheYearEndRecords(string CentreCode,int FromLeaveSessionID,int ToLeaveSessionID)
        {
            ...
            IBaseEntityCollectionResponse<LeavePost> baseEntityCollectionResponse = _LeavePostServiceAccess.GetLeaveSummaryAtTheYearEndBySearch(searchRequest);
        ...
        protected List<LeaveSession> GetListToLeaveSession(string CentreCode,string FromLeaveSessionID)
        {
            ...
            IBaseEntityCollectionResponse<LeaveSession> baseEntityCollectionResponse = _leaveSessionServiceAccess.GetByFromLeaveSessionID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
