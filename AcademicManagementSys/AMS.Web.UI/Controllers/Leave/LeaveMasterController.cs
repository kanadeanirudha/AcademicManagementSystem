    ...
    public class LeaveMasterController : BaseController
    {
        ...
        public ActionResult Create(LeaveMasterViewModel _leaveMasterViewModel)
        {
            try
            {
                ...
                IBaseEntityResponse<LeaveMaster> response = _leaveMasterServiceAccess.InsertLeaveMaster(_leaveMasterViewModel.LeaveMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
               ...
               IBaseEntityResponse<LeaveMaster> response = _leaveMasterServiceAccess.SelectByID(_leaveMasterViewModel.LeaveMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (_leaveMasterViewModel != null &&_leaveMasterViewModel.LeaveMasterDTO != null)
                {
                    if (_leaveMasterViewModel != null &&_leaveMasterViewModel.LeaveMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveMaster> response = _leaveMasterServiceAccess.UpdateLeaveMaster(_leaveMasterViewModel.LeaveMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            //{
                if (ID!= null)
                {
                    ...
                    IBaseEntityResponse<LeaveMaster> response = _leaveMasterServiceAccess.DeleteLeaveMaster(LeaveMasterDTO);
                    //_leaveMasterViewModel.LeaveMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    _leaveMasterViewModel.LeaveMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<LeaveMasterViewModel> GetLeaveMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<LeaveMaster> baseEntityCollectionResponse = _leaveMasterServiceAccess.GetBySearch(searchRequest);
