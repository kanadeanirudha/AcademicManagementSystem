...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveRuleExemptedEmployeeServiceAccess _LeaveRuleExemptedEmployeeServiceAccess = null;
        ...
        {
            _LeaveRuleExemptedEmployeeServiceAccess = new LeaveRuleExemptedEmployeeServiceAccess();
        ...
        public ActionResult Create(LeaveRuleExemptedEmployeeViewModel model)
        {
            try
            {
                ...
                if (model != null && model.LeaveRuleExemptedEmployeeDTO != null)
                {
                    ...
                    IBaseEntityResponse<LeaveRuleExemptedEmployee> response = _LeaveRuleExemptedEmployeeServiceAccess.InsertLeaveRuleExemptedEmployee(model.LeaveRuleExemptedEmployeeDTO);
                    model.LeaveRuleExemptedEmployeeDTO.ErrorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(string ID)
        {
            ...
            if (ID != null)
            {
                ...
                IBaseEntityResponse<LeaveRuleExemptedEmployee> response = _LeaveRuleExemptedEmployeeServiceAccess.UpdateLeaveRuleExemptedEmployee(model.LeaveRuleExemptedEmployeeDTO);
                //model.LeaveRuleExemptedEmployeeDTO.ErrorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                model.LeaveRuleExemptedEmployeeDTO.ErrorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(model.LeaveRuleExemptedEmployeeDTO.ErrorMessage, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        public ActionResult Delete(LeaveRuleExemptedEmployeeViewModel model)
        {
            ...
            if (model.ID > 0)
            {
                ...
                IBaseEntityResponse<LeaveRuleExemptedEmployee> response = _LeaveRuleExemptedEmployeeServiceAccess.DeleteLeaveRuleExemptedEmployee(LeaveRuleExemptedEmployeeDTO);
        ...
        protected List<LeaveRuleMaster> GetListLeaveRuleStatusByEmployeeID(string EmployeeID, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleMaster> baseEntityCollectionResponse = _LeaveRuleMasterServiceAccess.LeaveRuleStatusGetByCentreAndEmployee(searchRequest);
        ...
        public IEnumerable<LeaveRuleExemptedEmployeeViewModel> GetLeaveRuleExemptedEmployeeRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleExemptedEmployee> baseEntityCollectionResponse = _LeaveRuleExemptedEmployeeServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
