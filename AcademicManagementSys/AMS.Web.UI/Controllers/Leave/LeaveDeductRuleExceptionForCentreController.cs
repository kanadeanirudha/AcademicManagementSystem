...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveDeductRuleExceptionForCentreServiceAccess _LeaveDeductRuleExceptionForCentreServiceAcess = null;
        ...
        {
            _LeaveDeductRuleExceptionForCentreServiceAcess = new LeaveDeductRuleExceptionForCentreServiceAccess();
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeaveDeductRuleExceptionForCentreDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveDeductRuleExceptionForCentre> response = _LeaveDeductRuleExceptionForCentreServiceAcess.InsertLeaveDeductRuleExceptionForCentre(model.LeaveDeductRuleExceptionForCentreDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<LeaveDeductRuleExceptionForCentre> response = _LeaveDeductRuleExceptionForCentreServiceAcess.SelectByID(model.LeaveDeductRuleExceptionForCentreDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.LeaveDeductRuleExceptionForCentreDTO != null)
                {
                    if (model != null && model.LeaveDeductRuleExceptionForCentreDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveDeductRuleExceptionForCentre> response = _LeaveDeductRuleExceptionForCentreServiceAcess.UpdateLeaveDeductRuleExceptionForCentre(model.LeaveDeductRuleExceptionForCentreDTO);
        ...
        {           
            ...
            IBaseEntityCollectionResponse<LeaveDeductRuleExceptionForCentre> baseEntityCollectionResponse = _LeaveDeductRuleExceptionForCentreServiceAcess.GetBySearch(searchRequest);
