...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveCompensatoryWorkDayServiceAccess _LeaveCompensatoryWorkDayServiceAccess = null;
        ...
        {
            _LeaveCompensatoryWorkDayServiceAccess = new LeaveCompensatoryWorkDayServiceAccess();
        }
        ...
        public ActionResult Create(LeaveCompensatoryWorkDayViewModel _LeaveCompensatoryWorkDayViewModel)
        {
            try
            {
                ...
                IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.InsertLeaveCompensatoryWorkDay(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.SelectByID(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
        ...
        public ActionResult Edit(LeaveCompensatoryWorkDayViewModel _LeaveCompensatoryWorkDayViewModel)
        {
            ...
            if (_LeaveCompensatoryWorkDayViewModel != null && _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO != null)
            {
                ...
                IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.UpdateLeaveCompensatoryWorkDay(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
        ...
        public ActionResult Delete(int ID)
        {
            try { 
                ...
                if (ID > 0)
                {
                    ...
                    IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.DeleteLeaveCompensatoryWorkDay(LeaveCompensatoryWorkDayDTO);
                    //_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    model.LeaveCompensatoryWorkDayDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public ActionResult RequestApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            ...
            _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.ConnectionString = _connectioString;
            IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.GetCompensatoryOffDayApplicationDetailsByID(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
            if (response != null && response.Entity != null)
            {
                _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.ID = response.Entity.ID;
                _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.EmployeeID = response.Entity.EmployeeID;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (_LeaveCompensatoryWorkDayViewModel != null && _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO != null)
                    {
                        ...
                        _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.InsertApprovedCompensatoryWorkDayRecord(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
                        _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    return Json(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (_LeaveCompensatoryWorkDayViewModel != null && _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO != null)
                    {
                        ...
                        _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<LeaveCompensatoryWorkDay> response = _LeaveCompensatoryWorkDayServiceAccess.InsertApprovedCompensatoryWorkDayRecord(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO);
                        _LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    return Json(_LeaveCompensatoryWorkDayViewModel.LeaveCompensatoryWorkDayDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<LeaveCompensatoryWorkDayViewModel> GetLeaveCompensatoryWorkDay(int EmployeeID, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<LeaveCompensatoryWorkDay> baseEntityCollectionResponse = _LeaveCompensatoryWorkDayServiceAccess.GetBySearch(searchRequest);
