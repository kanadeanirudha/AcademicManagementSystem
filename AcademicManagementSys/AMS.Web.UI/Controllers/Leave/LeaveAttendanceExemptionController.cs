...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveAttendanceExemptionServiceAccess _leaveAttendanceExemptionServiceAccess = null;
        ...
        {
            _leaveAttendanceExemptionServiceAccess = new LeaveAttendanceExemptionServiceAccess();
        ...
        public ActionResult Action(int ID)
        {
            try
            {
                if (ID > 0) // for edit
                {
                    ...
                    IBaseEntityResponse<LeaveAttendanceExemption> response = _leaveAttendanceExemptionServiceAccess.SelectByID(_leaveAttendanceExemptionViewModel.LeaveAttendanceExemptionDTO);
        ...
        public ActionResult Action(LeaveAttendanceExemptionViewModel model)
        {
            try
            {
                if (model != null && model.LeaveAttendanceExemptionDTO != null && model.ID > 0) // for edit
                {
                    ...
                    IBaseEntityResponse<LeaveAttendanceExemption> response = _leaveAttendanceExemptionServiceAccess.UpdateLeaveAttendanceExemption(model.LeaveAttendanceExemptionDTO);
                ...
                else if (model != null && model.LeaveAttendanceExemptionDTO != null && model.ID == 0) // for create
                {
                    ...
                    IBaseEntityResponse<LeaveAttendanceExemption> response = _leaveAttendanceExemptionServiceAccess.InsertLeaveAttendanceExemption(model.LeaveAttendanceExemptionDTO);
        ...
        public IEnumerable<LeaveAttendanceExemptionViewModel> GetLeaveAttendanceExemptionRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveAttendanceExemption> baseEntityCollectionResponse = _leaveAttendanceExemptionServiceAccess.GetBySearch(searchRequest);
