...
namespace AMS.Web.UI.Controllers
{
    public class LeavePostController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeavePostDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeavePost> response = _LeavePostServiceAccess.InsertLeavePostAtOpening(model.LeavePostDTO);
                        model.LeavePostDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public IEnumerable<LeavePostViewModel> GetLeavePostRecords(string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeavePost> baseEntityCollectionResponse = _LeavePostServiceAccess.GetBySearch(searchRequest);
