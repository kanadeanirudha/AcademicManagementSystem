...
namespace AMS.Web.UI.Controllers
{
    public class LeaveRuleMasterController : BaseController
    {
        ...
        ILeaveRuleMasterViewModel _LeaveRuleMasterViewModel = null;
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeaveRuleMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveRuleMaster> response = _LeaveRuleMasterServiceAccess.InsertLeaveRuleMaster(model.LeaveRuleMasterDTO);
                        model.LeaveRuleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(string ID, string LeaveDescription, string Mode)
        {
            ...
            IBaseEntityResponse<LeaveRuleMaster> response = _LeaveRuleMasterServiceAccess.SelectByID(_LeaveRuleMasterViewModel.LeaveRuleMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeaveRuleMasterDTO != null)
                    {
                        if (model != null && model.LeaveRuleMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<LeaveRuleMaster> response = _LeaveRuleMasterServiceAccess.UpdateLeaveRuleMaster(model.LeaveRuleMasterDTO);
                            model.LeaveRuleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }
                    return Json(model.LeaveRuleMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public IEnumerable<LeaveRuleMasterViewModel> GetLeaveRuleMasterRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleMaster> baseEntityCollectionResponse = _LeaveRuleMasterServiceAccess.GetBySearch(searchRequest);
