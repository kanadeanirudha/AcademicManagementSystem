...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveRuleApplicableDetailsServiceAccess _LeaveRuleApplicableDetailsServiceAccess = null;
        ...
        {
            _LeaveRuleApplicableDetailsServiceAccess = new LeaveRuleApplicableDetailsServiceAccess();
        ...
        public ActionResult CreatePartialForm(string LeaveRuleMasterID)
        {
            ...
            IBaseEntityResponse<LeaveRuleMaster> response = _LeaveRuleMasterServiceAccess.SelectByID(_leaveRuleMsterViewModel.LeaveRuleMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.LeaveRuleApplicableDetailsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveRuleApplicableDetails> response = _LeaveRuleApplicableDetailsServiceAccess.InsertLeaveRuleApplicableDetails(model.LeaveRuleApplicableDetailsDTO);
                        model.LeaveRuleApplicableDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(string ID)
        {
            ...
            if (ID != null)
            {
                ...
                IBaseEntityResponse<LeaveRuleApplicableDetails> response = _LeaveRuleApplicableDetailsServiceAccess.UpdateLeaveRuleApplicableDetails(model.LeaveRuleApplicableDetailsDTO);
                model.LeaveRuleApplicableDetailsDTO.ErrorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(model.LeaveRuleApplicableDetailsDTO.ErrorMessage, JsonRequestBehavior.AllowGet);
            }
            else
            {
        ...
        public ActionResult ViewSessionDetails(string LeaveRuleApplicableDetailsID, string CentreCode, string CentreName, string Mode)
        {
            ...
            IBaseEntityResponse<LeaveRuleApplicableDetails> response = _LeaveRuleApplicableDetailsServiceAccess.SelectByID(_LeaveRuleApplicableDetailsViewModel.LeaveRuleApplicableDetailsDTO);
        ...
        public IEnumerable<LeaveRuleApplicableDetailsViewModel> GetLeaveRuleApplicableDetailsRecords(out int TotalRecords, string CentreCode, int LeaveSessionID)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleApplicableDetails> baseEntityCollectionResponse = _LeaveRuleApplicableDetailsServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected IEnumerable<LeaveRuleApplicableDetailsViewModel> GetLeaveRuleApplicableDetailsByLeaveCode(out int TotalRecords, string centreCode, string LeaveSessionID, string LeaveCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleApplicableDetails> baseEntityCollectionResponse = _LeaveRuleApplicableDetailsServiceAccess.SelectByLeaveRuleMasterID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<LeaveRuleMaster> GetListLeaveRuleMaster(string LeaveCode,string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveRuleMaster> baseEntityCollectionResponse = _LeaveRuleMasterServiceAccess.GetByLeaveCode(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
