...
namespace AMS.Web.UI.Controllers
{
    public class LeaveApplicationCancelSelfController : BaseController
    {
            ...
            try
            {
                ...
                //{
                    if (_LeaveApplicationViewModel != null && _LeaveApplicationViewModel.LeaveApplicationDTO != null)
                    {
                        ...
                        IBaseEntityResponse<LeaveApplication> response = _LeaveApplicationServiceAccess.InsertLeaveApplicationCancel(_LeaveApplicationViewModel.LeaveApplicationDTO);
        ...
        protected List<LeaveApplication> GetLeaveApplicationApprocedPendingStatus_SearchList()
        {
            ...
            IBaseEntityCollectionResponse<LeaveApplication> baseEntityCollectionResponse = _LeaveApplicationServiceAccess.GetLeaveApplicationApprocedPendingStatus_SearchList(searchRequest);
        ...
        public IEnumerable<LeaveApplicationViewModel> GetLeaveApplicationCancel(out int TotalRecords, int EmployeeID)
        {
            ...
            List<LeaveApplication> listLeaveApplication = new List<LeaveApplication>();
            IBaseEntityCollectionResponse<LeaveApplication> baseEntityCollectionResponse = _LeaveApplicationServiceAccess.GetLeaveApplicationCancelBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
