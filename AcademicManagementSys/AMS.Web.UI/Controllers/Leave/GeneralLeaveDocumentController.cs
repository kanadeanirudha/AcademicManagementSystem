    ...
    public class GeneralLeaveDocumentController : BaseController
    {
        ...
        public ActionResult Create(GeneralLeaveDocumentViewModel _generalLeaveDocumentViewModel)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    IBaseEntityResponse<GeneralLeaveDocument> response = _generalLeaveDocumentServiceAccess.InsertGeneralLeaveDocument(_generalLeaveDocumentViewModel.GeneralLeaveDocumentDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralLeaveDocument> response = _generalLeaveDocumentServiceAccess.SelectByID(_generalLeaveDocumentViewModel.GeneralLeaveDocumentDTO);
        ...
        public ActionResult Edit(GeneralLeaveDocumentViewModel _generalLeaveDocumentViewModel)
        {
            if (ModelState.IsValid)
            {
                if (_generalLeaveDocumentViewModel != null && _generalLeaveDocumentViewModel.GeneralLeaveDocumentDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralLeaveDocument> response = _generalLeaveDocumentServiceAccess.UpdateGeneralLeaveDocument(_generalLeaveDocumentViewModel.GeneralLeaveDocumentDTO);
        ...
        public ActionResult Delete(int ID) {
            ...
            try { 
                    ...
                    model.GeneralLeaveDocumentDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralLeaveDocumentViewModel> GetGeneralLeaveDocument(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralLeaveDocument> baseEntityCollectionResponse = _generalLeaveDocumentServiceAccess.GetBySearch(searchRequest);
