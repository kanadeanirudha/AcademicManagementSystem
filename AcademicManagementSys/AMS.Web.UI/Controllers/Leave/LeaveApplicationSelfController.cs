...
namespace AMS.Web.UI.Controllers
{
    public class LeaveApplicationSelfController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                return PartialView("/Views/Leave/LeaveApplicationSelf/ErrorPage.cshtml");
            }
        ...
        public ActionResult Create(LeaveApplicationViewModel _LeaveApplicationViewModel)
        {
            try
            {
               ...
               IBaseEntityResponse<LeaveApplication> response = _LeaveApplicationServiceAccess.InsertLeaveApplication(_LeaveApplicationViewModel.LeaveApplicationDTO);
                _LeaveApplicationViewModel.LeaveApplicationDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public IEnumerable<LeaveApplicationViewModel> GetLeaveApplicationSelf(out int TotalRecords, int EmployeeID, int LeaveSessionID)
        {
            ...
            IBaseEntityCollectionResponse<LeaveApplication> baseEntityCollectionResponse = _LeaveApplicationServiceAccess.GetLeaveSummaryByEmployeeID(searchRequest);
        ...
        protected List<LeaveCompensatoryWorkDay> GetCompensatoryWorkDayRecord(int EmployeeID, int LeaveSessionID)
        {
            ...
            IBaseEntityCollectionResponse<LeaveCompensatoryWorkDay> baseEntityCollectionResponse = _LeaveCompensatoryWorkDayServiceAccess.GetCompensatoryWorkDayDataByEmployeeAndLeaveSessionID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
