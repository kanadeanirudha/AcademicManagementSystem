...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        ILeaveShiftAllocateToCentreServiceAccess _leaveShiftAllocateToCentreServiceAccess = null;
        ...
        {
            _leaveShiftAllocateToCentreServiceAccess = new LeaveShiftAllocateToCentreServiceAccess();
        ...
        public IEnumerable<LeaveShiftAllocateToCentreViewModel> GetLeaveShiftAllocateToCentreRecords(out int TotalRecords, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<LeaveShiftAllocateToCentre> baseEntityCollectionResponse = _leaveShiftAllocateToCentreServiceAccess.GetBySearch(searchRequest);
