...
namespace AMS.Web.UI.Controllers
{
    public class EmployeeQualificationController : BaseController
    {
        ...
        IGeneralEducationMasterServiceAccess _generalEducationMasterServiceAccess = null;
        ...
        public EmployeeQualificationController()
        {
            ...
            _generalEducationMasterServiceAccess = new GeneralEducationMasterServiceAccess();
        ...
        public ActionResult EmployeeQualificationCreate(int EmployeeID)
        {
            ...
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_AWARD, Value = "AWARD" });
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_DISTINCTION, Value = "DISTINCTION" });
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_FIRST, Value = "FIRST" });
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_PROMPT, Value = "PROMPT" });
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_SECOND, Value = "SECOND" });
            li_EmployeeQualification_PassingDivision.Add(new SelectListItem { Text = Resources.DisplayName_THIRD, Value = "THIRD" });
            ...
            li_Student_Qualification_General_YearOfPassing.Add(new SelectListItem { Text = Resources.ddlHeaders_SelectYear, Value = "0" });
            ...
            YearOfPassingAndFrom.Add(new SelectListItem { Text = Resources.ddlHeaders_SelectYear, Value = "0" });
        ...
        public ActionResult EmployeeQualificationCreate(EmployeeQualificationViewModel EmployeeQualificationViewModel)
        {
            try
            {
                ...
                IBaseEntityResponse<EmployeeQualification> response = _EmployeeQualificationServiceAccess.InsertEmployeeQualification(EmployeeQualificationViewModel.EmployeeQualificationDTO);
                EmployeeQualificationViewModel.EmployeeQualificationDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult EmployeeQualificationEdit(int ID, string Mode)
        {
            ...
            IBaseEntityResponse<EmployeeQualification> response = _EmployeeQualificationServiceAccess.SelectByID(model.EmployeeQualificationDTO);
        ...
        public ActionResult EmployeeQualificationEdit(EmployeeQualificationViewModel EmployeeQualificationViewModel)
        {
            try
            {
                ...
                EmployeeQualificationViewModel.EmployeeQualificationDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmployeeQualification> response = _EmployeeQualificationServiceAccess.UpdateEmployeeQualification(EmployeeQualificationViewModel.EmployeeQualificationDTO);
                EmployeeQualificationViewModel.EmployeeQualificationDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(EmployeeQualificationViewModel.EmployeeQualificationDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
        ...
        protected List<GeneralEducationMaster> GetListGeneralEducationMaster(string EducationTypeID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralEducationMaster> baseEntityCollectionResponse = _generalEducationMasterServiceAccess.GetByEducationTypeID(searchRequest);
