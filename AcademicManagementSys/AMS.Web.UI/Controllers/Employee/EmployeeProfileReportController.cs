...
namespace AMS.Web.UI.Controllers.Employee
{
    public class EmployeeProfileReportController : BaseController
    {
        ...
        IEmployeeServiceDetailsServiceAccess _employeeServiceDetailsServiceAcess = null;
        IEmployeeQualificationServiceAccess _EmployeeQualificationServiceAccess = null;
        IEmployeeExperienceServiceAccess _EmployeeExperienceServiceAccess = null;
        IEmployeeCourseSubjectTaughtServiceAccess _EmployeeCourseSubjectTaughtServiceAccess = null;
        IEmployeeElectionNomineeBodyServiceAccess _EmployeeElectionNomineeBodyServiceAccess = null;
        IEmployeePaperPresentServiceAccess _EmployeePaperPresentServiceAccess = null;
        IEmployeePHdGuideRecognisationDetailsServiceAccess _EmployeePHdGuideRecognisationDetailsServiceAcess = null;
        IEmployeeOtherCollegeSpecialLectureDetailsServiceAccess _EmployeeOtherCollegeSpecialLectureDetailsServiceAccess = null;
        IEmployeeProjectWorksMasterServiceAccess _EmployeeProjectWorksMasterServiceAccess = null;
        ...
        IEmployeeConsultancyMasterServiceAccess _EmployeeConsultancyMasterServiceAccess = null;
        ...
        public EmployeeProfileReportController()
        {
            ...
            _EmployeeQualificationServiceAccess = new EmployeeQualificationServiceAccess();
            _EmployeeExperienceServiceAccess = new EmployeeExperienceServiceAccess();
            _EmployeeCourseSubjectTaughtServiceAccess = new EmployeeCourseSubjectTaughtServiceAccess();
            _EmployeeElectionNomineeBodyServiceAccess = new EmployeeElectionNomineeBodyServiceAccess();
            _EmployeePaperPresentServiceAccess = new EmployeePaperPresentServiceAccess();
            _EmployeePHdGuideRecognisationDetailsServiceAcess = new EmployeePHdGuideRecognisationDetailsServiceAccess();
            _EmployeeOtherCollegeSpecialLectureDetailsServiceAccess = new EmployeeOtherCollegeSpecialLectureDetailsServiceAccess();
            _EmployeeProjectWorksMasterServiceAccess = new EmployeeProjectWorksMasterServiceAccess();
            ...
            _EmployeeConsultancyMasterServiceAccess = new EmployeeConsultancyMasterServiceAccess();
        ...
        protected List<EmployeeQualification> GetEmployeeQualification(int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeQualification> baseEntityCollectionResponse = _EmployeeQualificationServiceAccess.GetBySearch(searchRequest);
        ...
        protected List<EmployeeExperience> GetEmployeeExperience(int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeExperience> baseEntityCollectionResponse = _EmployeeExperienceServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<EmployeeElectionNomineeBody> GetEmployeeElectionNomineeBody(int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeElectionNomineeBody> baseEntityCollectionResponse = _EmployeeElectionNomineeBodyServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<EmployeePaperPresent> GetEmployeePaperPresent(int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeePaperPresent> baseEntityCollectionResponse = _EmployeePaperPresentServiceAccess.GetAppliedDetails(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<EmployeeOtherCollegeSpecialLectureDetails> GetEmployeeOtherCollegeSpecialLectureDetails(int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeOtherCollegeSpecialLectureDetails> baseEntityCollectionResponse = _EmployeeOtherCollegeSpecialLectureDetailsServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult _EmployeeProjectWorkDetails(int EmployeeID)
        {
            ...
            IBaseEntityResponse<EmployeeProjectWorksMaster> response = _EmployeeProjectWorksMasterServiceAccess.SelectEmployeeCentreCode(model.EmployeeProjectWorksMasterDTO);
        ...
        protected List<EmployeeProjectWorksMaster> GetEmployeeProjectWorksMasterDetails(int EmployeeID, string centreCode)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeProjectWorksMaster> baseEntityCollectionResponse = _EmployeeProjectWorksMasterServiceAccess.GetAppliedDetails(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult _EmployeeConsultancyMasterDetails(int EmployeeID)
        {
            ...
            IBaseEntityResponse<EmployeeConsultancyMaster> response = _EmployeeConsultancyMasterServiceAccess.SelectEmployeeCentreCode(model.EmployeeConsultancyMasterDTO);
            model.CentreCode = response.Entity != null ? response.Entity.CentreCode : string.Empty;
        ...
        protected List<EmployeeConsultancyMaster> GetEmployeeConsultancyMasterDetails(int EmployeeID, string CentreCode)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeConsultancyMaster> baseEntityCollectionResponse = _EmployeeConsultancyMasterServiceAccess.GetAppliedDetails(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<EmpEmployeeMaster> GetListEmpEmployeeMaster(string CentreCode, string DepartmentID)
        {
            ...
            IBaseEntityCollectionResponse<EmpEmployeeMaster> baseEntityCollectionResponse = _empEmployeeMasterServiceAcess.GetByCentreCodeAndDeptID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
