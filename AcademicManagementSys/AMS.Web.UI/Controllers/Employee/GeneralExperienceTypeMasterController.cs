...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralExperienceTypeMasterServiceAccess _GeneralExperienceTypeMasterServiceAcess = null;
        ...
        {
            _GeneralExperienceTypeMasterServiceAcess = new GeneralExperienceTypeMasterServiceAccess();
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralExperienceTypeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralExperienceTypeMaster> response = _GeneralExperienceTypeMasterServiceAcess.InsertGeneralExperienceTypeMaster(model.GeneralExperienceTypeMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralExperienceTypeMaster> response = _GeneralExperienceTypeMasterServiceAcess.SelectByID(model.GeneralExperienceTypeMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralExperienceTypeMasterDTO != null)
                {
                    if (model != null && model.GeneralExperienceTypeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralExperienceTypeMaster> response = _GeneralExperienceTypeMasterServiceAcess.UpdateGeneralExperienceTypeMaster(model.GeneralExperienceTypeMasterDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralExperienceTypeMasterViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        if (model.ID > 0)
        ...
        //            GeneralExperienceTypeMasterDTO.ID = model.ID;
        //            GeneralExperienceTypeMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<GeneralExperienceTypeMaster> response = _GeneralExperienceTypeMasterServiceAcess.DeleteGeneralExperienceTypeMaster(GeneralExperienceTypeMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                    ...
                    GeneralExperienceTypeMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralExperienceTypeMaster> response = _GeneralExperienceTypeMasterServiceAcess.DeleteGeneralExperienceTypeMaster(GeneralExperienceTypeMasterDTO);
                    model.GeneralExperienceTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralExperienceTypeMasterViewModel> GetGeneralExperienceTypeMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralExperienceTypeMaster> baseEntityCollectionResponse = _GeneralExperienceTypeMasterServiceAcess.GetBySearch(searchRequest);
