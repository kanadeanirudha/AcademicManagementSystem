...
namespace AMS.Web.UI.Controllers
{
    public class EmployeeExperienceController : BaseController
    {
        ...
        IGeneralExperienceTypeMasterServiceAccess _generalExperienceTypeMasterServiceAccess = null;
        ...
        public EmployeeExperienceController()
        {
             ...
             _generalExperienceTypeMasterServiceAccess = new GeneralExperienceTypeMasterServiceAccess();
        }
        ...
        public ActionResult EmployeeExperienceCreate(EmployeeExperienceViewModel EmployeeExperienceViewModel)
        {
            try
            {
                ...
                IBaseEntityResponse<EmployeeExperience> response = _EmployeeExperienceServiceAccess.InsertEmployeeExperience(EmployeeExperienceViewModel.EmployeeExperienceDTO);
                EmployeeExperienceViewModel.EmployeeExperienceDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult EmployeeExperienceEdit(int ID, string Mode)
        {
            ...
            IBaseEntityResponse<EmployeeExperience> response = _EmployeeExperienceServiceAccess.SelectByID(model.EmployeeExperienceDTO);
        ...
        public ActionResult EmployeeExperienceEdit(EmployeeExperienceViewModel EmployeeExperienceViewModel)
        {
            try
            {
                ...
                EmployeeExperienceViewModel.EmployeeExperienceDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmployeeExperience> response = _EmployeeExperienceServiceAccess.UpdateEmployeeExperience(EmployeeExperienceViewModel.EmployeeExperienceDTO);
                EmployeeExperienceViewModel.EmployeeExperienceDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(EmployeeExperienceViewModel.EmployeeExperienceDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
        ...
        protected List<GeneralExperienceTypeMaster> GetListGeneralExperienceTypeMaster()
        {
            ...
            IBaseEntityCollectionResponse<GeneralExperienceTypeMaster> baseEntityCollectionResponse = _generalExperienceTypeMasterServiceAccess.GetBySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
