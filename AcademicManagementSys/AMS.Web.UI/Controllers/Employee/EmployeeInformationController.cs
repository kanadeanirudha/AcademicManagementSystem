...
namespace AMS.Web.UI.Controllers
{
    public class EmployeeInformationController : BaseController
    {
        ...
        IEmployeeLanguageDetailsServiceAccess _employeeLanguageDetailsServiceAccess = null;
        IEmployeePictureDetailsServiceAccess _employeePictureDetailsServiceAccess = null;
        EmployeeServiceDetailsServiceAccess _employeeServiceDetailsServiceAcess = null;
        ...
        public EmployeeInformationController()
        {
            ...
            _employeePictureDetailsServiceAccess = new EmployeePictureDetailsServiceAccess();
            _employeeLanguageDetailsServiceAccess = new EmployeeLanguageDetailsServiceAccess();
            _employeeServiceDetailsServiceAcess = new EmployeeServiceDetailsServiceAccess();
        }
        ...
        public ActionResult Profile(int ID)
        {
            try
            {
                ...
                //IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.SelectByID(empEmployeeMastermodel.EmpEmployeeMasterDTO);
        ...
        public ActionResult AddEmployee(string CentreCode, string CentreName)
        {
            try
            {
                ...
                empEmployeeMastermodel.DepartmentID = Convert.ToInt32(splitedCentreCode[2]);
        ...
        public ActionResult AddEmployee(EmpEmployeeMasterViewModel empEmployeeMastermodel)
        {
            try
            {
                ...
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.InsertEmpEmployeeMaster(empEmployeeMastermodel.EmpEmployeeMasterDTO);
                empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult _EmployeePictureDetails(int EmployeeID)
        {
            try
            {
                ...
                employeePictureDetailsViewModel.EmployeePictureDetailsDTO.EmployeeID = EmployeeID;
                IBaseEntityResponse<EmployeePictureDetails> response = _employeePictureDetailsServiceAccess.SelectByID(employeePictureDetailsViewModel.EmployeePictureDetailsDTO);
                ...
                return View("/Views/Shared/_EmployeePictureDetailsV2.cshtml", employeePictureDetailsViewModel);
                ...
                if (Request.Files["File"] != null)
                {
                    if (ModelState.IsValid)
                    {
                        ...
                        if (original != null)
                        {
                            ...
                            employeePictureDetailsViewModel.EmployeePictureDetailsDTO.ConnectionString = _connectioString;
                            IBaseEntityResponse<EmployeePictureDetails> response = _employeePictureDetailsServiceAccess.InsertEmployeePictureDetails(employeePictureDetailsViewModel.EmployeePictureDetailsDTO);
        ...
        public ActionResult PersonalInformationHome(int ID)
        {
            try
            {
                ...
                //empEmployeeMastermodel.SSNNumber = response.Entity.SSNNumber.TrimEnd();
                ...
                if (Convert.ToString(Session["UserType"]) == "A" || Convert.ToInt32(Session["EstMgr"]) > 0)
                {
        ...
        public ActionResult PersonalInformationHome(EmpEmployeeMasterViewModel empEmployeeMastermodel)
        {
            try
            {
                ...
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.UpdateEmpEmployeeMasterPersonalInformation(empEmployeeMastermodel.EmpEmployeeMasterDTO);
                empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult EmployeeOfficeDetails(EmpEmployeeMasterViewModel empEmployeeMastermodel)
        {
            try
            {
                ...
                li_EmpEmployeeMaster_PaymentMode.Add(new SelectListItem { Text = Resources.ddlHeaders_SelectPaymentMode, });
                li_EmpEmployeeMaster_PaymentMode.Add(new SelectListItem { Text = Resources.DisplayName_DailyBasis, Value = "D" });
                li_EmpEmployeeMaster_PaymentMode.Add(new SelectListItem { Text = Resources.DisplayName_Fixed_Consolidated, Value = "C" });
                li_EmpEmployeeMaster_PaymentMode.Add(new SelectListItem { Text = Resources.DisplayName_PeriodBasis, Value = "P" });
                li_EmpEmployeeMaster_PaymentMode.Add(new SelectListItem { Text = Resources.DisplayName_Structure, Value = "S" });
        ...
        public ActionResult UpdateEmployeeOfficeDetails(EmpEmployeeMasterViewModel empEmployeeMastermodel)
        {
            try
            {
                ...
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ID = empEmployeeMastermodel.ID;
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.UpdateEmpEmployeeMasterOfficeDetails(empEmployeeMastermodel.EmpEmployeeMasterDTO);
                empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
        ...
        public ActionResult EmployeeServiceDetailsCreate(int EmployeeID)
        {
            ...
            try
            {
                ...
                li_EmpolyeeServiceDetail_YesNo.Add(new SelectListItem { Text = Resources.DisplayName_No, Value = "N" });
                li_EmpolyeeServiceDetail_YesNo.Add(new SelectListItem { Text = Resources.DisplayName_Yes, Value = "Y" });
                ...
                li_EmpolyeeServiceDetail_PromotionDemotionFlag.Add(new SelectListItem { Text = Resources.DisplayName_Promotion, Value = "P" });
                li_EmpolyeeServiceDetail_PromotionDemotionFlag.Add(new SelectListItem { Text = Resources.DisplayName_Demotion, Value = "D" });
                li_EmpolyeeServiceDetail_PromotionDemotionFlag.Add(new SelectListItem { Text = Resources.DisplayName_Transfer, Value = "T" });
                ...
                li_EmpolyeeServiceDetail_NatureOfAppoinment.Add(new SelectListItem { Text = Resources.DisplayName_VISITING, Value = "VISITING" });
                ...
                li_EmpolyeeServiceDetail_GrantedPromotionLevel.Add(new SelectListItem { Text = Resources.DisplayName_UNIVERSITYddl, Value = "UNIVERSITY" });
                li_EmpolyeeServiceDetail_GrantedPromotionLevel.Add(new SelectListItem { Text = Resources.DisplayName_INSTITUTE, Value = "INSTITUTE" });
                ...
                IBaseEntityResponse<EmployeeServiceDetails> response = _employeeServiceDetailsServiceAcess.SelectByEmployeeID(EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO);
        ...
        public ActionResult EmployeeServiceDetailsCreate(EmployeeServiceDetailsViewModel EmployeeServiceDetailsViewModel)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmployeeServiceDetails> response = _employeeServiceDetailsServiceAcess.InsertEmployeeServiceDetails(EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO);
                EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult EmployeeServiceDetailsInfo(int ID)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmployeeServiceDetails> response = _employeeServiceDetailsServiceAcess.SelectByID(EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO);
        ...
        public ActionResult EmployeeServiceDetailsEdit(EmployeeServiceDetailsViewModel EmployeeServiceDetailsViewModel)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmployeeServiceDetails> response = _employeeServiceDetailsServiceAcess.UpdateEmployeeServiceDetails(EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO);
                EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(EmployeeServiceDetailsViewModel.EmployeeServiceDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult EmpEmployeeLanguageDetails(int EmployeeID, string SelectedIDs)
        {
            ...
            try
            {
                ...
                employeeLanguageDetailsViewModel.EmployeeLanguageDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult _ChangePassword(int ID)
        {
            try
            {
                ...
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ID = ID;
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.GetCurrentPassword(empEmployeeMastermodel.EmpEmployeeMasterDTO);
        ...
        public ActionResult _ChangePassword(EmpEmployeeMasterViewModel empEmployeeMastermodel)
        {
            try
            {
                ...
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserId"]);
                empEmployeeMastermodel.EmpEmployeeMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.InsertNewPassword(empEmployeeMastermodel.EmpEmployeeMasterDTO);
                empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                return Json(empEmployeeMastermodel.EmpEmployeeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmpEmployeeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.InsertEmpEmployeeMaster(model.EmpEmployeeMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.SelectByID(model.EmpEmployeeMasterDTO);
                if (response != null && response.Entity != null)
                {
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.EmpEmployeeMasterDTO != null)
                {
                    if (model != null && model.EmpEmployeeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.UpdateEmpEmployeeMaster(model.EmpEmployeeMasterDTO);
        ...
        public ActionResult Delete(EmpEmployeeMasterViewModel model)
        {
            if (!ModelState.IsValid)
            {
                if (model.ID > 0)
                {
                    ...
                    IBaseEntityResponse<EmpEmployeeMaster> response = _empEmployeeMasterServiceAcess.DeleteEmpEmployeeMaster(EmpEmployeeMasterDTO);
        ...
        public IEnumerable<EmpEmployeeMasterViewModel> GetEmpEmployeeMaster(out int TotalRecords, string CentreCode, string EntityLevel, string AdminRoleMasterID)
        {
            ...
            IBaseEntityCollectionResponse<EmpEmployeeMaster> baseEntityCollectionResponse = _empEmployeeMasterServiceAcess.GetBySearch(searchRequest);
        ...
        public IEnumerable<EmployeeServiceDetailsViewModel> GetEmployeeServiceDetails(int EmployeeID, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeServiceDetails> baseEntityCollectionResponse = _employeeServiceDetailsServiceAcess.GetBySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<EmpEmployeeMaster> GetEmployeeList(string SearchKeyWord)
        {
            ...
            IBaseEntityCollectionResponse<EmpEmployeeMaster> baseEntityCollectionResponse = _empEmployeeMasterServiceAcess.GetEmployeeList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult AjaxHandlerEmployeeServiceDetails(JQueryDataTableParamModel param, int EmployeeID)
        {
            ...
            switch (Convert.ToInt32(sortColumnIndex))
            {
                case 0:
                    ...
                    {
                        _searchBy = "OrderNumber Like '%" + param.sSearch + "%' or DepartmentName Like '%" + param.sSearch + "%' or PromotionDemotionFlag Like '%" + param.sSearch + "%'";        //this "if" block is added for search functionality
                    }
                    break;
                case 1:
                    _sortBy = "DepartmentName";
                ...
                case 2:
                    ...
                    {
                        _searchBy = "OrderNumber Like '%" + param.sSearch + "%' or Fluency Like '%" + param.sSearch + "%' or PromotionDemotionFlag Like '%" + param.sSearch + "%'";      //this "if" block is added for search functionality
                    }
                    break;
