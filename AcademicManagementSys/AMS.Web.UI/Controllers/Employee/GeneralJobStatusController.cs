    ...
    public class GeneralJobStatusController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralJobStatusDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralJobStatus> response = _GeneralJobStatusServiceAccess.InsertGeneralJobStatus(model.GeneralJobStatusDTO);
        ...
        public ActionResult Edit(int ID)
        {
           GeneralJobStatusViewModel model = new GeneralJobStatusViewModel();
            ...
            IBaseEntityResponse<GeneralJobStatus> response = _GeneralJobStatusServiceAccess.SelectByID(model.GeneralJobStatusDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralJobStatusDTO != null)
                    {
                        if (model != null && model.GeneralJobStatusDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralJobStatus> response = _GeneralJobStatusServiceAccess.UpdateGeneralJobStatus(model.GeneralJobStatusDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralJobStatusViewModel model)
        //{
        //    try
        //    {
        ...
        //               GeneralJobStatusDTO.ID = model.ID;
        //               GeneralJobStatusDTO.DeletedBy = model.DeletedBy;
        //               model.GeneralJobStatusDTO.JobStatusDescription = model.JobStatusDescription;
        //               model.GeneralJobStatusDTO.JobStatusCode = model.JobStatusCode;
        //               model.GeneralJobStatusDTO.IsActive = model.IsActive;
        //               GeneralJobStatusDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //                IBaseEntityResponse<GeneralJobStatus> response = _GeneralJobStatusServiceAccess.DeleteGeneralJobStatus(GeneralJobStatusDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            try
            {
                ...
                if (ID > 0)
                {
                        ...
                        IBaseEntityResponse<GeneralJobStatus> response = _GeneralJobStatusServiceAccess.DeleteGeneralJobStatus(GeneralJobStatusDTO);
                        //model.GeneralJobStatusDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                        model.GeneralJobStatusDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralJobStatusViewModel> GetGeneralJobStatusDetails(out int TotalRecords)
        {
           GeneralJobStatusSearchRequest searchRequest = new GeneralJobStatusSearchRequest();
            ...
            IBaseEntityCollectionResponse<GeneralJobStatus> baseEntityCollectionResponse = _GeneralJobStatusServiceAccess.GetBySearch(searchRequest);
