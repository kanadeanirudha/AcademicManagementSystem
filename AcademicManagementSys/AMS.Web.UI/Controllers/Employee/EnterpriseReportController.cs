...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IEmployeeEnterpriseReportServiceAccess _employeeEnterpriseReportServiceAccess = null;       
        ...
        {
            _employeeEnterpriseReportServiceAccess = new EmployeeEnterpriseReportServiceAccess();            
        }
