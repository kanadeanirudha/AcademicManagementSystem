...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IEmployeeDependentsServiceAccess _employeeDependentsServiceAccess = null;
        IGeneralRelationshipTypeMasterServiceAccess _generalRelationshipTypeMasterServiceAccess=null;
        ...
        {
            _employeeDependentsServiceAccess = new EmployeeDependentsServiceAccess();
            _generalRelationshipTypeMasterServiceAccess = new GeneralRelationshipTypeMasterServiceAccess();
        }
        ...
        public ActionResult List(string actionMode, int EmployeeID)
        {
            try
            {
                ...
                return PartialView("~/Views/Employee/EmployeeDependents/List.cshtml", model);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeDependentsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeDependents> response = _employeeDependentsServiceAccess.InsertEmployeeDependents(model.EmployeeDependentsDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmployeeDependents> response = _employeeDependentsServiceAccess.SelectByID(model.EmployeeDependentsDTO);
                if (response != null && response.Entity != null)
                {
                    ...
                    //model.EmployeeDependentsDTO.WeddingAnniversaryDate = response.Entity.WeddingAnniversaryDate;
                ...
                ViewBag.GeneralRegionMaster = new SelectList(generalRegionMaster, "Value", "Text");
                ViewBag.GeneralCityMaster = new SelectList(GeneralCityMaster, "Value", "Text");
                return PartialView("/Views/Employee/EmployeeDependents/Edit.cshtml", model);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeDependentsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<EmployeeDependents> response = _employeeDependentsServiceAccess.UpdateEmployeeDependents(model.EmployeeDependentsDTO);
        ...
        //                IBaseEntityResponse<EmployeeDependents> response = _employeeDependentsServiceAccess.DeleteEmployeeDependents(EmployeeDependentsDTO);
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                if (ID > 0)
                {
                        ...
                        EmployeeDependentsDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<EmployeeDependents> response = _employeeDependentsServiceAccess.DeleteEmployeeDependents(EmployeeDependentsDTO);
                        model.EmployeeDependentsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<EmployeeDependentsViewModel> GetEmployeeDependents( int EmployeeID, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeDependents> baseEntityCollectionResponse = _employeeDependentsServiceAccess.GetBySearch(searchRequest);
        ...
        protected List<GeneralRelationshipTypeMaster> GetListGeneralRelationshipTypeMaster()
        {
            ...
            IBaseEntityCollectionResponse<GeneralRelationshipTypeMaster> baseEntityCollectionResponse = _generalRelationshipTypeMasterServiceAccess.GetBySearchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
