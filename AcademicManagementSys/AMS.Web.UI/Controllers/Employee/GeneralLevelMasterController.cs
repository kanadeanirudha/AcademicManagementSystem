...
namespace AMS.Web.UI.Controllers
{
    public class GeneralLevelMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralLevelMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralLevelMaster> response = _GeneralLevelMasterServiceAccess.InsertGeneralLevelMaster(model.GeneralLevelMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralLevelMaster> response = _GeneralLevelMasterServiceAccess.SelectByID(model.GeneralLevelMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralLevelMasterDTO != null)
                    {
                        if (model != null && model.GeneralLevelMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralLevelMaster> response = _GeneralLevelMasterServiceAccess.UpdateGeneralLevelMaster(model.GeneralLevelMasterDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralLevelMasterViewModel model)
        //{
        //    try
        //    {
        ...
        //                GeneralLevelMasterDTO.ID = model.ID;
        //                GeneralLevelMasterDTO.DeletedBy = model.DeletedBy;
        //                GeneralLevelMasterDTO.Description = model.Description;
        //                GeneralLevelMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //                IBaseEntityResponse<GeneralLevelMaster> response = _GeneralLevelMasterServiceAccess.DeleteGeneralLevelMaster(GeneralLevelMasterDTO);
            ...
            try
            {
                ...
                if (ID > 0)
                {
                    if (model != null && model.GeneralLevelMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralLevelMaster> response = _GeneralLevelMasterServiceAccess.DeleteGeneralLevelMaster(GeneralLevelMasterDTO);
                        //model.GeneralLevelMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                        model.GeneralLevelMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.GeneralLevelMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<GeneralLevelMasterViewModel> GetGeneralLevelMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralLevelMaster> baseEntityCollectionResponse = _GeneralLevelMasterServiceAccess.GetBySearch(searchRequest);
