...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IEmployeePersonalDetailsServiceAccess _employeePersonalDetailsServiceAcess = null;
        IGeneralLocationMasterServiceAccess _generalLocationMasterServiceAccess = null;
        IEmployeeContactDetailsServiceAccess _employeeContactDetailsServiceAccess = null;
        ...
        {
            _employeePersonalDetailsServiceAcess = new EmployeePersonalDetailsServiceAccess();
            _generalLocationMasterServiceAccess = new GeneralLocationMasterServiceAccess();
            _employeeContactDetailsServiceAccess = new EmployeeContactDetailsServiceAccess();
        }
        ...
        //    li_EmployeeContactDetails_AddressType.Add(new SelectListItem { Text = "-- Select-- ", });
            li_EmployeeContactDetails_AddressType.Add(new SelectListItem { Text = Resources.DisplayName_CORRESPONDENCE, Value = "CORRESPONDENCE" });
          ...
          {           
            try
            {
                ...
                IBaseEntityResponse<EmployeeContactDetails> response = _employeeContactDetailsServiceAccess.InsertEmployeeContactDetails(employeeContactDetailsViewModel.EmployeeContactDetailsDTO);
                employeeContactDetailsViewModel.EmployeeContactDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
          ...
          public ActionResult EmployeeContactDetailsEdit(int ID, string Mode)
          {
            ...
            //  ViewBag.EmployeeContactDetails_AddressType = new SelectList(li_EmployeeContactDetails_AddressType, "Value", "Text");
              ...
              IBaseEntityResponse<EmployeeContactDetails> response = _employeeContactDetailsServiceAccess.SelectByID(model.EmployeeContactDetailsDTO);
         ...
         [HttpPost]
          ...
          {           
            try
            {
                ...
                employeeContactDetailsViewModel.EmployeeContactDetailsDTO.ID = employeeContactDetailsViewModel.ID;
                employeeContactDetailsViewModel.EmployeeContactDetailsDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<EmployeeContactDetails> response = _employeeContactDetailsServiceAccess.UpdateEmployeeContactDetails(employeeContactDetailsViewModel.EmployeeContactDetailsDTO);
                employeeContactDetailsViewModel.EmployeeContactDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                return Json(employeeContactDetailsViewModel.EmployeeContactDetailsDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        protected List<GeneralLocationMaster> GetListGeneralLocationMaster(string CityID)
        {
            ...
            IBaseEntityCollectionResponse<GeneralLocationMaster> baseEntityCollectionResponse = _generalLocationMasterServiceAccess.GetByCityID(searchRequest);
        ...
        public IEnumerable<EmployeeContactDetailsViewModel> GetEmployeeContactDetails(int EmployeeID, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<EmployeeContactDetails> baseEntityCollectionResponse = _employeeContactDetailsServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
