...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IEmployeeShiftApplicableMasterServiceAccess _employeeShiftApplicableMasterServiceAccess = null;
        ...
        {
            _employeeShiftApplicableMasterServiceAccess = new EmployeeShiftApplicableMasterServiceAccess();
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                    {
                        if (model != null && model.EmployeeShiftApplicableMasterDTO != null)
                        {
                            ...
                            model.EmployeeShiftApplicableMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }
                    return Json(model.EmployeeShiftApplicableMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
