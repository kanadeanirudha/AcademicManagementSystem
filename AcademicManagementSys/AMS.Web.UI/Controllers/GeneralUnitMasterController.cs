...
namespace AMS.Web.UI.Controllers
{
    public class GeneralUnitMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralUnitMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralUnitMaster> response = _GeneralUnitMasterServiceAccess.InsertGeneralUnitMaster(model.GeneralUnitMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralUnitMaster> response = _GeneralUnitMasterServiceAccess.SelectByID(model.GeneralUnitMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralUnitMasterDTO != null)
                    {
                        if (model != null && model.GeneralUnitMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralUnitMaster> response = _GeneralUnitMasterServiceAccess.UpdateGeneralUnitMaster(model.GeneralUnitMasterDTO);
            ...
            try
            {
                ...
                if (model.ID > 0)
                {
                    if (model != null && model.GeneralUnitMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralUnitMaster> response = _GeneralUnitMasterServiceAccess.DeleteGeneralUnitMaster(GeneralUnitMasterDTO);
        ...
        public IEnumerable<GeneralUnitMasterViewModel> GetGeneralUnitMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralUnitMaster> baseEntityCollectionResponse = _GeneralUnitMasterServiceAccess.GetBySearch(searchRequest);
