...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IInventoryLocationMasterServiceAccess _InventoryLocationMasterServiceAcess = null;
        ...
        {
            _InventoryLocationMasterServiceAcess = new InventoryLocationMasterServiceAccess();
        }
            ...
            try
            {
                    ...
                    if (model != null && model.InventoryLocationMasterDTO != null)
                    {
                       ...
                       // model.InventoryLocationMasterDTO.AccBalanceSheetID = model.AccBalanceSheetID;
                        ...
                        IBaseEntityResponse<InventoryLocationMaster> response = _InventoryLocationMasterServiceAcess.InsertInventoryLocationMaster(model.InventoryLocationMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            {                
                ...
                IBaseEntityResponse<InventoryLocationMaster> response = _InventoryLocationMasterServiceAcess.SelectByID(model.InventoryLocationMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.InventoryLocationMasterDTO != null)
                {
                    if (model != null && model.InventoryLocationMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<InventoryLocationMaster> response = _InventoryLocationMasterServiceAcess.UpdateInventoryLocationMaster(model.InventoryLocationMasterDTO);
        ...
        public ActionResult Delete(InventoryLocationMasterViewModel model)
        {
            if (!ModelState.IsValid)
            {
                if (model.ID > 0)
                {
                    ...
                    IBaseEntityResponse<InventoryLocationMaster> response = _InventoryLocationMasterServiceAcess.DeleteInventoryLocationMaster(InventoryLocationMasterDTO);
        ...
        public IEnumerable<InventoryLocationMaster> GetInventoryLocationMaster(string centreCode, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<InventoryLocationMaster> baseEntityCollectionResponse = _InventoryLocationMasterServiceAcess.GetBySearch(searchRequest);
            ...
            if (Session["UserType"] != null)
            {
                ...
                switch (Convert.ToInt32(sortColumnIndex))
                {
                    case 0:
                        ...
                        {
                            _searchBy = "LocationName Like '%" + param.sSearch + "%' or LocationName Like '%" + param.sSearch + "%'";        //this "if" block is added for search functionality
                        }
                        break;
                    //case 1:
