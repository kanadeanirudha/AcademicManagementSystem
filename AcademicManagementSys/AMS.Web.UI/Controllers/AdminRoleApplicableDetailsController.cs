    ...
    public class AdminRoleApplicableDetailsController : BaseController
    {
        ...
        public ActionResult List(string centerCode, string departmentID, string actionMode)
        {
            try
            {
                ...
                return PartialView("List", _adminRoleApplicableDetailsBaseViewModel);
        ...
        public ActionResult Create(string ID, string CentreCode, string CentreName, string DepartmentID, string DepartmentName, string EmployeeID, string DesignationID, string EmployeeName, string RoleApplicableID)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(RoleApplicableID) == 0)
                {
                    ...
                    IBaseEntityResponse<AdminRoleApplicableDetails> response = _adminRoleApplicableDetailsServiceAcess.SelectActiveAdminRoleCodeByEmployeeID(model.AdminRoleApplicableDetailsDTO);
                ...
                else
                {
                    ...
                    IBaseEntityResponse<AdminRoleApplicableDetails> response = _adminRoleApplicableDetailsServiceAcess.SelectByID(model.AdminRoleApplicableDetailsDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AdminRoleApplicableDetailsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AdminRoleApplicableDetails> response = _adminRoleApplicableDetailsServiceAcess.InsertAdminRoleApplicableDetails(model.AdminRoleApplicableDetailsDTO);
                        model.AdminRoleApplicableDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public IEnumerable<AdminRoleApplicableDetailsViewModel> GetAdminRoleApplicableDetails(string centerCode, int departmentId, out int TotalRecords)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleApplicableDetails> baseEntityCollectionResponse = _adminRoleApplicableDetailsServiceAcess.GetBySearch(searchRequest);
        ...
        public List<AdminRoleApplicableDetailsViewModel> GetAdminRegularRoleList(int AdminRoleMasterID, string CentreCode, int DepartmentID)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleApplicableDetails> baseEntityCollectionResponse = _adminRoleApplicableDetailsServiceAcess.GetAdminRegularListBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        public List<AdminRoleApplicableDetailsViewModel> GetAdminAddtionalRoleList(string centerCode, int DepartmentID, int EmployeeID, out int TotalRecords)
        {
            try
            {
                ...
                List<AdminRoleApplicableDetailsViewModel> listAdminRoleApplicableDetailsViewModel = new List<AdminRoleApplicableDetailsViewModel>();
                List<AdminRoleApplicableDetails> listAdminRoleApplicableDetails = new List<AdminRoleApplicableDetails>();
                IBaseEntityCollectionResponse<AdminRoleApplicableDetails> baseEntityCollectionResponse = _adminRoleApplicableDetailsServiceAcess.GetAdminAdditionalListBySearch(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
