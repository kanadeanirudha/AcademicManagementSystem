...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IAccountHeadMasterServiceAccess _AccountHeadMasterServiceAcess = null;
        ...
        {
            _AccountHeadMasterServiceAcess = new AccountHeadMasterServiceAccess();
        }
        ...
        public ActionResult Index()
        {
            ...
            return View("/Views/AccountHeadMaster/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/AccountHeadMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("/Views/AccountHeadMaster/Create.cshtml", model);
        }
        ...
        public ActionResult Create(AccountHeadMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.AccountHeadMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<AccountHeadMaster> response = _AccountHeadMasterServiceAcess.InsertAccountHeadMaster(model.AccountHeadMasterDTO);

                    model.AccountHeadMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.AccountHeadMasterDTO != null)
                {
                    if (model != null && model.AccountHeadMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AccountHeadMaster> response = _AccountHeadMasterServiceAcess.UpdateAccountHeadMaster(model.AccountHeadMasterDTO);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
               ...
               // model.AccountHeadMasterDTO.AccountHeadMasterID = id;
                ...
                IBaseEntityResponse<AccountHeadMaster> response = _AccountHeadMasterServiceAcess.SelectByID(model.AccountHeadMasterDTO);
                ...
                return PartialView("/Views/AccountHeadMaster/Edit.cshtml", model);
            }
            catch (Exception)
            {
                throw;
        ...
        //        AccountHeadMasterViewModel model = new AccountHeadMasterViewModel();
        //        model.AccountHeadMasterDTO = new AccountHeadMaster();
        //        model.AccountHeadMasterDTO.ID = Convert.ToInt16(ID);
        //        model.AccountHeadMasterDTO.ConnectionString = _connectioString;

        //        IBaseEntityResponse<AccountHeadMaster> response = _AccountHeadMasterServiceAcess.SelectByID(model.AccountHeadMasterDTO);
        //        if (response != null && response.Entity != null)
        //        {
        //            model.AccountHeadMasterDTO.GroupDescription = response.Entity.GroupDescription;
        //            model.AccountHeadMasterDTO.MarchandiseGroupCode = response.Entity.MarchandiseGroupCode;
        //        }
        ...
        //        ViewData["GroupCode"] = new SelectList(GroupCode_li, "Value", "Text", model.AccountHeadMasterDTO.GroupCode);
        ...
        //        //    }
        //        //    ViewBag.GeneralServiceMasterList = new SelectList(GeneralServiceMasterList, "Value", "Text", model.AccountHeadMasterDTO.GenServiceRequiredID);

        //        return PartialView("/Views/AccountHeadMaster/ViewDetails.cshtml", model);
        //    }
        //    catch (Exception ex)
        //    {
        //        _logException.Error(ex.Message);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _AccountHeadMasterServiceAcess.DeleteAccountHeadMaster(AccountHeadMasterDTO);
        ...
        public IEnumerable<AccountHeadMasterViewModel> GetAccountHeadMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountHeadMaster> baseEntityCollectionResponse = _AccountHeadMasterServiceAcess.GetBySearch(searchRequest);
