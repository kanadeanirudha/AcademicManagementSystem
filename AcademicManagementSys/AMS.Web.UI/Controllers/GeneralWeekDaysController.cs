...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralWeekDaysServiceAccess _GeneralWeekDaysServiceAccess = null;
        ...
        {
            _GeneralWeekDaysServiceAccess = new GeneralWeekDaysServiceAccess();
        }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralWeekDaysDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralWeekDays> response = _GeneralWeekDaysServiceAccess.InsertGeneralWeekDays(model.GeneralWeekDaysDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralWeekDays> response = _GeneralWeekDaysServiceAccess.SelectByID(model.GeneralWeekDaysDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralWeekDaysDTO != null)
                    {
                        if (model != null && model.GeneralWeekDaysDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralWeekDays> response = _GeneralWeekDaysServiceAccess.UpdateGeneralWeekDays(model.GeneralWeekDaysDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralWeekDaysViewModel model)
        //{
        //    try
        //    {
        ...
        //                GeneralWeekDaysDTO.ID = model.ID;
        //                GeneralWeekDaysDTO.DeletedBy = model.DeletedBy;
        ...
        //                IBaseEntityResponse<GeneralWeekDays> response = _GeneralWeekDaysServiceAccess.DeleteGeneralWeekDays(GeneralWeekDaysDTO);
            ...
            try
            {
                ...
                if (ID > 0)
                {
                    if (model != null && model.GeneralWeekDaysDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralWeekDays> response = _GeneralWeekDaysServiceAccess.DeleteGeneralWeekDays(GeneralWeekDaysDTO);
                        //model.GeneralWeekDaysDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                        model.GeneralWeekDaysDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.GeneralWeekDaysDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<GeneralWeekDaysViewModel> GetGeneralWeekDaysDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralWeekDays> baseEntityCollectionResponse = _GeneralWeekDaysServiceAccess.GetBySearch(searchRequest);
