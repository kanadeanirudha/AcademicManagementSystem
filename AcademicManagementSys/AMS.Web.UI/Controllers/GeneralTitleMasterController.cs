...
namespace AMS.Web.UI.Controllers
{
    public class GeneralTitleMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralTitleMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralTitleMaster> response = _GeneralTitleMasterServiceAccess.InsertGeneralTitleMaster(model.GeneralTitleMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralTitleMaster> response = _GeneralTitleMasterServiceAccess.SelectByID(model.GeneralTitleMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralTitleMasterDTO != null)
                    {
                        if (model != null && model.GeneralTitleMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralTitleMaster> response = _GeneralTitleMasterServiceAccess.UpdateGeneralTitleMaster(model.GeneralTitleMasterDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralTitleMasterViewModel model)
        //{
        //    try
        //    {
        ...
        //                GeneralTitleMasterDTO.ID = model.ID;
        //                GeneralTitleMasterDTO.DeletedBy = model.DeletedBy;
        //                GeneralTitleMasterDTO.Description = model.Description;
        //                GeneralTitleMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //                IBaseEntityResponse<GeneralTitleMaster> response = _GeneralTitleMasterServiceAccess.DeleteGeneralTitleMaster(GeneralTitleMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            try
            {
                ...
                if (ID > 0)
                {
                        ...
                        GeneralTitleMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<GeneralTitleMaster> response = _GeneralTitleMasterServiceAccess.DeleteGeneralTitleMaster(GeneralTitleMasterDTO);
                        model.GeneralTitleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralTitleMasterViewModel> GetGeneralTitleMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralTitleMaster> baseEntityCollectionResponse = _GeneralTitleMasterServiceAccess.GetBySearch(searchRequest);
