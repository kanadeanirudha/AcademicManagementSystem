    ...
    public class AccountMasterController : BaseController
    {
        ...
        public ActionResult Create(AccountMasterViewModel model)
        {
            try
            {
                if (model != null && model.AccountMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<AccountMaster> response = _accountMasterServiceAccess.InsertAccountMaster(model.AccountMasterDTO);
                    model.AccountMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(Int16 ID, string GroupDesc)
        {
            try
            {
                ...
                model.AccountMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<AccountMaster> response = _accountMasterServiceAccess.SelectByID(model.AccountMasterDTO);
        ...
        public ActionResult Edit(AccountMasterViewModel model)
        {
            try
            {
                if (model != null && model.AccountMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<AccountMaster> response = _accountMasterServiceAccess.UpdateAccountMaster(model.AccountMasterDTO);
                    model.AccountMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    return Json(model.AccountMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
                {
        ...
        protected List<AccountBalancesheetMaster> GetBalsheetMasterList(int accountId,int RoleID)
        {
            ...
            IBaseEntityCollectionResponse<AccountBalancesheetMaster> baseEntityCollectionResponse = _accountBalancesheetMasterServiceAccess.GetBalancesheetForMultipleSelectList(searchRequest);
        ...
        protected List<AccountMaster> GetSurplusDeficitList()
        {
            ...
            IBaseEntityCollectionResponse<AccountMaster> baseEntityCollectionResponse = _accountMasterServiceAccess.GetSurplusDeficitList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<AccountMaster> GetAlternateGroupList(int groupID)  
        {
            ...
            List<AccountMaster> listAccountMaster = new List<AccountMaster>();
            IBaseEntityCollectionResponse<AccountMaster> baseEntityCollectionResponse = _accountMasterServiceAccess.GetAlternateGroupList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public List<AccountMaster> GetListAccountMaster(int SelectedBalanceSheet, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountMaster> baseEntityCollectionResponse = _accountMasterServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, int SelectedBalanceSheet)
        {
            ...
            switch (Convert.ToInt32(sortColumnIndex))
            {
                case 0:
                    ...
                    {
                        _searchBy = "GroupDescription Like '%" + param.sSearch + "%' or AccountCode Like '%" + param.sSearch + "%'  or CentreCode Like '%" + param.sSearch + "%'  or AccountName Like '%" + param.sSearch + "%' or AccBalsheetHeadDesc Like '%" + param.sSearch + "%' or BankAccountNumber Like '%" + param.sSearch + "%'";         //this "if" block is added for search functionality
                    }
                    break;
                case 1:
                    _sortBy = "AccountCode";
