...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralNationalityMasterServiceAccess __genNationalityMasterServiceAcess = null;
        ...
        {
            __genNationalityMasterServiceAcess = new GeneralNationalityMasterServiceAccess();
        }
           ...
           try
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralNationalityMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralNationalityMaster> response = __genNationalityMasterServiceAcess.InsertGeneralNationalityMaster(model.GeneralNationalityMasterDTO);
                    model.GeneralNationalityMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralNationalityMaster> response = __genNationalityMasterServiceAcess.SelectByID(model.GeneralNationalityMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralNationalityMasterDTO != null)
                {
                    if (model != null && model.GeneralNationalityMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralNationalityMaster> response = __genNationalityMasterServiceAcess.UpdateGeneralNationalityMaster(model.GeneralNationalityMasterDTO);
                        model.GeneralNationalityMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralNationalityMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralNationalityMasterViewModel model)
        //{
        //     try
        //    {
        ...
        //        GeneralNationalityMasterDTO.ID = model.ID;
        ...
        //        IBaseEntityResponse<GeneralNationalityMaster> response = __genNationalityMasterServiceAcess.DeleteGeneralNationalityMaster(GeneralNationalityMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            try
            {
                ...
                if (ID > 0)
                {
                        ...
                        GeneralNationalityMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<GeneralNationalityMaster> response = __genNationalityMasterServiceAcess.DeleteGeneralNationalityMaster(GeneralNationalityMasterDTO);
                        model.GeneralNationalityMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralNationalityMasterViewModel> GetGeneralNationalityMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralNationalityMaster> baseEntityCollectionResponse = __genNationalityMasterServiceAcess.GetBySearch(searchRequest);
