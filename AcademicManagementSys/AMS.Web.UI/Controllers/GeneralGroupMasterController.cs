...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralGroupMasterServiceAccess _GeneralGroupMasterServiceAccess = null;
        ...
        {
            _GeneralGroupMasterServiceAccess = new GeneralGroupMasterServiceAccess();
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralGroupMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.InsertGeneralGroupMaster(model.GeneralGroupMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.SelectByID(model.GeneralGroupMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralGroupMasterDTO != null)
                    {
                        if (model != null && model.GeneralGroupMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.UpdateGeneralGroupMaster(model.GeneralGroupMasterDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralGroupMasterDTO != null)
                    {
                        ...
                        model.GeneralGroupMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]); ;
                        IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.InsertGroupDetails(model.GeneralGroupMasterDTO);
                        model.GeneralGroupMasterDTO.ErrorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
                    return Json(model.GeneralGroupMasterDTO.ErrorMessage, JsonRequestBehavior.AllowGet);
                }
        ...
        public ActionResult DropdownList(int ID, int DependentObjectID, string EmployeeGroupDetailsID, string mode)
        {
            ...
            IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.SelectEmployeeGroupDetailsByID(model.GeneralGroupMasterDTO);
            ...
            ViewBag.mode = mode;
            return View("/Views/GeneralGroupMaster/DropdownList.cshtml", model);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralGroupMasterDTO != null)
                    {
                        ...
                        model.GeneralGroupMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]); ;
                        IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.UpdateGroupDetails(model.GeneralGroupMasterDTO);
                        model.GeneralGroupMasterDTO.ErrorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                    return Json(model.GeneralGroupMasterDTO.ErrorMessage, JsonRequestBehavior.AllowGet);
                }
            ...
            try
            {
                ...
                if (model.ID > 0)
                {
                    if (model != null && model.GeneralGroupMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralGroupMaster> response = _GeneralGroupMasterServiceAccess.DeleteGeneralGroupMaster(GeneralGroupMasterDTO);
        ...
        public IEnumerable<GeneralGroupMasterViewModel> GetGeneralGroupMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralGroupMaster> baseEntityCollectionResponse = _GeneralGroupMasterServiceAccess.GetBySearch(searchRequest);
        ...
        public IEnumerable<GeneralGroupMasterViewModel> GetEmployeeGroupDetails(out int TotalRecords, string GroupID, string GroupDependentObject)
        {
            ...
            IBaseEntityCollectionResponse<GeneralGroupMaster> baseEntityCollectionResponse = _GeneralGroupMasterServiceAccess.EmployeeGroupDetailsGetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
