...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralEducationTypeMasterServiceAccess _generalCategoryMasterServiceAcess = null;
        ...
        {
            _generalCategoryMasterServiceAcess = new GeneralEducationTypeMasterServiceAccess();
        }
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralEducationTypeMasterDTO != null)
                {
                  ...
                  //  model.GeneralEducationTypeMasterDTO.EduSequenceNumber = model.EduSequenceNumber;
                    ...
                    IBaseEntityResponse<GeneralEducationTypeMaster> response = _generalCategoryMasterServiceAcess.InsertGeneralEducationTypeMaster(model.GeneralEducationTypeMasterDTO);
                    model.GeneralEducationTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            IBaseEntityResponse<GeneralEducationTypeMaster> response = _generalCategoryMasterServiceAcess.SelectByID(model.GeneralEducationTypeMasterDTO);
                ...
                if (model != null && model.GeneralEducationTypeMasterDTO != null)
                {
                    if (model != null && model.GeneralEducationTypeMasterDTO != null)
                    {
                       ...
                       // model.GeneralEducationTypeMasterDTO.EduSequenceNumber = model.EduSequenceNumber;
                        ...
                        IBaseEntityResponse<GeneralEducationTypeMaster> response = _generalCategoryMasterServiceAcess.UpdateGeneralEducationTypeMaster(model.GeneralEducationTypeMasterDTO);
                        model.GeneralEducationTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralEducationTypeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralEducationTypeMasterViewModel model)
        //{
        //     try
        //    {
        //    if (!ModelState.IsValid)
        ...
        //            generalEducationTypeMasterDTO.ID = model.ID;
        //            generalEducationTypeMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<GeneralEducationTypeMaster> response = _generalCategoryMasterServiceAcess.DeleteGeneralEducationTypeMaster(generalEducationTypeMasterDTO);
            ...
            try
            {
                ...
                //{
                    if (ID > 0)
                    {
                        ...
                        generalEducationTypeMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<GeneralEducationTypeMaster> response = _generalCategoryMasterServiceAcess.DeleteGeneralEducationTypeMaster(generalEducationTypeMasterDTO);
                        model.GeneralEducationTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.GeneralEducationTypeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                //}
                //else
        ...
        public IEnumerable<GeneralEducationTypeMasterViewModel> GetGeneralEducationTypeMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralEducationTypeMaster> baseEntityCollectionResponse = _generalCategoryMasterServiceAcess.GetBySearch(searchRequest);
