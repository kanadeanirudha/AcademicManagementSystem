...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralUnitTypeServiceAccess _GeneralUnitTypeServiceAcess = null;
        ...
        {
            _GeneralUnitTypeServiceAcess = new GeneralUnitTypeServiceAccess();
        }
        ...
        public ActionResult Index()
        {
           ...
           return View("/Views/GeneralUnitType/Index.cshtml");
        ...
        public ActionResult List(string actionMode)
        {
            try
            {
                ...
                return PartialView("/Views/GeneralUnitType/List.cshtml", model);
            }
            catch (Exception ex)
            {
       ...
       //     li_RelatedWith.Add(new SelectListItem { Text = " ", Value = " " });
            ...
            return PartialView("/Views/GeneralUnitType/Create.cshtml",model);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralUnitTypeDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralUnitType> response = _GeneralUnitTypeServiceAcess.InsertGeneralUnitType(model.GeneralUnitTypeDTO);
                     
                        model.GeneralUnitTypeDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralUnitType> response = _GeneralUnitTypeServiceAcess.SelectByID(model.GeneralUnitTypeDTO);
                ...
                if (model != null && model.GeneralUnitTypeDTO != null)
                {
                    if (model != null && model.GeneralUnitTypeDTO != null)
                    {
                       ...
                       // model.GeneralUnitTypeDTO.SeqNo = model.SeqNo;
                        ...
                        IBaseEntityResponse<GeneralUnitType> response = _GeneralUnitTypeServiceAcess.UpdateGeneralUnitType(model.GeneralUnitTypeDTO);
        ...
        public ActionResult ViewDetails(string ID)
        {
            try
            {
                ...
                //    ViewBag.GeneralServiceMasterList = new SelectList(GeneralServiceMasterList, "Value", "Text", model.GeneralUnitTypeDTO.GenServiceRequiredID);
                  ...
                  return PartialView("/Views/GeneralUnitType/ViewDetails.cshtml", model);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _GeneralUnitTypeServiceAcess.DeleteGeneralUnitType(GeneralUnitTypeDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralUnitTypeViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        if (model.ID > 0)
        ...
        //            GeneralUnitType GeneralUnitTypeDTO = new GeneralUnitType();
        //            GeneralUnitTypeDTO.ConnectionString = _connectioString;
        //            GeneralUnitTypeDTO.ID = model.ID;
        //            GeneralUnitTypeDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<GeneralUnitType> response = _GeneralUnitTypeServiceAcess.DeleteGeneralUnitType(GeneralUnitTypeDTO);
        //            model.GeneralUnitTypeDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
        ...
        public IEnumerable<GeneralUnitTypeViewModel> GetGeneralUnitType(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralUnitType> baseEntityCollectionResponse = _GeneralUnitTypeServiceAcess.GetBySearch(searchRequest);
