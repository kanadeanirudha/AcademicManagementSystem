...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IPurchaseReplenishmentServiceAccess _PurchaseReplenishmentServiceAccess = null;
        ...
        {
            _PurchaseReplenishmentServiceAccess = new PurchaseReplenishmentServiceAccess();
        ...
        public ActionResult ViewPurchaseReplenishment()
        {
            ...
            IBaseEntityCollectionResponse<PurchaseReplenishment> baseEntityCollectionResponse = _PurchaseReplenishmentServiceAccess.SelectByPurchaseGRNMasterID(searchRequest);
        ...
        public ActionResult Create(PurchaseReplenishmentViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    IBaseEntityResponse<PurchaseReplenishment> response = _PurchaseReplenishmentServiceAccess.InsertPurchaseReplenishment(model.PurchaseReplenishmentDTO);
                    //errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);

                    //return Json(errorMessage, JsonRequestBehavior.AllowGet);
                    model.PurchaseReplenishmentDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        protected List<PurchaseReplenishment> GetReplenishmentData(string GeneralUnitsID)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseReplenishment> baseEntityCollectionResponse = _PurchaseReplenishmentServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
