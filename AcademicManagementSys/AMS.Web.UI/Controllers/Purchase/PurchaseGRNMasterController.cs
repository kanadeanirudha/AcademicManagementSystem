...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IPurchaseGRNMasterServiceAccess _PurchaseGRNMasterServiceAcess = null;
        ...
        {
            _PurchaseGRNMasterServiceAcess = new PurchaseGRNMasterServiceAccess();
        ...
        public ActionResult Create(PurchaseGRNMasterViewModel model)
        {
            try
            {
                if (model != null && model.PurchaseGRNMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<PurchaseGRNMaster> response = _PurchaseGRNMasterServiceAcess.InsertPurchaseGRNMaster(model.PurchaseGRNMasterDTO);
                    ...
                    //model.PurchaseGRNMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                ...
                response = _PurchaseGRNMasterServiceAcess.DeletePurchaseGRNMaster(PurchaseGRNMasterDTO);
        ...
        public FileStreamResult Downloads(int id)
        {
            ...
            try
            {
                ...
                PurchasePDF = PurchasePDF + "<table><tr><td style='text-align:left;'><img src='" + Path.Combine(Server.MapPath("~") + "Content\\UploadedFiles\\Inventory_1\\Logo\\" + model.PurchaseGRNMasterListFromPO[0].LogoPath) + "' height='70' width='130'></td></tr></table>";
        ...
        // Non-Action Method
        #region Methods
        public IEnumerable<PurchaseGRNMasterViewModel> GetPurchaseGRNMaster(out int TotalRecords, Byte POStatus, int VendorID,int AdminRoleID)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseGRNMaster> baseEntityCollectionResponse = _PurchaseGRNMasterServiceAcess.GetBySearch(searchRequest);
        ...
        protected List<PurchaseGRNMaster> GetPurchaseOrderMasterListForGRN(int id)
        {
            ...
            searchRequest.ID = id;
            List<PurchaseGRNMaster> listPurchaseGRNMaster = new List<PurchaseGRNMaster>();
            IBaseEntityCollectionResponse<PurchaseGRNMaster> baseEntityCollectionResponse = _PurchaseGRNMasterServiceAcess.GetPurchaseOrderMasterListForGRN(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<PurchaseGRNMaster> GetPurchaseGrnMasterListForPDF(int PurchaseOrderMasterID)
        {
            ...
            List<PurchaseGRNMaster> listPurchaseGRNMaster = new List<PurchaseGRNMaster>();
            IBaseEntityCollectionResponse<PurchaseGRNMaster> baseEntityCollectionResponse = _PurchaseGRNMasterServiceAcess.GetPurchaseGrnMasterListForPDF(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<PurchaseGRNMaster> GetPurchaseGRNDetailsByID(int id, int PurchaseOrderMaster)
        {
            ...
            List<PurchaseGRNMaster> listPurchaseGRNMaster = new List<PurchaseGRNMaster>();
            IBaseEntityCollectionResponse<PurchaseGRNMaster> baseEntityCollectionResponse = _PurchaseGRNMasterServiceAcess.GetPurchaseGRNDetailsByID(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<PurchaseGRNMaster> GetBatchList(string term, int ItemNumber)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseGRNMaster> baseEntityCollectionResponse = _PurchaseGRNMasterServiceAcess.GetBatchList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        // AjaxHandler Method
        #region AjaxHandler
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, Byte POStatus, int VendorID, int AdminRoleID)
        {
            if (Session["UserType"] != null)
            {
                ...
                filteredCountryMaster = GetPurchaseGRNMaster(out TotalRecords, POStatus, VendorID, AdminRoleID);
