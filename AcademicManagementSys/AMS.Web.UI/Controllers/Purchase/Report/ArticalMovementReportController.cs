    ...
    public class ArticalReportMasterController : BaseController
    {
        ...
        public List<PurchaseReportMaster> GetPurchaseReportMaster(int Itemnumber, string CentreCode)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<PurchaseReportMaster> baseEntityCollectionResponse = _PurchaseReportMasterServiceAccess.GetArticalMovementReport(searchRequest);
