...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IPurchaseReturnServiceAccess _PurchaseReturnServiceAcess = null;
        ...
        {
            _PurchaseReturnServiceAcess = new PurchaseReturnServiceAccess();
        ...
        public ActionResult Create(PurchaseReturnViewModel model)
        {
            try
            {
                if (model != null && model.PurchaseReturnDTO != null)
                {
                    ...
                    IBaseEntityResponse<PurchaseReturn> response = _PurchaseReturnServiceAcess.InsertPurchaseReturn(model.PurchaseReturnDTO);
                    model.PurchaseReturnDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public JsonResult GetVendorSearchList(string SearchWord)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseReturn> baseEntityCollectionResponse = _PurchaseReturnServiceAcess.GetVendorSearchList(searchRequest);
        ...
        protected List<PurchaseReturn> GetPurchaseReturnList(int ID)
        {
            ...
            searchRequest.ID = ID;
            List<PurchaseReturn> listPurchaseReturn = new List<PurchaseReturn>();
            IBaseEntityCollectionResponse<PurchaseReturn> baseEntityCollectionResponse = _PurchaseReturnServiceAcess.GetPurchaseReturnDetailLists(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<PurchaseReturn> GetUoMCodeByForPurchasePriceList(string ItemNumber, string UoMCode, int PurchaseOrderMasterID)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseReturn> baseEntityCollectionResponse = _PurchaseReturnServiceAcess.GetUomWisePurchasePrice(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        public IEnumerable<PurchaseReturnViewModel> GetPurchaseReturn(out int TotalRecords, int VendorId, string TransactionDate, int LocationID)
        {
            ...
            List<PurchaseReturn> listPurchaseReturn = new List<PurchaseReturn>();
            IBaseEntityCollectionResponse<PurchaseReturn> baseEntityCollectionResponse = _PurchaseReturnServiceAcess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
