...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IPurchaseInvoiceServiceAccess _PurchaseInvoiceServiceAccess = null;
        ...
        {
            _PurchaseInvoiceServiceAccess = new PurchaseInvoiceServiceAccess();
        ...
        public ActionResult Create(int PurchaseGRNMasterID, string Vendor, string PurchaseOrderTypeDescription, int VendorID, Int16 PurchaseOrderType,int PurchaseOrderMasterID)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseInvoice> baseEntityCollectionResponse = _PurchaseInvoiceServiceAccess.SelectByPurchaseGRNMasterID(searchRequest);
        ...
        public ActionResult Create(PurchaseInvoiceViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    IBaseEntityResponse<PurchaseInvoice> response = _PurchaseInvoiceServiceAccess.InsertPurchaseInvoice(model.PurchaseInvoiceDTO);
                    //errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);



                    //return Json(errorMessage, JsonRequestBehavior.AllowGet);
                    model.PurchaseInvoiceDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
        ...
        public IEnumerable<PurchaseInvoiceViewModel> GetPurchaseInvoice(string PurchaseOrderType,int AdminRoleID,out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseInvoice> baseEntityCollectionResponse = _PurchaseInvoiceServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected List<PurchaseInvoice> GetRecordForPurchaseOrderPDF(int id)
        {
            ...
            searchRequest.ID = id;
            List<PurchaseInvoice> listPurchaseInvoice = new List<PurchaseInvoice>();
            IBaseEntityCollectionResponse<PurchaseInvoice> baseEntityCollectionResponse = _PurchaseInvoiceServiceAccess.GetRecordForPurchaseOrderPDF(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
