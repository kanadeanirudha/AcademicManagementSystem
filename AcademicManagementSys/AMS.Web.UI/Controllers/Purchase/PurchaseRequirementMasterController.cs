...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IPurchaseRequirementMasterServiceAccess _PurchaseRequirementMasterServiceAccess = null;
        ...
        {
            _PurchaseRequirementMasterServiceAccess = new PurchaseRequirementMasterServiceAccess();
        ...
        public ActionResult Create(PurchaseRequirementMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.PurchaseRequirementMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.InsertPurchaseRequirementMaster(model.PurchaseRequirementMasterDTO);
                    ...
                    {
                        model.PurchaseRequirementMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(int ID)
        {
            try
            {
                ...
                //      IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.SelectByID(model.PurchaseRequirementMasterDTO);
            ...
            try
            {
                ...
                if (model != null && model.PurchaseRequirementMasterDTO != null)
                {
                    if (model != null && model.PurchaseRequirementMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.UpdatePurchaseRequirementMaster(model.PurchaseRequirementMasterDTO);
                ...
                if (model != null && model.PurchaseRequirementMasterDTO != null)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.InsertPurchaseRequirementMasterByExcel(model.PurchaseRequirementMasterDTO);
                                if(response.Entity.ErrorCode == 10)
                                {
        ...
        public ActionResult PurchaseRequirementRequestApproval(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            ...
            model.InventoryPurchaseRequirementList = GetPurchaseRequirementRecord(PersonID, Convert.ToInt32(TNMID));
            ...
            return View("/Views/Purchase/PurchaseRequirementMaster/PurchaseRequirementRequestApproval.cshtml", model);
        }

        [HttpPost]
        public ActionResult PurchaseRequirementRequestApproval(PurchaseRequirementMasterViewModel model)
        {
            try
            {
                ...
                if (model != null && model.PurchaseRequirementMasterDTO != null)
                {
                    ...
                    model.PurchaseRequirementMasterDTO.CreatedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.InsertApprovedPurchaseRequirementRecord(model.PurchaseRequirementMasterDTO);
                    model.PurchaseRequirementMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    return Json(model.PurchaseRequirementMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
        ...
        [HttpGet]
        public ActionResult PurchaseRequirementRequestApprovalV2(int PersonID, string TNDID, string TNMID, string GTRDID1, string TaskCode, string StageSequenceNumber, string IsLast)
        {
            PurchaseRequirementMasterViewModel model = new PurchaseRequirementMasterViewModel();
            model.PersonID = Convert.ToInt32(PersonID);
            model.TaskNotificationDetailsID = Convert.ToInt32(TNDID);
        ...
        protected List<PurchaseRequirementMaster> GetPurchaseRequirementMasterList(int id)
        {
            ...
            IBaseEntityCollectionResponse<PurchaseRequirementMaster> baseEntityCollectionResponse = _PurchaseRequirementMasterServiceAccess.GetPurchaseRequirementMasterDetailList(searchRequest);
        ...
        [NonAction]
        protected List<PurchaseRequirementMaster> GetPurchaseRequirementRecord(int personId, int taskNotificationMasterID)
        {
            PurchaseRequirementMasterSearchRequest searchRequest = new PurchaseRequirementMasterSearchRequest();
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            ...
            IBaseEntityCollectionResponse<PurchaseRequirementMaster> baseEntityCollectionResponse = _PurchaseRequirementMasterServiceAccess.GetPurchaseRequirementForApproval(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
        ...
        protected string GetPurchaseRequirementNumber(string CentreCode, string Description, int FinancialYearID)
        {
            try
            {
                ...
                IBaseEntityResponse<GeneralRunningNumbersForAccount> response = _GeneralRunningNumbersForAccountServiceAccess.GetAutoGeneratedRequirementNumber(model.GeneralRunningNumbersForAccountDTO);
        ...
        [NonAction]
        protected List<InventoryLocationMaster_1> GetInventoryIssueLocationMasterList(int balancesheet)
        {
        ...
        public JsonResult CheckForBlockForProcurement(int ItemNumber, int StorageLocationID)
        {
            ...
            if (StorageLocationID >0 && ItemNumber > 0)
            {
                ...
                IBaseEntityResponse<PurchaseRequirementMaster> response = _PurchaseRequirementMasterServiceAccess.GetBlockForProcurementByLocationID(_PurchaseRequirementMaster);
                if (response != null && response.Entity != null)
                {
        ...
        protected IEnumerable<PurchaseRequirementMasterViewModel> GetPurchaseRequirement(string CentreCode, string EntityLevel, string AdminRoleMasterID, out int TotalRecords)
        {
            ...
            List<PurchaseRequirementMaster> listPurchaseRequirementMaster = new List<PurchaseRequirementMaster>();
            IBaseEntityCollectionResponse<PurchaseRequirementMaster> baseEntityCollectionResponse = _PurchaseRequirementMasterServiceAccess.GetBySearch(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
