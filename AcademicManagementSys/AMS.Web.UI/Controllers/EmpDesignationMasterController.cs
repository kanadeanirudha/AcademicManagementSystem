...
namespace AMS.Web.UI.Controllers
{
    public class EmpDesignationMasterController : BaseController
    {
        ...
        IEmpDesignationMasterServiceAccess _empDesignationMasterServiceAcess = null;
        ...
        {
            _empDesignationMasterServiceAcess = new EmpDesignationMasterServiceAccess();
        }
        ...
        {
            return View("/Views/EmpDesignationMaster/Index.cshtml");
        }
        ...
        public ActionResult List(string actionMode)
        {
            ...
            try
            {
                ...
                return PartialView("/Views/EmpDesignationMaster/List.cshtml", model);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                if (model != null && model.EmpDesignationMasterDTO != null)
                {
                   ...
                   //model.EmpDesignationMasterDTO.IsActive = model.IsActive;
                    ...
                    IBaseEntityResponse<EmpDesignationMaster> response = _empDesignationMasterServiceAcess.InsertEmpDesignationMaster(model.EmpDesignationMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<EmpDesignationMaster> response = _empDesignationMasterServiceAcess.SelectByID(model.EmpDesignationMasterDTO);
                ...
                return PartialView("/Views/EmpDEsignationMaster/Edit.cshtml", model);
            }
           ...
           if (model != null && model.EmpDesignationMasterDTO != null)
                 {
                        ...
                        IBaseEntityResponse<EmpDesignationMaster> response = _empDesignationMasterServiceAcess.UpdateEmpDesignationMaster(model.EmpDesignationMasterDTO);
        ...
        //    model.EmpDesignationMasterDTO = new EmpDesignationMaster();
        //    model.EmpDesignationMasterDTO.ID = ID;
        //    return PartialView("/Views/EmpDEsignationMaster/Delete.cshtml", model);
        //}



        //[HttpPost]
        //public ActionResult Delete(EmpDesignationMasterViewModel model)
        //{
        //    if (model.ID > 0)
        //    {
        ...
        //        empDesignationMasterDTO.ID = model.ID;
        //        empDesignationMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //        IBaseEntityResponse<EmpDesignationMaster> response = _empDesignationMasterServiceAcess.DeleteEmpDesignationMaster(empDesignationMasterDTO);
        ...
        public IEnumerable<EmpDesignationMasterViewModel> GetEmpDesignationMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<EmpDesignationMaster> baseEntityCollectionResponse = _empDesignationMasterServiceAcess.GetBySearch(searchRequest);
