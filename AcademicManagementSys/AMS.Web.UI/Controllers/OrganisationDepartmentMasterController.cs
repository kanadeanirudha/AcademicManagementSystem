    ...
    public class OrganisationDepartmentMasterController : BaseController
    {
          ...
          try
           {
            if (ModelState.IsValid)
            {
                if (model != null && model.OrganisationDepartmentMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<OrganisationDepartmentMaster> response = _organisationDepartmentMasterServiceAcess.InsertOrganisationDepartmentMaster(model.OrganisationDepartmentMasterDTO);
                    model.OrganisationDepartmentMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<OrganisationDepartmentMaster> response = _organisationDepartmentMasterServiceAcess.SelectByID(model.OrganisationDepartmentMasterDTO);
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.OrganisationDepartmentMasterDTO != null)
                {
                    if (model != null && model.OrganisationDepartmentMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<OrganisationDepartmentMaster> response = _organisationDepartmentMasterServiceAcess.UpdateOrganisationDepartmentMaster(model.OrganisationDepartmentMasterDTO);
                        model.OrganisationDepartmentMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        //[HttpPost]
        //public ActionResult Delete(OrganisationDepartmentMasterViewModel model)
        //{
        //  try
        //    {  
        //    if (model.ID > 0)
        ...
        //            OrganisationDepartmentMasterDTO.ID = model.ID;
        //            OrganisationDepartmentMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);//model.DeletedBy;
        //            IBaseEntityResponse<OrganisationDepartmentMaster> response = _organisationDepartmentMasterServiceAcess.DeleteOrganisationDepartmentMaster(OrganisationDepartmentMasterDTO);
            ...
            try
            {
                if (ID > 0)
                {
                    if (ID > 0)
                    {
                        ...
                        OrganisationDepartmentMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);//model.DeletedBy;
                        IBaseEntityResponse<OrganisationDepartmentMaster> response = _organisationDepartmentMasterServiceAcess.DeleteOrganisationDepartmentMaster(OrganisationDepartmentMasterDTO);
                        model.OrganisationDepartmentMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.OrganisationDepartmentMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<OrganisationDepartmentMasterViewModel> GetOrganisationDepartmentMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<OrganisationDepartmentMaster> baseEntityCollectionResponse = _organisationDepartmentMasterServiceAcess.GetBySearch(searchRequest);
        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param)
        {
            ...
            switch (Convert.ToInt32(sortColumnIndex))
            {
                case 0:
                    ...
                    {
                        _searchBy = "DepartmentName Like '%" + param.sSearch + "%' or DeptShortCode Like '%" + param.sSearch + "%'or AcademicNonacademic Like '%" + param.sSearch + "%'";        //this "if" block is added for search functionality
                    }
                    break;
                case 1:
            ...
            var result = from c in displayedPosts select new[] { c.DepartmentName.ToString(), c.DeptShortCode.ToString(),c.AcademicNonacademic.ToString(), Convert.ToString(c.ID) };
            return Json(new
            {
                sEcho = param.sEcho,
