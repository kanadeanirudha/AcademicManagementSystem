...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IGeneralEducationMasterServiceAccess _generalEducationMasterServiceAcess = null;
        ...
        {
            _generalEducationMasterServiceAcess = new GeneralEducationMasterServiceAccess();
        ...
        public ActionResult Create(string EducationTypeMaster)
        {
            ...
            try
            {
                ...
                List<GeneralUnitMaster> GeneralUnitMasterList = GetListGeneralUnitMaster();
                List<SelectListItem> GeneralUnitMaster = new List<SelectListItem>();
                foreach (GeneralUnitMaster item in GeneralUnitMasterList)
                {
                    GeneralUnitMaster.Add(new SelectListItem { Text = item.UnitDescription, Value = item.UnitDescription.ToString() });
                }
                ViewBag.GeneralUnitMaster = new SelectList(GeneralUnitMaster, "Value", "Text");
            }
            catch (Exception)
            {
                throw;
        ...
        public ActionResult Create(GeneralEducationMasterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralEducationMasterDTO != null)
                {
                    ...
                    IBaseEntityResponse<GeneralEducationMaster> response = _generalEducationMasterServiceAcess.InsertGeneralEducationMaster(model.GeneralEducationMasterDTO);
                    model.GeneralEducationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                }
        ...
        public ActionResult Edit(int id)
        {
            ...
            try
            {
                ...
                IBaseEntityResponse<GeneralEducationMaster> response = _generalEducationMasterServiceAcess.SelectByID(model.GeneralEducationMasterDTO);
                if (response != null && response.Entity != null)
                {
                    ...
                    ViewBag.GeneralUnitMaster = new SelectList(GeneralUnitMaster, "Value", "Text", response.Entity.Unit.ToString());
                }
                return PartialView(model);
            }
            catch (Exception)
            ...
            if (ModelState.IsValid)
            {
                if (model != null && model.GeneralEducationMasterDTO != null)
                {
                    if (model != null && model.GeneralEducationMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralEducationMaster> response = _generalEducationMasterServiceAcess.UpdateGeneralEducationMaster(model.GeneralEducationMasterDTO);
                        model.GeneralEducationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                }
                return Json(model.GeneralEducationMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralEducationMasterViewModel model)
        //{
        //    if (!ModelState.IsValid)
        //    {
        //        if (model.ID > 0)
        ...
        //            generalEducationMasterDTO.ID = model.ID;
        //            generalEducationMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
        //            IBaseEntityResponse<GeneralEducationMaster> response = _generalEducationMasterServiceAcess.DeleteGeneralEducationMaster(generalEducationMasterDTO);
        ...
        public ActionResult Delete(int ID)
        {
            ...
            if (ID > 0)
            {
                if (ID > 0)
                {
                    ...
                    generalEducationMasterDTO.DeletedBy = Convert.ToInt32(Session["UserID"]);
                    IBaseEntityResponse<GeneralEducationMaster> response = _generalEducationMasterServiceAcess.DeleteGeneralEducationMaster(generalEducationMasterDTO);
                    model.GeneralEducationMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                }
                return Json(model.GeneralEducationMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            else
        ...
        public IEnumerable<GeneralEducationMasterViewModel> GetGeneralEducationMaster(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralEducationMaster> baseEntityCollectionResponse = _generalEducationMasterServiceAcess.GetBySearch(searchRequest);
