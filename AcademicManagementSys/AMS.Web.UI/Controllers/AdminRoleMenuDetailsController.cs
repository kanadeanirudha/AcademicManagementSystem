...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IAdminRoleMenuDetailsServiceAccess _AdminRoleMenuDetailsServiceAccess = null;
        ...
        {
            _AdminRoleMenuDetailsServiceAccess = new AdminRoleMenuDetailsServiceAccess();
        ...
        public ActionResult List(string centerCode, string departmentID, string actionMode)
        {
            try
            {
                ...
                return PartialView("List", _adminRoleMenuDetailsBaseViewModel);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AdminRoleMenuDetailsDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AdminRoleMenuDetails> response = _AdminRoleMenuDetailsServiceAccess.InsertAdminRoleMenuDetails(model.AdminRoleMenuDetailsDTO);
                        model.AdminRoleMenuDetailsDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public IEnumerable<AdminRoleMenuDetailsViewModel> GetAdminRoleMenuDetails(string centerCode, int departmentId, out int TotalRecords)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleMenuDetails> baseEntityCollectionResponse = _AdminRoleMenuDetailsServiceAccess.GetBySearch(searchRequest);
        ...
        protected List<AdminRoleMenuDetails> GetListAdminMenuDetails(int ModuleID, int AdminRoleMasterID)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleMenuDetails> baseEntityCollectionResponse = _AdminRoleMenuDetailsServiceAccess.GetBySearchAdminMenuList(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
        ...
        protected List<AdminRoleMenuDetails> GetListAdminModule()
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleMenuDetails> baseEntityCollectionResponse = _AdminRoleMenuDetailsServiceAccess.GetBySearchModuleList(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
