    ...
    public class DashboardAllocationController : BaseController
    {
        ...
        public ActionResult List(string actionMode, string ModuleCode, int AdminRoleMasterID = 0)
        {
            try
            {
                ...
                ViewBag.AdminRoleCodeList = new SelectList(CRMAdmineRoleCodelist, "Value", "Text", AdminRoleMasterID);
        ...
        public ActionResult DeleteContaintAllocateStatus(string ID)
        {
            try
            {
                if (ID != string.Empty & ID != null)
                {
                    ...
                    IBaseEntityResponse<Dashboard> response = _DashboardServiceAccess.DeleteContaintAllocateStatus(model.DashboardDTO);
                    model.DashboardDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
        ...
        public ActionResult InsertContaintAllocateStatus(string ID)
        {
            try
            {
                if (ID != string.Empty & ID != null)
                {
                    ...
                    IBaseEntityResponse<Dashboard> response = _DashboardServiceAccess.InsertContaintAllocateStatus(model.DashboardDTO);
        ...
        public IEnumerable<DashboardViewModel> GetDeshboardAllocationList(int AdminRoleMasterID, string ModuleCode, out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<Dashboard> baseEntityCollectionResponse = _DashboardServiceAccess.GetDeshboardAllocationBySearch(searchRequest);
