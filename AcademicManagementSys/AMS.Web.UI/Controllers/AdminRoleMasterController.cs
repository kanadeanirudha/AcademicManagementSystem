...
namespace AMS.Web.UI.Controllers
{
    public class AdminRoleMasterController : BaseController
    {
        ...
        AdminRoleCentreRightsServiceAccess _adminRoleCentreRightsServiceAccess = null;
        ...
        public ActionResult List(string centerCode, string departmentID, string actionMode)
        {
            try
            {
                ...
                return PartialView("List", _adminRoleMasterBaseViewModel);
        ...
        public ActionResult Create(int ID)
        {
            try
            {
                ...
                if (ID != 0)
                {
                    ...
                    IBaseEntityResponse<AdminSnPosts> response = _adminSnPostsServiceAcess.SelectByID(adminSnPostsmodel.AdminSnPostsDTO);
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AdminRoleMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AdminRoleMaster> response = _adminRoleMasterServiceAcess.InsertAdminRoleMaster(model.AdminRoleMasterDTO);
                        model.AdminRoleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }                   
        ...
        public ActionResult Edit(int ID,string CentreCode,string CentreName)
        {
            try
            {
                ...
                model.AdminRoleMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<AdminRoleMaster> response = _adminRoleMasterServiceAcess.SelectByID(model.AdminRoleMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.AdminRoleMasterDTO != null)
                    {
                        if (model != null && model.AdminRoleMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<AdminRoleMaster> response = _adminRoleMasterServiceAcess.UpdateAdminRoleMaster(model.AdminRoleMasterDTO);
                            model.AdminRoleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                        }
                    }
                    return Json(model.AdminRoleMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model.ID > 0)
                    {
                        ...
                        IBaseEntityResponse<AdminRoleMaster> response = _adminRoleMasterServiceAcess.DeleteAdminRoleMaster(AdminRoleMasterDTO);
                        model.AdminRoleMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.AdminRoleMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<AdminRoleMasterViewModel> GetAdminRoleMaster(string centerCode, int departmentId, out int TotalRecords)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleMaster> baseEntityCollectionResponse = _adminRoleMasterServiceAcess.GetBySearch(searchRequest);
        ...
        protected List<AdminRoleMaster> GetListAdminRoleCentreRightsByAdminRole(int ID)
        {
            try
            {
                ...
                IBaseEntityCollectionResponse<AdminRoleMaster> baseEntityCollectionResponse = _adminRoleMasterServiceAcess.GetCentreRightsByRole(searchRequest);
                if (baseEntityCollectionResponse != null)
                {
                    if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                    {
