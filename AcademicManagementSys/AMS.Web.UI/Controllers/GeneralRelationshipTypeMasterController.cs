...
namespace AMS.Web.UI.Controllers
{
    public class GeneralRelationshipTypeMasterController : BaseController
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralRelationshipTypeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralRelationshipTypeMaster> response = _GeneralRelationshipTypeMasterServiceAccess.InsertGeneralRelationshipTypeMaster(model.GeneralRelationshipTypeMasterDTO);
        ...
        public ActionResult Edit(int ID)
        {
            ...
            IBaseEntityResponse<GeneralRelationshipTypeMaster> response = _GeneralRelationshipTypeMasterServiceAccess.SelectByID(model.GeneralRelationshipTypeMasterDTO);
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.GeneralRelationshipTypeMasterDTO != null)
                    {
                        if (model != null && model.GeneralRelationshipTypeMasterDTO != null)
                        {
                            ...
                            IBaseEntityResponse<GeneralRelationshipTypeMaster> response = _GeneralRelationshipTypeMasterServiceAccess.UpdateGeneralRelationshipTypeMaster(model.GeneralRelationshipTypeMasterDTO);
        ...
        //[HttpPost]
        //public ActionResult Delete(GeneralRelationshipTypeMasterViewModel model)
        //{
        //    try
        //    {
        ...
        //                GeneralRelationshipTypeMasterDTO.ID = model.ID;
        //                GeneralRelationshipTypeMasterDTO.DeletedBy = model.DeletedBy;
        ...
        //                IBaseEntityResponse<GeneralRelationshipTypeMaster> response = _GeneralRelationshipTypeMasterServiceAccess.DeleteGeneralRelationshipTypeMaster(GeneralRelationshipTypeMasterDTO);
            ...
            try
            {
                ...
                if (ID > 0)
                {
                    if (model != null && model.GeneralRelationshipTypeMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<GeneralRelationshipTypeMaster> response = _GeneralRelationshipTypeMasterServiceAccess.DeleteGeneralRelationshipTypeMaster(GeneralRelationshipTypeMasterDTO);
                        //model.GeneralRelationshipTypeMasterDTO.errorMessage = CheckError((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                        model.GeneralRelationshipTypeMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                    }
                    return Json(model.GeneralRelationshipTypeMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public IEnumerable<GeneralRelationshipTypeMasterViewModel> GetGeneralRelationshipTypeMasterDetails(out int TotalRecords)
        {
            ...
            IBaseEntityCollectionResponse<GeneralRelationshipTypeMaster> baseEntityCollectionResponse = _GeneralRelationshipTypeMasterServiceAccess.GetBySearch(searchRequest);
