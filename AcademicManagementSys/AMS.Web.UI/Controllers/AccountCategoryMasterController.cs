...
namespace AMS.Web.UI.Controllers
{
    ...
    {
        IAccountCategoryMasterServiceAccess _accountCategoryMasterServiceAccess = null;
        IAccountHeadMasterServiceAccess _accountHeadMasterServiceAccess = null;
        ...
        {
            _accountCategoryMasterServiceAccess = new AccountCategoryMasterServiceAccess();
            _accountHeadMasterServiceAccess = new AccountHeadMasterServiceAccess();
        }
        #endregion
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountCategoryMasterDTO != null)
                    {
                        ...
                        IBaseEntityResponse<AccountCategoryMaster> response = _accountCategoryMasterServiceAccess.InsertAccountCategoryMaster(model.AccountCategoryMasterDTO);
                        model.AccountCategoryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Insert);
                    }
        ...
        public ActionResult Edit(Int16 id)
        {
            try
            {
                ...
                model.ID = id;
                model.AccountCategoryMasterDTO.ConnectionString = _connectioString;
                IBaseEntityResponse<AccountCategoryMaster> response = _accountCategoryMasterServiceAccess.SelectByID(model.AccountCategoryMasterDTO);
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    if (model != null && model.AccountCategoryMasterDTO != null)
                    {
                        ...
                        model.AccountCategoryMasterDTO.ModifiedBy = Convert.ToInt32(Session["UserID"]);
                        IBaseEntityResponse<AccountCategoryMaster> response = _accountCategoryMasterServiceAccess.UpdateAccountCategoryMaster(model.AccountCategoryMasterDTO);
                        model.AccountCategoryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Update);
                    }
                    return Json(model.AccountCategoryMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
                }
                else
        ...
        public ActionResult Delete(short ID)
        {
            try
            {
                ...
                IBaseEntityResponse<AccountCategoryMaster> response  = _accountCategoryMasterServiceAccess.DeleteAccountCategoryMaster(AccountCategoryMasterDTO);
                model.AccountCategoryMasterDTO.errorMessage = CheckErrorV2((response.Entity != null) ? response.Entity.ErrorCode : 20, ActionModeEnum.Delete);
                return Json(model.AccountCategoryMasterDTO.errorMessage, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public List<AccountCategoryMaster> GetListAccountCategoryMaster(out int _totalRecords)
        {
            ...
            IBaseEntityCollectionResponse<AccountCategoryMaster> baseEntityCollectionResponse = _accountCategoryMasterServiceAccess.GetBySearch(searchRequest);
        ...
        public List<AccountHeadMaster> GetListAccountHeadMaster()
        {
            ...
            searchRequest.ConnectionString = Convert.ToString(ConfigurationManager.ConnectionStrings["Main.ConnectionString"]);
            IBaseEntityCollectionResponse<AccountHeadMaster> baseEntityCollectionResponse = _accountHeadMasterServiceAccess.GetHeadNameList(searchRequest);
            if (baseEntityCollectionResponse != null)
            {
                if (baseEntityCollectionResponse.CollectionResponse != null && baseEntityCollectionResponse.CollectionResponse.Count > 0)
                {
