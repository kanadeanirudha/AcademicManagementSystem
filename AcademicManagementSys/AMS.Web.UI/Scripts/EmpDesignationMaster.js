...
function createSuccess() {
    ...
    if ($("#update-message").html() == "True") {
        ...
        //Reload List
        ReloadList("Employee Designation Created Sucessfully.");
...
function editSuccess() {
    ...
    if ($("#update-message").html() == "True") {
        ...
        //Reload List
        ReloadList("Employee Designation Updated Sucessfully.");
...
function deleteSuccess() {
    ...
    if ($("#update-message").html() == "True") {
        ...
        //Reload List
        ReloadList("Employee Designation Deleted Sucessfully.");
