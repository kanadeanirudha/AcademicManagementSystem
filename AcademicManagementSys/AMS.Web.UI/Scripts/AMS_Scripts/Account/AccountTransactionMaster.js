...
//        //AccountTransactionMaster.t = $('#example').DataTable({
//        //    "bPaginate": false,
//        //    "bSort": false,
//        //    //"bSortable": false,
//        //    //"bJQueryUI": true,
...
//        //    AccountTransactionMaster.rowCount = $("#example tbody tr").length;
...
//        //    var $td = $('#example tbody').find('tr').eq(AccountTransactionMaster.rowCount - 2).find('td').eq(4).append('<a href="#"><i class="icon-edit"></i></a>');

//        //    AccountTransactionMaster.t.row.add([
//        //            '<input id="AccName' + AccountTransactionMaster.rowCount + '" placeholder="Search Account"  style="width:230px;" maxlength="200" type="text" /><input type="hidden" id="TransactionSubID' + AccountTransactionMaster.rowCount + '" /> <input type="hidden" id="AccID' + AccountTransactionMaster.rowCount + '" /> <input type="text" id="SubLedger' + AccountTransactionMaster.rowCount + '" placeholder="Search Sub-Ledger Account" maxlength="200" style="width:230px;display:none;" /><input type="text" id="AccBranchName' + AccountTransactionMaster.rowCount + '" placeholder="Enter Branch Name" maxlength="30" style="width:230px;display:none;" /> ',
//        //            '<input type="text" style="width:260px" maxlength="500" placeholder="Narration"  /> <input type="text" id="AccChequeNumber' + AccountTransactionMaster.rowCount + '" placeholder="Enter Cheque Number" style="display:none;width:260px" maxlength="20" />',
//        //            '<input type="text" id="debitBal' + AccountTransactionMaster.rowCount + '" maxlength="10" style="text-align:right; width:100px" value="0" /><input type="text" id="AccChequeDate' + AccountTransactionMaster.rowCount + '" placeholder="Cheque Date" style="width:100px;display:none;" />',
//        //            '<input type="text" id="creditBal' + AccountTransactionMaster.rowCount + '" maxlength="10" style="text-align:right ;width:100px" value="0"/> <input type="hidden" id="PersonID' + AccountTransactionMaster.rowCount + '" /><input type="hidden" id="PersonType' + AccountTransactionMaster.rowCount + '" /><input type="hidden" id="CashBankFlag' + AccountTransactionMaster.rowCount + '" /> ',// </br><a href="#" class="hide-row" style="text-align:centre;display:none;width:500px"><i class="icon-ok"></i><a>',
//        //            '',
//        //    ]).draw();
...
//        //        $('#example tbody').find('tr').eq(trLength - 2).find('td').eq(4).append('<a href="#"><i style="" class="icon-ok"></i></a>');
...
//        //    $("#example tbody tr td input[id^=AccChequeDate]").datepicker({
//        //        dateFormat: "d-M-yy",
//        //        changeMonth: true,
//        //        changeYear: true
//        //    });
...
//        //    $("#example tbody").on("keydown click", "tr td input[id^=SubLedger]", function () {
//        //        $(this).autocomplete({
...
//        //                    $(this).closest('tr').find('td input[id^=AccName]').val(mainLedgerName + " [" + ui.item.label + "]");    // save selected id to hidden input
...
//        //    $("#example tbody").on("keydown", "tr td input[id^=debitBal]", function (e) {
//        //        AMSValidation.AllowNumbersWithDecimalOnly(e);
//        //    });

//        //    //VALIDATION FOR CREDIT BALANCE INPUT
//        //    $("#example tbody").on("keydown", "tr td input[id^=creditBal]", function (e) {
//        //        AMSValidation.AllowNumbersWithDecimalOnly(e);
//        //    });

//        //    //FORMAT OF INPUT TEXT IN DEBIT BALANCE
//        //    $("#example tbody").on('change', "tr td input[id^=debitBal]", function (e) {
//        //        this.value = parseFloat(this.value).toFixed(2);
//        //    });

//        //    //FORMAT OF INPUT TEXT IN CREDIT BALANCE
//        //    $("#example tbody").on('change', "tr td input[id^=creditBal]", function (e) {
//        //        this.value = parseFloat(this.value).toFixed(2);
//        //    });
...
//                ajaxRequest.ErrorMessageForJS("JsValidationMessages_SelectTransactionType", "SuccessMessage", "#FFCC80");
//                //$('#SuccessMessage').html("Please select transaction type");
...
//            }
//            else {
//                ajaxRequest.ErrorMessageForJS("JsValidationMessages_SelectBalancesheetAndTransCationType", "SuccessMessage", "#FFCC80");
//                //$('#SuccessMessage').html("Please select balancesheet & transaction type");
//                //$('#SuccessMessage').delay(400).slideDown(400).delay(15000).slideUp(400).css('background-color', "#FFCC80");
//                $('#LiSessionName').hide(true);
//                //  $('#btnCreateTransaction').hide(true);
//            }
...
//            if (accName == "") {
//                $('#SuccessMessage').html("Please select account.");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                return false;
//            }
...
//                $('#SuccessMessage').html("Please enter cheque date of cheque no" + AccChequeNumber);
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                return false;
//            }
...
//                '<tr>' +
//                '<td><input id="AccName' + AccountTransactionMaster.rowCount + '" placeholder="Search Account*"  style="width:230px;text-align:centre" type="text"  maxlength="200"  /><input type="hidden" id="TransactionSubID' + AccountTransactionMaster.rowCount + '" /> <input type="hidden" id="AccID' + AccountTransactionMaster.rowCount + '" /> <input type="text" id="SubLedger' + AccountTransactionMaster.rowCount + '" placeholder="Search Sub-Ledger Account*"  maxlength="200" style="width:230px;display:none;" /><input type="text" id="AccBranchName' + AccountTransactionMaster.rowCount + '" placeholder="Enter Branch Name"  maxlength="30"  style="width:230px;display:none;" /> </td>' +
//                '<td><input type="text" maxlength="500" style="width:260px" placeholder="Narration"  /> <input type="text" id="AccChequeNumber' + AccountTransactionMaster.rowCount + '" placeholder="Enter Cheque Number"  maxlength="20" style="display:none;width:260px" /></td>' +
//                '<td style= padding-left:12px; ><input type="text" id="debitBal' + AccountTransactionMaster.rowCount + '" maxlength="10" style="text-align:right; width:100px" value="0" /><input type="text" id="AccChequeDate' + AccountTransactionMaster.rowCount + '" placeholder="Cheque Date" style="width:100px;display:none;" /></td>' +
//                '<td style= padding-left:12px;><input type="text" id="creditBal' + AccountTransactionMaster.rowCount + '" maxlength="10" style="text-align:right ;width:100px" value="0"/> <input type="hidden" id="PersonID' + AccountTransactionMaster.rowCount + '" /><input type="hidden" id="PersonType' + AccountTransactionMaster.rowCount + '" /> <input type="hidden" id="CashBankFlag' + AccountTransactionMaster.rowCount + '" /></td>' +//</br><a href="#" class="hide-row" style="text-align:centre;display:none;width:500px"><i class="icon-ok"></i><a>',
//                "<td style='text-align:center; '><a href='#' class='edit-row' ><i class='icon-edit'></i><a> | <a href='#' class='remove-row' ><i  class='icon-trash'></i><a></td>" +
//                '</tr>'
//        );
...
//                $("#AccID" + AccountTransactionMaster.rowCount + "").val(ui.item.id);    // save selected id to hidden input
...
//                var vat = "";
//            }
//            else { AMSValidation.AllowNumbersWithDecimalOnly(e); }
...
//        var data = table.$('input,select,input').each(function () {
...
//        var Count = DataArray.length / 13;
//        var transactionAmount = 0;
//        var statusFlag = "";
//        for (var i = 0; i < Count; i++) {

//            // String for Insert 
//            if (DataArray[x + 2] == "" && DataArray[x + 7] >= 0 && DataArray[x + 9] >= 0) {
//                $('#SuccessMessage').html("Please select account of debited amount " + DataArray[x + 7]+" or credited amount " + DataArray[x + 9]);
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                return false;
//            }
//            //else if (DataArray[x + 2] == "" && DataArray[x + 9] >= 0) {
//            //    $('#SuccessMessage').html("Please select Account of credited amount " + DataArray[x + 9]);
//            //    $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//            //    return false;
//            //}
//            else if (DataArray[x + 6] != "" && DataArray[x + 7] == "") {
//                $('#SuccessMessage').html("Please enter cheque date of cheque no" + DataArray[x + 6]);
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                AccountTransactionMaster.flag = false;
//                return false;
//            }
//            else if (DataArray[x + 2] == 0 || DataArray[x + 2] == "") {
//                $('#SuccessMessage').html("Please select proper account.");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                AccountTransactionMaster.flag = false;
//                return false;
//            }
//            else if (DataArray[x + 12] == "B" && DataArray[x + 4] == "") {
//                $('#SuccessMessage').html("Please enter branch name.");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                AccountTransactionMaster.flag = false;
//                return false;
//            }
//            else if (DataArray[x + 6] != "" && DataArray[x + 8] == "") {
//                $('#SuccessMessage').html("Please enter cheque date of cheque no" + DataArray[x + 6]);
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                AccountTransactionMaster.flag = false;
//                return false;
//            }
//            else if (DataArray[x + 12] == "L" && DataArray[x + 11] != "" && DataArray[x + 10] == 0) {
//                $('#SuccessMessage').html("Please select sub-ledger account.");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1500).slideUp(400).css('background-color', "#FFCC80");
//                AccountTransactionMaster.flag = false;
//                return false;
...
//            else if (DataArray[x + 2] != "" && DataArray[x + 7] > 0 || DataArray[x + 2] != "" && DataArray[x + 9] > 0) {
//                if (DataArray[x + 7] > 0) {
//                    transactionamount = DataArray[x + 7];
//                    statusFlag = 'D';
//                }
//                else if (DataArray[x + 9] > 0) {
//                    transactionamount = DataArray[x + 9];
//                    statusFlag = 'C';
//                }
//                xmlParamList = xmlParamList + "<row><TransactionSubID>" + DataArray[x + 1] + "</TransactionSubID><AccountID>" + DataArray[x + 2] + "</AccountID><DebitCreditFlag>" + statusFlag + "</DebitCreditFlag><TransactionAmount>" + transactionamount + "</TransactionAmount><ChequeNo>" + DataArray[x + 6] + "</ChequeNo><ChequeDatetime>" + DataArray[x + 8] + "</ChequeDatetime><NarrationDescription>" + DataArray[x + 5] + "</NarrationDescription><BankName>" + DataArray[x] + "</BankName><BranchName>" + DataArray[x + 4] + "</BranchName><PersonID>" + DataArray[x + 10] + "</PersonID><PersonType>" + DataArray[x + 11] + "</PersonType><IsActive>1</IsActive></row>";
...
var AccountTransactionMaster = {
    ...
    AddRow: function () {
        ...
        $("#AccChequeNumber" + AccountTransactionMaster.rowCount + "").on("keydown", function (e) {
            ...
            else { AMSValidation.AllowNumbersOnly(e); }
    ...
    getDataFromDataTable: function () {
        ...
        for (var i = 0; i < Count; i++) {
            ...
            if (DataArray[x + 3] == "" && DataArray[x + 9] >= 0 && DataArray[x + 11] >= 0) {
                ...
                xmlParamList = xmlParamList + "<row><TransactionSubID>" + DataArray[x] + "</TransactionSubID><AccountID>" + DataArray[x + 3] + "</AccountID><DebitCreditFlag>" + statusFlag + "</DebitCreditFlag><TransactionAmount>" + transactionamount + "</TransactionAmount><ChequeNo>" + DataArray[x + 8] + "</ChequeNo><ChequeDatetime>" + DataArray[x + 10] + "</ChequeDatetime><NarrationDescription>" + DataArray[x + 7] + "</NarrationDescription><BankName>" + DataArray[x + 1] + "</BankName><BranchName>" + DataArray[x + 6] + "</BranchName><PersonID>" + DataArray[x + 12] + "</PersonID><PersonType>" + DataArray[x + 13] + "</PersonType><IsActive>1</IsActive></row>";
                //"<row><TransactionSubID>" + 0 + "</TransactionSubID><AccountID>" + DataArray[x + 1] + "</AccountID><DebitCreditFlag>" + statusFlag + "</DebitCreditFlag><TransactionAmount>" + transactionamount + "</TransactionAmount><ChequeNo>" + 00001 + "</ChequeNo><ChequeDatetime>" + 2014 - 01 - 01 + "</ChequeDatetime><NarrationDescription>" + DataArray[x + 2] + "</NarrationDescription><BankName>" + DataArray[x] + "</BankName><BranchName>" + ASD + "</BranchName><PersonID>" + 0 + "</PersonID><PersonType>" + S + "</PersonType><IsActive>1</IsActive></row>"
                // xmlParamList = xmlParamList + "<row><AccountName>" + DataArray[x] + "</AccountName><AccountID>" + DataArray[x + 1] + "</AccountID><Narration>" + DataArray[x + 2] + "</Narration><DebitAmount>" + DataArray[x + 3] + "</DebitAmount><CreditAmount>" +  DataArray[x + 4] * -1 + "</CreditAmount></row>";
            }
            x = x + 15
