...
//            var varSum = parseInt($("#ChequeFromNo").val()) + parseInt($(this).val()) - 1;
//            $("#ChequeToNo").val(varSum);
//        });

//        $("#ChequeFromNo").change(function () {
//            var varSum = parseInt($("#TotalNoCheque").val()) + parseInt($(this).val()) - 1;
//            $("#ChequeToNo").val(varSum);
//        });
...
//                $('#SuccessMessage').delay(400).slideDown(400).delay(15000).slideUp(400).css('background-color', actionMode);
//            }
//        });
//    },
//    //LoadList method is used to load List page
...
//                ajaxRequest.makeRequest("/AccountChequeBookMaster/Create", "POST", AccountChequeBookMasterData, AccountChequeBookMaster.Success);
//            }
//        }
...
//    //    parent.$.colorbox.close();
//    //    if (data == "True") {
//    //        AccountChequeBookMaster.ReloadList("Record Updated Sucessfully.")
//    //    }
//    //},
...
//    //    parent.$.colorbox.close();
//    //    if (data == "True") {
//    //        AccountChequeBookMaster.ReloadList("Record Deleted Sucessfully.")
//    //    }
//    //},
//};
