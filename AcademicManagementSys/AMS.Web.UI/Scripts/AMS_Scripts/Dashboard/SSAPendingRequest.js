...
var SSAPendingRequest = {
    ...
    AjaxCallSSAPendingRequest: function () {
        var SSAPendingRequestData = null;
         if (SSAPendingRequest.ActionName == "Approved" || SSAPendingRequest.ActionName == "Rejected") {
            ...
            ajaxRequest.makeRequest("/ScholarShipAllocation/ScholarShipAllocationRequestApproval", "POST", SSAPendingRequestData, SSAPendingRequest.Success);
        }
    },
    ...
    GetSSAPendingRequest: function () {
        ...
        if (SSAPendingRequest.ActionName == "Approved" || SSAPendingRequest.ActionName == "Rejected") {
            ...
            Data.XMLstring = ScholarShipAllocation.XMLstring           
    ...
    GetXmlData: function () {
        ...
        if (ScholarShipAllocationXml.length > 6) {
            ScholarShipAllocation.XMLstring = ScholarShipAllocationXml + "</rows>";
        }
        else {
