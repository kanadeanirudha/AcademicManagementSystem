...
var InformativeNotifications = {
    ...
    AjaxCallRequestApproval: function (selectedTransactionID) {
        ...
        if (InformativeNotifications.ActionName == "AllRead") {
            ...
            ajaxRequest.makeRequest("/Home/InformativeNotifications", "POST", RequestApprovalData, InformativeNotifications.Success);
            ...
            Data.NotificationTransactionID = selectedTransactionID;
            RequestApprovalData = Data;
            ajaxRequest.makeRequest("/Home/InformativeNotifications", "POST", RequestApprovalData, InformativeNotifications.SuccessSingle);
        }
    },
