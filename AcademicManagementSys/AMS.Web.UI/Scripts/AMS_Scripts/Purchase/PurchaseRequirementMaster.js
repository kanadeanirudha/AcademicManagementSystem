...
//                if (DataArray[i] == $('#GeneralItemCodeID').val()) {
...
//                $('#msgDiv').html("Please Enter Expected Date.");
//                $('#msgDiv').delay(400).slideDown(400).delay(1200).slideUp(400).css('background-color', "#FFCC80");
//                $("#ExpectedDate").focus();
//                return false;
//            }
...
//                $('#msgDiv').html("Please Select Location.");
//                $('#msgDiv').delay(400).slideDown(400).delay(1200).slideUp(400).css('background-color', "#FFCC80");
...
//                    "<td><input id='quantity' maxlength='8' type='text' value=" + parseFloat($('#Quantity').val()).toFixed(2) + " style='width:60%;height:16px;text-align:right'/></td>" +
//                    "<td>" + $('#UnitCode').val() + "</td>" +
...
//                    "<td  style='text-align:center; '><i class='icon-trash' style='cursor:pointer;'  title = Delete> <input type='text' value=" + $('#ItemNumber').val() + " style='display:none' /><input type='text' value=" + $('#BarCode').val() + " style='display:none' /><input type='text' value=" + $('#UnitCode').val() + " style='display:none' /> </td>" +
//                    "</tr>");
...
//                $('#SuccessMessage').html("Please Select Deprtment");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(1200).slideUp(400).css('background-color', "#FFCC80");
//                return false;
//            }
//            else {
...
//                    $('#SuccessMessage').html("Option excel only allows file types of xls and xlsx. ");
//                    $('#SuccessMessage').delay(400).slideDown(400).delay(5000).slideUp(400).css('background-color', '#FFCC80');
...
//            else {
//                $("#CreatePurchaseByExcel").hide(false)
//                $('#SuccessMessage').html("The selected file does not appear to be an excel file.");
//                $('#SuccessMessage').delay(400).slideDown(400).delay(5000).slideUp(400).css('background-color', '#FFCC80');
//                $("#MyFile").replaceWith($("#MyFile").val('').clone(true));
