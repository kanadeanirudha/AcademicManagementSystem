...
//        //    $('#UptoYear').append($('<option />').val(i).html(i));
//        //}
...
//       // $('#FormDetailsEmployeeQualification :input').attr('readonly', 'readonly');
...
//                //$('#EmployeeQualification').hide();
//                //$('#iconQualificationDetails').removeClass("icon-minus");
//                //$('#iconQualificationDetails').addClass("icon-plus");
//                //ShowQualificationExperience = 0;
...
//    //        parent.$.colorbox.close();
//    //        var actionMode = "1";
//    //        EmployeeQualification.ReloadList("Record Updated Sucessfully.", actionMode);
...
//    //        parent.$.colorbox.close();
//    //        EmployeeQualification.ReloadList("Record Deleted Sucessfully.");
