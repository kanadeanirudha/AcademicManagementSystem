...
//    //        parent.$.colorbox.close();
//    //        var actionMode = "1";
//    //        EmployeeExperience.ReloadList("Record Updated Sucessfully.", actionMode);
...
//    //        parent.$.colorbox.close();
//    //        EmployeeExperience.ReloadList("Record Deleted Sucessfully.");
    ...
    constructor: function () {
        ...
        $(function () {
            ...
            $('#ExperienceToYear').on('dp.hide', function (e) {
                ...
                $('#ExperienceFromYear').data("DateTimePicker").minDate(minDate);
                if ($("#ExperienceFromYear").val() != "") {
                    var ExperienceFromYear = new Date($("#ExperienceFromYear").val());
                    var ExperienceToYear = new Date($("#ExperienceToYear").val());
