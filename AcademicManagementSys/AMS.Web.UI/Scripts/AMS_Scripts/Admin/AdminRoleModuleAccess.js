...
//            var splited_ADM_RM_ID = ADM_RM_ID.split(":");
//            var AdminRoleMasterID = splited_ADM_RM_ID[3];           
//            AdminRoleModuleAccess.LoadListByEntityType(accessibleCentreCode, MonitoringLevel, valEntityType, AdminRoleMasterID, accessibleCentreName);
...
//        var EntityType = $('input[name=Entity]').val();
...
//        TotalRow = TotalRecord / 4;
//        //DatatableData = DataArray.join(',') + ",";


//        var CheckArrayForSelect_Row = []; var CheckArrayForIsAcadMgr = []; var CheckArrayForIsEstMgr = []; var CheckArrayForIsSuperUser = [];
//        $('#myCreateDataTable input[type=checkbox]').each(function () {
//            if (this.checked == true) {
//                var aaa = [];
//                aaa = $(this).val().split('~');
//                if (aaa[5] == "Select_Row") {
//                    CheckArrayForSelect_Row.push($(this).val());
//                }
//                // else { CheckArrayForSelect_Row.push("0"); }
//                if (aaa[4] == "IsAcadMgr") {
//                    CheckArrayForIsAcadMgr.push($(this).val());
//                }
//                // else { CheckArrayForIsAcadMgr.push("0"); }
//                if (aaa[4] == "IsEstMgr") {
//                    CheckArrayForIsEstMgr.push($(this).val());
//                }
//                // else { CheckArrayForIsEstMgr.push("0"); }
//                if (aaa[4] == "IsSuperUser") {
//                    CheckArrayForIsSuperUser.push($(this).val());
//                }
//                // else { CheckArrayForIsEstMgr.push("0"); }
//            }
...
//                aaa = $(this).val().split('~');
//                if (aaa[5] == "Select_Row") {
//                    CheckArrayForSelect_Row.push("0");
//                }
//                if (aaa[4] == "IsAcadMgr") {
//                    CheckArrayForIsAcadMgr.push("0");
//                }
//                if (aaa[4] == "IsEstMgr") {
//                    CheckArrayForIsEstMgr.push("0");
//                }
//                if (aaa[4] == "IsSuperUser") {
//                    CheckArrayForIsSuperUser.push("0");
//                }
//            }

//        });
//        //alert(DataArray);
//        //alert(CheckArrayForSelect_Row);
//        //alert(CheckArrayForIsAcadMgr);
//        //alert(CheckArrayForIsEstMgr);
//        AdminRoleModuleAccessCombinationIDs = "<rows>";
...
//            var d = [];
//            a = DataArray[i].split('~');
//            b = CheckArrayForIsAcadMgr[x].split('~');
//            c = CheckArrayForIsEstMgr[x].split('~');
//            d = CheckArrayForIsSuperUser[x].split('~');

//            if (DataArray[i] == CheckArrayForSelect_Row[x]) {
//                AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<row><ID>" + a[0] + "</ID><DptBshtSecnStrID>" + a[4] + "</DptBshtSecnStrID><IsAcadMgr>";
//                if (DataArray[i + 1] == CheckArrayForIsAcadMgr[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "1</IsAcadMgr><IsEstMgr>";
//                }
//                else if (DataArray[i + 1] != CheckArrayForIsAcadMgr[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "0</IsAcadMgr><IsEstMgr>"
//                }
//                if (DataArray[i + 2] == CheckArrayForIsEstMgr[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "1</IsEstMgr><IsSuperUser>";
//                }
//                else if (DataArray[i + 2] != CheckArrayForIsEstMgr[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "0</IsEstMgr><IsSuperUser>";

//                }
//                if (DataArray[i + 3] == CheckArrayForIsSuperUser[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "1";
//                }
//                else if (DataArray[i + 3] != CheckArrayForIsSuperUser[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "0";

//                }
//                AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "</IsSuperUser><IsFinMgr>0</IsFinMgr><IsAdmMgr>0</IsAdmMgr><IsActive>" + 1 + "</IsActive></row>"
//            }
//            else if (DataArray[i] != CheckArrayForSelect_Row[x]) {
//                if (a[1] == "True") {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<row><ID>" + a[0] + "</ID><DptBshtSecnStrID>" + a[4] + "</DptBshtSecnStrID><IsSuperUser>" + 0 + "</IsSuperUser><IsAcadMgr>" + 0 + "</IsAcadMgr><IsEstMgr>" + 0 + "</IsEstMgr><IsFinMgr>0</IsFinMgr><IsAdmMgr>0</IsAdmMgr><IsActive>" + 0 + "</IsActive></row>"
...
//            var DatatableData, TotalRecord, TotalRow;
//            TotalRecord = DataArray.length;
//            TotalRow = TotalRecord / 2;
//            //DatatableData = DataArray.join(',') + ",";


//            var CheckArrayForSelect_Row = []; var CheckArrayForIsAcadMgr = [];
//            $('#myCreateDataTable input[type=checkbox]').each(function () {
...
//                if (DataArray[i] == CheckArrayForSelect_Row[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<row><ID>" + a[0] + "</ID><DptBshtSecnStrID>" + a[4] + "</DptBshtSecnStrID><IsSuperUser>0</IsSuperUser><IsAcadMgr>";
//                    if (DataArray[i + 1] == CheckArrayForIsAcadMgr[x]) {
//                        AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "1</IsAcadMgr>";
//                    }
//                    else if (DataArray[i + 1] != CheckArrayForIsAcadMgr[x]) {
//                        AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "0</IsAcadMgr>"
//                    }


//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<IsEstMgr>0</IsEstMgr><IsFinMgr>0<IsFinMgr><IsAdmMgr>0</IsAdmMgr><IsActive>" + 1 + "</IsActive></row>"
//                }
//                else if (DataArray[i] != CheckArrayForSelect_Row[x]) {
...
//            var CheckArrayForSelect_Row = []; var CheckArrayForIsFinMgr = [];
//            $('#myCreateDataTable input[type=checkbox]').each(function () {
...
//                    // else { CheckArrayForSelect_Row.push("0"); }
//                    if (aaa[4] == "IsFinMgr") {
//                        CheckArrayForIsFinMgr.push($(this).val());
//                    }
//                    // else { CheckArrayForIsFinMgr.push("0"); }
...
//                var c = [];
//                a = DataArray[i].split('~');
//                b = CheckArrayForIsFinMgr[x].split('~');
//               // c = CheckArrayForIsEstMgr[x].split('~');
//                //  WeeklyData = DataArray[y].split('~');
             
//                if (DataArray[i] == CheckArrayForSelect_Row[x]) {
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<row><ID>" + a[0] + "</ID><DptBshtSecnStrID>" + a[4] + "</DptBshtSecnStrID><IsSuperUser>0</IsSuperUser><IsAcadMgr>0</IsAcadMgr><IsEstMgr>0</IsEstMgr><IsFinMgr>";
//                    if (DataArray[i + 1] == CheckArrayForIsFinMgr[x]) {
//                        AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "1</IsFinMgr>";
//                    }
//                    else if (DataArray[i + 1] != CheckArrayForIsFinMgr[x]) {
//                        AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "0</IsFinMgr>"
//                    }
                  
                    
//                    AdminRoleModuleAccessCombinationIDs = AdminRoleModuleAccessCombinationIDs + "<IsAdmMgr>0</IsAdmMgr><IsActive>" + 1 + "</IsActive></row>"
//                }
//                else if (DataArray[i] != CheckArrayForSelect_Row[x]) {
...
//        //alert(AdminRoleModuleAccess.SelectedRightsIDs);
//    },
