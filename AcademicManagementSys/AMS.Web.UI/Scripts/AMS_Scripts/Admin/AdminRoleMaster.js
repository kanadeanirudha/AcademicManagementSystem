...
//                AdminRoleMaster.SelectedRightsIDs = AdminRoleMaster.SelectedRightsIDs + '<row><ID>' + ID + '</ID><CentreCode>' + CentreCode + '</CentreCode><IsSuperUser>1</IsSuperUser><IsAcadMgr>1</IsAcadMgr><IsEstMgr>1</IsEstMgr><IsFinMgr>1</IsFinMgr><IsAdmMgr>1</IsAdmMgr><IsActive>1</IsActive></row>';
//                // j = j + 1;
//            }
//            else {
...
//                AdminRoleMaster.SelectedRightsIDs = AdminRoleMaster.SelectedRightsIDs + '<row><ID>' + ID + '</ID><CentreCode>' + CentreCode + '</CentreCode><IsSuperUser>' + IsSuper + '</IsSuperUser><IsAcadMgr>' + IsAcad + '</IsAcadMgr><IsEstMgr>' + IsEst + '</IsEstMgr><IsFinMgr>' + IsFin + '</IsFinMgr><IsAdmMgr>' + IsAdm + '</IsAdmMgr><IsActive>1</IsActive></row>';
//            }
        ...
        for (var j = 0; j <= AllRecord;) {
            ...
            if (temp == spltStr[3] + '~' + spltStr[2]) {
                if (spltStr[1] == "IsAcadMgr") {
                    ...
                    conStr = conStr + ',' + "Academic Manager";
                ...
                if (spltStr[1] == "IsAcadMgr") {
                    conStr = conStr + spltStr[3] + '~' + spltStr[2] + ':' + "Academic Manager";
                } else if (spltStr[1] == "IsEstMgr") {
