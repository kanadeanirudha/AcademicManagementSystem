...
//            $('#TaxName').focus();
//            $('#IsCompoundTax').removeAttr('checked');
...
//            //alert($('input[name=IsCompoundTax]:checked').val());
//            Data.IsCompoundTax = $('input[name=IsCompoundTax]:checked').val() ? true : false;
...
var GeneralTaxMaster = {
    ...
    GetGeneralTaxMaster: function () {
        ...
        if (GeneralTaxMaster.ActionName == "Create" || GeneralTaxMaster.ActionName == "Edit") {
            ...
            //alert($('input[name=IsCompoundTax]:checked').val());
            Data.IsCompoundTax = $('input[id=IsCompoundTax]:checked').val() ? true : false;
