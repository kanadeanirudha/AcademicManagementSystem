...
//    //    //    //Reload List
//    //    GeneralLocationMaster.ReloadList("Record Updated Sucessfully.",actionMode);
//    //    //} else {
//    //    //    $("#update-message").show();
//    //    //}
//    //},
...
//    //    //if ($("#update-message").html() == "True") {
//    //    //    //Reload List
//    //    GeneralLocationMaster.ReloadList("Record Deleted Sucessfully.");
//    //    //} else {
//    //    //    $("#update-message").show();
//    //    //}
//    //},
...
var GeneralLocationMaster = {
    ...
    GetGeneralLocationMasterMaster: function () {
        ...
        if (GeneralLocationMaster.ActionName == "Create" || GeneralLocationMaster.ActionName == "Edit") {
            ...
            Data.Longitude = $('#Longitude').val();
            //Data.DefaultFlag = $('input[id=DefaultFlag]:checked').val();
            //Data.DefaultFlag = $('input[id=DefaultFlag').val() ? true : false;
            Data.DefaultFlag = true;
        }
        else if (GeneralLocationMaster.ActionName == "Delete") {
            Data.ID = $('input[name=ID]').val();
        }
