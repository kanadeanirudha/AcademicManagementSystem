...
var InventoryBelowIndentLevelReport = {
    ActionName: null,
    SelectedLocationIDs: null,
    AllSelectedLocationIDs: null,

    Initialize: function () {
        InventoryBelowIndentLevelReport.constructor();
    },
    ...
    constructor: function () {
        ...
        $('#btnBelowIndentLevelReportSubmit').on("click", function () {            
            if ($("#AccountBalsheetMstID").val() != null && $("#AccountBalsheetMstID").val() > 0) {
                ...
                InventoryBelowIndentLevelReport.GetSelectedLocationListXML();                
    ...
    GetSelectedLocationListXML: function () {
        ...
        if (xmlParamList.length > 6) {
            InventoryBelowIndentLevelReport.SelectedLocationIDs = xmlParamList + "</rows>";
            $("#LocationNameListXml").val(InventoryBelowIndentLevelReport.SelectedLocationIDs);
        }
        else {
