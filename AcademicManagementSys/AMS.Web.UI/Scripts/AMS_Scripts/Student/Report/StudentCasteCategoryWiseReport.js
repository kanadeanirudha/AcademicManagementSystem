...
var StudentCasteCategoryWiseReport = {
    //Member variables
    ActionName: null,
    ...
    Initialize: function () {
        ...
        StudentCasteCategoryWiseReport.constructor();

    },
    //Attach all event of page
    constructor: function () {

        $('#btnStudentCasteCategoryWiseReportSubmit').on("click", function () {
            $("#IsPosted").val(true);
        });
        ...
        $("#SelectedCentreCode").change(function () {
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentCasteCategoryWiseReport/GetUniversityByCentreCode",
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentCasteCategoryWiseReport/GetAllSessionDetails",
        ...
        $("#SelectedUniversityID").change(function () {
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentCasteCategoryWiseReport/GetSectionDetails",
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentCasteCategoryWiseReport/GetCourseYearDetails",
        ...
        $('#ShowStudentList').on("click", function () {
            ...
            StudentCasteCategoryWiseReport.LoadList111(SelectedCentreCode, SelectedUniversityID, SelectedSectionDetailID, SelectedCourseYearId, SelectedAcademicYear, AdmissionStatus, SortOrder, ReportType);
