...
var StudentListNameWiseReport = {
    ...
    Initialize: function () {
        ...
        StudentListNameWiseReport.constructor();
        //generalCountryMaster.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {

        $('#btnStudentListReportSubmit').on("click", function () {
            $("#IsPosted").val(true);
        });
        ...
        $("#SelectedCentreCode").change(function () {
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentListNameWiseReport/GetUniversityByCentreCode",
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentListNameWiseReport/GetAllSessionDetails",
        ...
        $("#SelectedUniversityID").change(function () {
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentListNameWiseReport/GetSectionDetails",
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentListNameWiseReport/GetCourseYearDetails",
        ...
        $('#ShowStudentList').on("click", function () {
            ...
            StudentListNameWiseReport.LoadList111(SelectedCentreCode, SelectedUniversityID, SelectedSectionDetailID, SelectedCourseYearId, SelectedAcademicYear, AdmissionStatus, SortOrder, ReportType);
