...
var StudentOrignalBranchWiseReport = {
    //Member variables
    ActionName: null,
    ...
    Initialize: function () {
        ...
        StudentOrignalBranchWiseReport.constructor();
        //generalCountryMaster.initializeValidation();
    },
    //Attach all event of page
    constructor: function () {
        $('#btnStudentOrignalBranchWiseReportSubmit').on("click", function () {
            $("#IsPosted").val(true);
        });
        ...
        $("#SelectedCentreCode").change(function () {
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentOrignalBranchWiseReport/GetUniversityByCentreCode",
            ...
            if ($("#SelectedCentreCode").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentOrignalBranchWiseReport/GetAllSessionDetails",
        ...
        $("#SelectedUniversityID").change(function () {
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentOrignalBranchWiseReport/GetSectionDetails",
            ...
            if ($("#SelectedUniversityID").val() != "") {
                $.ajax({
                    cache: false,
                    type: "GET",
                    url: "/StudentOrignalBranchWiseReport/GetCourseYearDetails",
        ...
        $('#ShowStudentList').on("click", function () {
            ...
            var ReportType = $('input[id=ReportType]:checked').val() ? true : false;
            
            StudentOrignalBranchWiseReport.LoadList111(SelectedCentreCode, SelectedUniversityID, SelectedSectionDetailID, SelectedCourseYearId, SelectedAcademicYear, AdmissionStatus, SortOrder, ReportType);
