...
var StudentRegistrationForm = {
    ...
    PreviousWorkExperienceXML: null,
    DeletedPreviousWorkExperienceIDs:'',
    ...
    constructor: function () {
        ...
        $("#btnAddWorkExperience").on("click", function () {
            $("#tblWorkExperience tbody").append(
                '<tr>'+
                    '<td>'+
                        ' <input class="form-control input-sm" value="0" id="txtWorkExpID" type="text" style="display:none">' +
                        '<input class="form-control input-sm" value="" id="txtNameOfOrg"  style="background-color:#fff;" type="text">' +
                    '</td>'+
                    '<td>'+
                        '<input class="form-control input-sm" value="" id="txtPosition"  style="background-color:#fff;" type="text">' +
                    '</td>'+
                    '<td>'+
                        '<select class="form-control input-sm"   id="ddlFullPart" ><option value="1">Full Time</option><option value="2">Part Time</option></select>' +
                    '</td>'+
                    '<td>'+
                        '<input class="form-control input-sm myclassfromdate" readonly value="" id="txtFromDate"  style="background-color:#fff;" type="text">' +
                    '</td>'+
                    '<td>'+
                        '<input class="form-control input-sm myclassuptodate" readonly value="" id="txtUpTo"  style="background-color:#fff;" type="text">' +
                    '</td>' +
                    '<td>' +
                        '<i class="zmdi zmdi-delete zmdi-hc-fw" id="deleteWorkExperience" style="cursor:pointer" title="Delete"></i>' +
                    '</td>' +
                '</tr>'               
                  );

            StudentRegistrationForm.DeletePreviousWorkExp();
            StudentRegistrationForm.FromDateWorkExpDatePicker();
            StudentRegistrationForm.UpToDateWorkExpDatePicker();
        });
   ...
   */
        ...
        /////////////new searchlist for Location functionality///////////////////////////////////
        var getData = function () {
            return function findMatches(q, cb) {
                ...
                var cityIDValue = $("#SelectedCityID:selected").val();
                var regionIDValue = $("#SelectedRegionID:selected").val(); 
                $.ajax({
                    url: "/StudentRegistrationForm/GetLocationList",
                    type: "POST",
                    data: { term: q, maxResults: 10, CityID: cityIDValue, RegionID: regionIDValue },
                    //data: { term: request.term, maxResults: 10, CityID: $("#SelectedCityID :selected").val(), RegionID: $("#SelectedRegionID :selected").val() }, 
                    dataType: "json",
                    success: function (data) {
                        ...
                        $.each(data, function (i, response) {
                            //alert(response.id);
                            if (substrRegex.test(response.LocationAddress)) {
                                StudentRegistrationForm.map[response.LocationAddress] = response;
                                matches.push(response.LocationAddress);
        ...
        $("#Student_PermanentAddress_City_TahsilName").typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
            ...
            //alert(item.id);
            $(this).val(item.label);
            var selectedItem = $("#SelectedRegionID").val();
            //$("#Student_PermanentAddress_City_TahsilName").val(selectedItem);
            $("#Student_PermanentAddress_City_TahsilID").val(selectedItem);

            //$.ajax(
            //    {
            //        cache: false,
            //        type: "Get",
            //        data: { ID: StudentRegistrationForm.map[item].id, centreCode: StudentRegistrationForm.map[item].centreCode, studentType: selectedItem },
            //        dataType: "html",
        ...
        var getData = function () {
            return function findMatches(q, cb) {
                ...
                // regex used to determine if a string contains the substring `q`
                substrRegex = new RegExp(q, 'i');
                var cityIDValue1 = $("#SelectedCityID:selected").val();
                var regionIDValue1 = $("#SelectedRegionID:selected").val(); 
                $.ajax({
                    url: "/StudentRegistrationForm/GetLocationList",
                    type: "POST",
                    data: { term: q, maxResults: 10, CityID: cityIDValue1, RegionID: regionIDValue1 },
        ...
        $("#Student_CorrespondenceAddress_City_TahsilName").typeahead({
            hint: true,
            highlight: true,
            minLength: 1
        }, {
            ...
            var selectedItem = $("#SelectedRegionID").val();
            //$("#Student_PermanentAddress_City_TahsilName").val(selectedItem);
            $("#Student_CorrespondenceAddress_City_TahsilID").val(selectedItem);
        });
        //end new search functionality
        ...
        $('#EditStudentRegistrationFormRecord').on("click", function () {
            ...
            StudentRegistrationForm.GetQualificationExamSubjectSSCDetailsDataTable();
            StudentRegistrationForm.GetQualificationExamSubjectHSCDetailsDataTable();
            StudentRegistrationForm.GetPreviousWorkExperience();
            StudentRegistrationForm.AjaxCallStudentRegistrationForm();
        });
    ...
    DeletePreviousWorkExp: function () {
        $("#tblWorkExperience tbody tr td i[id^='deleteWorkExperience']").on("click", function () {
            if ($(this).closest('tr').find('input[id="txtWorkExpID"]').val() == 0) {
                $(this).closest('tr').remove();
            }
            else {
                StudentRegistrationForm.DeletedPreviousWorkExperienceIDs +=  $(this).closest('tr').find('input[id="txtWorkExpID"]').val() + ',';
                $(this).closest('tr').remove();
            }
        });
    },

    FromDateWorkExpDatePicker: function () {
        $(".myclassfromdate").each(function () {
            $(this).datetimepicker({
                format: 'DD MMMM YYYY',
                maxDate: moment(),
                ignoreReadonly: true,
                ...
                if (datepicker.hasClass('bottom')) {
                    ...
                    var top = $(this).offset().top - (datepicker.outerHeight()/2) + 90;
                    //var left = $(this).offset().left - datepicker.outerWidth();
                    var left = $(this).offset().left - (datepicker.outerWidth() + (datepicker.outerWidth() / 4)) + 200;
                    datepicker.css({
                        'top': top + 'px',
                        'bottom': 'auto',
                        'left': left + 'px'
    ...
    UpToDateWorkExpDatePicker: function () {
        $(".myclassuptodate").each(function () {
            $(this).datetimepicker({
                format: 'DD MMMM YYYY',
                maxDate: moment(),
                ignoreReadonly: true,
                ...
                if (datepicker.hasClass('bottom')) {
                    var top = $(this).offset().top - (datepicker.outerHeight() / 2) + 30;
                    var left = $(this).offset().left - (datepicker.outerWidth() + (datepicker.outerWidth() / 3));
                    datepicker.css({
                        'top': top + 'px',
                        'bottom': 'auto',
                        'left': left + 'px'
    ...
    AjaxCallStudentRegistrationForm: function () {
        ...
        if (StudentRegistrationForm.ActionName == "Save") {
            ...
            ajaxRequest.makeRequest("/StudentRegistrationForm/Create", "POST", StudentRegistrationFormData, StudentRegistrationForm.createSuccess, "SaveStudentRegistrationFormRecord");
            //}
        }
    ...
    GetStudentRegistrationForm: function () {
        ...
        Data.Student_Ex_Serviceman_Ward_of_Ex_Serviceman = $('input[id=Student_Ex_Serviceman_Ward_of_Ex_Serviceman]:checked').val() ? true : false;
        ...
        Data.Student_Active_Serviceman_Ward_of_Active_Serviceman = $('input[id=Student_Active_Serviceman_Ward_of_Active_Serviceman]:checked').val() ? true : false;
        Data.Student_FreedomFighterWardOfFreedomFighter = $('input[id=Student_FreedomFighterWardOfFreedomFighter]:checked').val() ? true : false;
        Data.Student_WardofPrimaryTeacher = $('input[id=Student_WardofPrimaryTeacher]:checked').val() ? true : false;
        Data.Student_WardofSecondaryTeacher = $('input[id=Student_WardofSecondaryTeacher]:checked').val() ? true : false;
        Data.Student_Deserted_Divorced_Widowed_Women = $('input[id=Student_Deserted_Divorced_Widowed_Women]:checked').val() ? true : false;
        Data.Student_MemberofProjectAffectedFamily = $('input[id=Student_MemberofProjectAffectedFamily]:checked').val() ? true : false;
        Data.Student_MemberofEarthquakeAffectedFamily = $('input[id=Student_MemberofEarthquakeAffectedFamily]:checked').val() ? true : false;
        Data.Student_MemberofFloodFamineAffectedFamily = $('input[id=Student_MemberofFloodFamineAffectedFamily]:checked').val() ? true : false;
        Data.Student_ResidentofTribalArea = $('input[id=Student_ResidentofTribalArea]:checked').val() ? true : false;
        Data.Student_KashmirMigrant = $('input[id=Student_KashmirMigrant]:checked').val() ? true : false;
        ...
        Data.Student_PermanentAddress_City_TahsilOther = $('#Student_PermanentAddress_City_TahsilName').val();
        ...
        Data.Student_CorrespondenceAddress_City_TahsilOther = $('#Student_CorrespondenceAddress_City_TahsilName').val();
        ...
        Data.Student_Qualification_General_Percent = parseFloat($('#Student_Qualification_General_Percent').val());
        ...
        Data.Student_Qualification_SSC_Percent = parseFloat($('#Student_Qualification_SSC_Percent').val());
        ...
        Data.Student_Qualification_HSC_Percent = parseFloat($('#Student_Qualification_HSC_Percent').val());
        ...
        Data.Student_Qualification_Diploma_ITI_Details_Percent = parseFloat($('#Student_Qualification_Diploma_ITI_Details_Percent').val());
        ...
        Data.Student_Qualification_PostGraduationDetails_Percent = parseFloat($('#Student_Qualification_PostGraduationDetails_Percent').val());
        ...
        Data.Student_AdmissionDocuments_JETMarkSheet = $('input[id=Student_AdmissionDocuments_JETMarkSheet]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_AllotmentLetter = $('input[id=Student_AdmissionDocuments_AllotmentLetter]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_TenthMarkSheet = $('input[id=Student_AdmissionDocuments_TenthMarkSheet]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_TwelvethMarkSheet = $('input[id=Student_AdmissionDocuments_TwelvethMarkSheet]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_AllDiplomaMarksheet = $('input[id=Student_AdmissionDocuments_AllDiplomaMarksheet]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_LeavingCertificate = $('input[id=Student_AdmissionDocuments_LeavingCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_Domicile_BirthCertificate = $('input[id=Student_AdmissionDocuments_Domicile_BirthCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_NationalityCertificate = $('input[id=Student_AdmissionDocuments_NationalityCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_CasteCertificate = $('input[id=Student_AdmissionDocuments_CasteCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_CasteValidityCertificate = $('input[id=Student_AdmissionDocuments_CasteValidityCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_NonCreamylayerCertificate = $('input[id=Student_AdmissionDocuments_NonCreamylayerCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_EquivalenceCertificate = $('input[id=Student_AdmissionDocuments_EquivalenceCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_MigrationCertificate = $('input[id=Student_AdmissionDocuments_MigrationCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_GapCertificate = $('input[id=Student_AdmissionDocuments_GapCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_AntiRaggingAffidavit = $('input[id=Student_AdmissionDocuments_AntiRaggingAffidavit]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_Proforma_Fand_F1_On_DoctorsLetter_Head = $('input[id=Student_AdmissionDocuments_Proforma_Fand_F1_On_DoctorsLetter_Head]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_Proforma_I = $('input[id=Student_AdmissionDocuments_Proforma_I]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_ProformaG1 = $('input[id=Student_AdmissionDocuments_ProformaG1]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_ProformaG2 = $('input[id=Student_AdmissionDocuments_ProformaG2]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_Proforma_C_D_E = $('input[id=Student_AdmissionDocuments_Proforma_C_D_E]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_FathersIncomeCertificate = $('input[id=Student_AdmissionDocuments_FathersIncomeCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_AadharCardXerox = $('input[id=Student_AdmissionDocuments_AadharCardXerox]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_B_WPhoto_I_card_size = $('input[id=Student_AdmissionDocuments_B_WPhoto_I_card_size]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_Colour_photo = $('input[id=Student_AdmissionDocuments_Colour_photo]:checked').val() ? true : false;
        ...
        //For PG Students
        Data.Student_AdmissionDocuments_PGStudents_DegreeMarksheet = $('input[id=Student_AdmissionDocuments_PGStudents_DegreeMarksheet]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_PGStudents_DegreeCertificate = $('input[id=Student_AdmissionDocuments_PGStudents_DegreeCertificate]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_PGStudents_GateScoreCard = $('input[id=Student_AdmissionDocuments_PGStudents_GateScoreCard]:checked').val() ? true : false;
        ...
        Data.Student_AdmissionDocuments_PGStudents_SponsorshipLetterforSponsoredCandidate = $('input[id=Student_AdmissionDocuments_PGStudents_SponsorshipLetterforSponsoredCandidate]:checked').val() ? true : false;
        ...
        Data.NameOfApplicant = $("#NameOfApplicant").val();
        Data.TitleOfProject = $("#TitleOfProject").val();
        Data.ProjectSummary = $("#ProjectSummary").val();

        //for Previous Work Experience
        Data.WorkExperienceXML = StudentRegistrationForm.PreviousWorkExperienceXML;
        Data.DeletedPreviousExperienceIDs = StudentRegistrationForm.DeletedPreviousWorkExperienceIDs;

        //for Fees Details
        Data.FeesPaidBy = $("#FeesPaidBy").val();
    ...
    GetQualifyingExamSubjectDetailsDataTable: function () {
        ...
        $("#QualifyingExamSubjectDetails input:input").each(function () {
            if ($(this).attr('type') == 'checkbox') {
                DataArrayQualifyingExamSubjectDetails.push($(this).attr('id'));
            }
            else {
        ...
        //alert(DataArrayQualifyingExamSubjectDetails + "  @@@  " + TotalRecord);
        //alert(TotalRecord);
    ...
    GetQualificationExamSubjectGeneralDetailsDataTable: function () {
        ...
        $("#QualificationExamSubjectGeneral input:input").each(function () {
            if ($(this).attr('type') == 'checkbox') {
                DataArrayQualificationExamSubjectGeneralDetails.push($(this).attr('id'));
            }
            else {
    ...
    GetQualificationExamSubjectSSCDetailsDataTable: function () {
        ...
        $("#QualificationExamSubjectSSC input:input").each(function () {
            if ($(this).attr('type') == 'checkbox') {
                DataArrayQualificationExamSubjectSSCDetails.push($(this).attr('id'));
            }
            else {
    ...
    GetQualificationExamSubjectHSCDetailsDataTable: function () {
        ...
        $("#QualificationExamSubjectHSC input:input").each(function () {
            if ($(this).attr('type') == 'checkbox') {
                DataArrayQualificationExamSubjectHSCDetails.push($(this).attr('id'));
            }
            else {
    ...
    GetPreviousWorkExperience: function () {
        var dataArray = [];
        $("#tblWorkExperience > tbody > tr > td > input[type='text'],select[id='ddlFullPart']").each(function () {
            dataArray.push($(this).val());            
        });
        PreviousWorkExperienceXML = "<rows>";
        var TotalRecord = dataArray.length;
        //alert(dataArray + "-----length--------" + dataArray.length);
        //alert(TotalRecord);
        for (var i = 0; i < TotalRecord; i = i + 6) {
            PreviousWorkExperienceXML = PreviousWorkExperienceXML + "<row><ID>"+dataArray[i]+"</ID><RegistrationID>0</RegistrationID><NameOfOrganization>" + dataArray[i+1] + "</NameOfOrganization><Position>" + dataArray[i + 2] + "</Position><FullTimePartTimeFlag>" + dataArray[i + 3] + "</FullTimePartTimeFlag><FromDate>" + dataArray[i + 4] + "</FromDate><UptoDate>" + dataArray[i + 5] + "</UptoDate></row>";
        }
        StudentRegistrationForm.PreviousWorkExperienceXML = PreviousWorkExperienceXML + "</rows>";

        //alert(StudentRegistrationForm.PreviousWorkExperienceXML);
    },
    ...
    createSuccess: function (data) {
        debugger;
        if (data == "True") {
            alert("Registration information saved sucessfully.");
