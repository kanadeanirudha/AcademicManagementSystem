...
<head runat="server">
    ...
    <script runat="server">
        ...
        AMS.Web.UI.Controllers.VendorMasterReportController controller = new AMS.Web.UI.Controllers.VendorMasterReportController();
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                List<AMS.DTO.VendorMasterReport> VendorMasterReport = null;
                ...
                else
                {
                    ...
                    rvVendorMasterReportForReplenishmentCategory.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/VendorMasterReportForReplenishmentCategory.rdlc");
            ...
            <div id="categoryPrint">
                ...
                <%--Please Select Report :&nbsp&nbsp&nbsp;--%>
                 ...
                 <rsweb:ReportViewer ID="rvVendorMasterReportForReplenishmentCategory" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.VendorMasterReportForReplenishmentCategory.rdlc">
                        <DataSources>
