        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    rvItemMasterReportForVendorDetails.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/ItemMasterReportForVendorDetails.rdlc");
            ...
            <div id="categoryPrint">
             ...
             <%--   Please Select Report :&nbsp&nbsp&nbsp;--%>
                 ...
                 <rsweb:ReportViewer ID="rvItemMasterReportForVendorDetails" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.ItemMasterReportForVendorDetails.rdlc">
                        <DataSources>
