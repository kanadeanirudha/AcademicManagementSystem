...
<head runat="server">
    ...
    <script runat="server">
        ...
        AMS.Web.UI.Controllers.GeneralItemMissingExceptionReportController controller = new AMS.Web.UI.Controllers.GeneralItemMissingExceptionReportController();
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                List<AMS.DTO.InventoryReport> GeneralItemMissingExceptionReport = null;
                ...
                else
                {
                    ...
                    rvItemMasterReportForCategoryDetails.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/ItemMasterReportForCategoryDetails.rdlc");
        ...
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvItemMasterReportForCategoryDetails" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.ItemMasterReportForCategoryDetails.rdlc">
                        <DataSources>
