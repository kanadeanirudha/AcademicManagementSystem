        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    rvGeneralItemMissingExceptionReport.LocalReport.ReportPath = Server.MapPath("~/Report/Inventory_1/GeneralItemMissingExceptionReport.rdlc");
        ...
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvGeneralItemMissingExceptionReport" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.Inventory_1.GeneralItemMissingExceptionReport.rdlc">
                        <DataSources>
