...
<head id="Head1" runat="server">
    ...
    <script runat="server">
        ...
        List<AMS.DTO.AccountTradingReport> AccountTradingReportReport = null;
        void Page_Load(object sender, EventArgs e)
            ...
            if (!IsPostBack)
            {
                ...
                AMS.Web.UI.Controllers.AccountTradingReportController controller = new AMS.Web.UI.Controllers.AccountTradingReportController();
    ...
    <form id="Form1" runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountTradingReportList" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountTradingReportExpenditure.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="DataSetAccountTradingReportExpenditureReport" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetData" TypeName="AMSDataSet121TableAdapters.AccountTradingReportTableAdapter"></asp:ObjectDataSource>
