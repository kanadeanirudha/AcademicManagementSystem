...
<head runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountBalancesheetTypeReport> AccountBalancesheetTypeReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;

                AMS.Web.UI.Controllers.AccountBalancesheetTypeReportController controller = new AMS.Web.UI.Controllers.AccountBalancesheetTypeReportController();
        ...
        <div id="MainDiv" runat="server">
            <div>
                ...
                <rsweb:ReportViewer ID="rvAccountBalancesheetType" runat="server" AsyncRendering="False" SizeToReportContent="True" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountBalancesheetTypeReport.rdlc">
                  ...
                  <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.AccBalsheetTypeMasterTableAdapter"></asp:ObjectDataSource>
