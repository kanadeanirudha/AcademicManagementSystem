...
<head id="Head1" runat="server">
    ...
    <title>AccountProfitAndLossReport</title>
    <script runat="server">
        ...
        List<AMS.DTO.AccountProfitAndLossReport> AccountProfitAndLossReport = null;
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                AMS.Web.UI.Controllers.AccountProfitAndLossReportController controller = new AMS.Web.UI.Controllers.AccountProfitAndLossReportController();
       ...
       <form id="Form1" runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountProfitAndLossList" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountProfitAndLossExpenditure.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="ObjectDataSource3" Name="DataSetAccountProfitAndLossExpenditureReport" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetData" TypeName="AMSDataSet121TableAdapters.AccountProfitAndLossTableAdapter"></asp:ObjectDataSource>
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="AMSDataSet3TableAdapters.AccountGeneralLedgerReportTableAdapter"></asp:ObjectDataSource>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.OrgStudyCentrePrintingFormatTableAdapter"></asp:ObjectDataSource>
               </div>
        </div>
...
<%--<body>
    <form  runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountProfitAndLossList" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountProfitAndLossListReport.rdlc">
                    <DataSources>
