...
<head id="Head1" runat="server">
    ...
    <title>AccountTrialBalanceReport</title>
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountTrialBalanceReport> AccountTrialBalanceReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;

                AMS.Web.UI.Controllers.AccountTrialBalanceReportController controller = new AMS.Web.UI.Controllers.AccountTrialBalanceReportController();
    ...
    <form id="Form1" runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountTrialBalanceList" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="100%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountTrialBalanceListReport.rdlc">
                    <DataSources>
