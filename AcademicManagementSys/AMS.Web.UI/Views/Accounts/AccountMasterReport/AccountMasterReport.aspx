...
<head runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                List<AMS.DTO.AccountMasterReport> AccountMasterReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;
                AMS.Web.UI.Controllers.AccountMasterReportController controller = new AMS.Web.UI.Controllers.AccountMasterReportController();
    ...
    <form runat="server">
      <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountMaster" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="100%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountMasterReport.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.USP_GeneralStudyCentreMaster_ReportSearchListTableAdapter"></asp:ObjectDataSource>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.USP_AccountNameList_ReportTableAdapter"></asp:ObjectDataSource>
