...
<head id="Head1" runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountGeneralLedgerReport> AccountIndividualBalanceReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;
                AMS.Web.UI.Controllers.AccountIndividualBalanceReportController controller = new AMS.Web.UI.Controllers.AccountIndividualBalanceReportController();
    ...
    <form runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountIndividualBalanceList" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountIndividualBalanceListReport.rdlc">
                    <DataSources>
