...
<head id="Head1" runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountVoucherSettingMasterReport> accountVoucherSettingMasterReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;

                AMS.Web.UI.Controllers.AccountVoucherSettingMasterReportController controller = new AMS.Web.UI.Controllers.AccountVoucherSettingMasterReportController();
        ...
        <div id="MainDiv" runat="server">
            <div>
                ...
                <rsweb:ReportViewer ID="rvAccountVoucherSettingList" runat="server" AsyncRendering="False" SizeToReportContent="True" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountVoucherSettingListReport.rdlc">
