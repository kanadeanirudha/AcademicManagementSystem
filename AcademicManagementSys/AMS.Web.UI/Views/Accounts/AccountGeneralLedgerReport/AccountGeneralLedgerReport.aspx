...
<head runat="server">
    ...
    <script runat="server">
        ...
        AMS.Web.UI.Controllers.AccountGeneralLedgerReportController controller = new AMS.Web.UI.Controllers.AccountGeneralLedgerReportController();
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountGeneralLedgerReport> AccountGeneralLedgerReport = null;
        ...
        <div id="MainDiv" runat="server">
            ...
            <div id="dataDiv">
                <rsweb:ReportViewer ID="rvAccountGeneralLedgerReport" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountGeneralLedgerReport.rdlc">
                        <DataSources>
