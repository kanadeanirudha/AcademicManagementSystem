...
<head runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            List<AMS.DTO.AccountCategoryMasterReport> AccountCategoryMasterReport = null;
        ...
        <div id="MainDiv" runat="server">
            <div id="categoryPrint">
                ...
                <rsweb:ReportViewer ID="rvAccountCategoryReport" runat="server" AsyncRendering="false" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountCategoryReport.rdlc">
                        <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.USP_AccountCategoryMaster_ReportTableAdapter"></asp:ObjectDataSource>
