...
<head runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                AMS.Web.UI.Controllers.AccountDayBookReportController controller = new AMS.Web.UI.Controllers.AccountDayBookReportController();
                List<AMS.DTO.AccountDayBookReport> AccountDayBookReport = null;
    ...
    <form runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountDayBookReport" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" PageCountMode="Actual" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountDayBookReport.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.AccountDayBookReportTableAdapter"></asp:ObjectDataSource>
        </div>
