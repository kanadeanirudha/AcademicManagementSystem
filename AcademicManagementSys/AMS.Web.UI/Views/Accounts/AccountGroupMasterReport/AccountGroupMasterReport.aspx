...
<head runat="server">
    ...
    <script runat="server">
        ...
        AMS.Web.UI.Controllers.AccountCategoryMasterReportController controller = new AMS.Web.UI.Controllers.AccountCategoryMasterReportController();
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                List<AMS.DTO.AccountGroupMasterReport> AccountGroupMasterReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;
                AMS.Web.UI.Controllers.AccountGroupMasterReportController controller = new AMS.Web.UI.Controllers.AccountGroupMasterReportController();
    ...
    <form runat="server">
      <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountGroupMaster" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="100%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountGroupMasterReport.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.USP_AccountGroupMaster_REPORTTableAdapter"></asp:ObjectDataSource>
