...
<head runat="server">
    ...
    <title></title>
    <script runat="server">
        List<AMS.DTO.AccountBalancesheetReport> AccountBalancesheetReport = null;
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                AMS.Web.UI.Controllers.AccountBalancesheetReportController controller = new AMS.Web.UI.Controllers.AccountBalancesheetReportController();
        ...
        <div id="MainDiv" runat="server">
            ...
            <div id="dataDiv">
                <rsweb:ReportViewer ID="rvAccountBalancesheetReport" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="99%" SizeToReportContent="True">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountBalancesheetReport.rdlc">
                        <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="AMSDataSetTableAdapters.AccountBalancesheetReportTableAdapter"></asp:ObjectDataSource>
            </div>
        </div>
