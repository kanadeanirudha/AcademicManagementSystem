...
<head id="Head1" runat="server">
    ...
    <script runat="server">
        ...
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountCentreWiseBalanceSheetReport> accountCentreWiseBalanceSheetReportReport = null;
                List<AMS.DTO.OrganisationStudyCentreMaster> OrganisationStudyCentreMasterDetails = null;

                AMS.Web.UI.Controllers.AccountCentreWiseBalanceSheetReportController controller = new AMS.Web.UI.Controllers.AccountCentreWiseBalanceSheetReportController();
        ...
        <div id="MainDiv" runat="server">
            <div>
                ...
                <rsweb:ReportViewer ID="rvAccountCentreWiseBalanceSheetList" runat="server" AsyncRendering="False" SizeToReportContent="True" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
                    <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountCentreWiseBalanceSheetListReport.rdlc">
