...
<head runat="server">
    ...
    <script runat="server">
        ...
        AMS.Web.UI.Controllers.AccountOtherLedgerReportController controller = new AMS.Web.UI.Controllers.AccountOtherLedgerReportController();
        void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                List<AMS.DTO.AccountGeneralLedgerReport> AccountOtherLedgerReport = null;
    ...
    <form runat="server">
        <div id="MainDiv" runat="server">
            ...
            <rsweb:ReportViewer ID="rvAccountOtherLedgerReport" runat="server" AsyncRendering="False" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Height="" Width="68%" SizeToReportContent="True">
                <LocalReport ReportEmbeddedResource="AMS.Web.UI.Report.AccountReports.AccountOtherLedgerReport.rdlc">
                    <DataSources>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData" TypeName="AMSDataSet1TableAdapters.AccountOtherLedgerReportTableAdapter"></asp:ObjectDataSource>
