...
{
    public interface IInventoryWeighingDataServiceAccess
    {
        ...
        IBaseEntityCollectionResponse<InventoryWeighingData> GetBySearch(InventoryWeighingDataSearchRequest searchRequest);
        ...
        IBaseEntityResponse<InventoryWeighingData> SelectByID(InventoryWeighingData item);
    }
}
