...
namespace AMS.Business.BusinessActions
{
    public class CRMSalesCustomerInformationReportBA : ICRMSalesCustomerInformationReportBA
    {
        ...
        public IBaseEntityCollectionResponse<CRMSalesCustomerInformationReport> GetCRMSalesCustomerInformationReportBySearch_Enquiry(CRMSalesCustomerInformationReportSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<CRMSalesCustomerInformationReport> CRMSalesCustomerInformationReportCollection = new BaseEntityCollectionResponse<CRMSalesCustomerInformationReport>();
            try
            {
                if (_CRMSalesCustomerInformationReportDataProvider != null)
                    CRMSalesCustomerInformationReportCollection = _CRMSalesCustomerInformationReportDataProvider.GetCRMSalesCustomerInformationReportBySearch_Enquiry(searchRequest);
                else
                {
                    CRMSalesCustomerInformationReportCollection.Message.Add(new MessageDTO
                    {
        ...
        public IBaseEntityCollectionResponse<CRMSalesCustomerInformationReport> GetCRMSalesCustomerInformationReportBySearch_Schedule(CRMSalesCustomerInformationReportSearchRequest searchRequest)
        {
            IBaseEntityCollectionResponse<CRMSalesCustomerInformationReport> CRMSalesCustomerInformationReportCollection = new BaseEntityCollectionResponse<CRMSalesCustomerInformationReport>();
            try
            {
                if (_CRMSalesCustomerInformationReportDataProvider != null)
                    CRMSalesCustomerInformationReportCollection = _CRMSalesCustomerInformationReportDataProvider.GetCRMSalesCustomerInformationReportBySearch_Schedule(searchRequest);
                else
                {
                    CRMSalesCustomerInformationReportCollection.Message.Add(new MessageDTO
                    {
